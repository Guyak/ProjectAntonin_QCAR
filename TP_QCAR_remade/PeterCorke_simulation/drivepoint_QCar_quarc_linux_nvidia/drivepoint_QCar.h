...
#ifndef RTW_HEADER_drivepoint_QCar_h_
#define RTW_HEADER_drivepoint_QCar_h_
#include <math.h>
#include <string.h>
#ifndef drivepoint_QCar_COMMON_INCLUDES_
#define drivepoint_QCar_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* drivepoint_QCar_COMMON_INCLUDES_ */

#include "drivepoint_QCar_types.h"
...
#define drivepoint_QCar_rtModel        RT_MODEL_drivepoint_QCar_T

/* Block signals (default storage) */
typedef struct {
  real_T currentheading;               /* '<Root>/Integrator' */
  real_T positions[3];                 /* '<S1>/Integrator' */
  real_T Sum[2];                       /* '<Root>/Sum' */
  real_T speedcommand;                 /* '<Root>/velocity gain Kv' */
  real_T desired;                      /* '<S7>/command saturation' */
  real_T desired_o;                    /* '<S7>/Multiply1' */
  real_T Integrator2;                  /* '<S3>/Integrator2' */
  real_T Product1;                     /* '<S3>/Product1' */
  real_T motorspeedrots;               /* '<S6>/counts to rotations' */
  real_T shaftspeedrotss;              /* '<S6>/gear ratios' */
  real_T wheelspeedrads;               /* '<S6>/rot//s to rad//s' */
  real_T wheelspeedms;                 /* '<S6>/wheel radius' */
  real_T Offset;                       /* '<S6>/Offset' */
  real_T measured;                     /* '<S7>/Multiply' */
  real_T Sum_n;                        /* '<S7>/Sum' */
  real_T Integrator1;                  /* '<S7>/Integrator1' */
  real_T Gain1;                        /* '<Root>/Gain1' */
  real_T steeringwheelangle;           /* '<Root>/heading gain Kh' */
  real_T Saturation;                   /* '<Root>/Saturation' */
  real_T steeringlimit;                /* '<S1>/steering limit' */
  real_T Divide;                       /* '<S8>/Divide' */
  real_T velocitylimit;                /* '<S1>/velocity limit' */
  ...
  real_T Integrator1_j;                /* '<S3>/Integrator1' */
  real_T Sum1;                         /* '<S3>/Sum1' */
  ...
  real_T theta_dotrads;                /* '<Root>/Lowpass Filter' */
...
typedef struct {
  dsp_LowpassFilter_drivepoint__T obj; /* '<Root>/Lowpass Filter' */
  real_T HILInitialize_AIMinimums[7];  /* '<Root>/HIL Initialize' */
  real_T HILInitialize_AIMaximums[7];  /* '<Root>/HIL Initialize' */
  real_T HILInitialize_FilterFrequency[5];/* '<Root>/HIL Initialize' */
  real_T HILInitialize_POSortedFreqs[8];/* '<Root>/HIL Initialize' */
  real_T HILInitialize_POValues[8];    /* '<Root>/HIL Initialize' */
  real_T HILInitialize_OOValues[13];   /* '<Root>/HIL Initialize' */
  real_T PrevYA;                       /* '<S1>/acceleration limit' */
  real_T PrevYB;                       /* '<S1>/acceleration limit' */
  real_T LastMajorTimeA;               /* '<S1>/acceleration limit' */
  real_T LastMajorTimeB;               /* '<S1>/acceleration limit' */
  real_T HILRead_OtherBuffer;          /* '<Root>/HIL Read' */
  ...
  struct {
    void *LoggedData[2];
  } HeadingDiff_PWORK;                 /* '<Root>/HeadingDiff' */

  struct {
    void *LoggedData;
  } heading_PWORK;                     /* '<Root>/heading ' */

  struct {
    void *LoggedData;
  } steeringangle_PWORK;               /* '<Root>/steeringangle' */
  ...
  struct {
    void *LoggedData[2];
  } speedComparison_PWORK;             /* '<S7>/speedComparison' */

  int32_T HILInitialize_DOStates;      /* '<Root>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[5];/* '<Root>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[5];/* '<Root>/HIL Initialize' */
  ...
  int_T Integrator1_IWORK;             /* '<S3>/Integrator1' */
...
} DW_drivepoint_QCar_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T Integrator_CSTATE_l[3];       /* '<S1>/Integrator' */
...
typedef struct {
  ...
  real_T Integrator1_CSTATE;           /* '<S7>/Integrator1' */
  real_T Integrator1_CSTATE_e;         /* '<S3>/Integrator1' */
} XDot_drivepoint_QCar_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
  boolean_T Integrator_CSTATE_l[3];    /* '<S1>/Integrator' */
...
} ExtY_drivepoint_QCar_T;

/* Backward compatible GRT Identifiers */
#define rtB                            drivepoint_QCar_B
#define BlockIO                        B_drivepoint_QCar_T
#define rtX                            drivepoint_QCar_X
#define ContinuousStates               X_drivepoint_QCar_T
#define rtXdot                         drivepoint_QCar_XDot
#define StateDerivatives               XDot_drivepoint_QCar_T
#define tXdis                          drivepoint_QCar_XDis
#define StateDisabled                  XDis_drivepoint_QCar_T
#define rtY                            drivepoint_QCar_Y
#define ExternalOutputs                ExtY_drivepoint_QCar_T
#define rtP                            drivepoint_QCar_P
#define Parameters                     P_drivepoint_QCar_T
#define rtDWork                        drivepoint_QCar_DW
#define D_Work                         DW_drivepoint_QCar_T
#define rtPrevZCSigState               drivepoint_QCar_PrevZCX
#define PrevZCSigStates                PrevZCX_drivepoint_QCar_T

/* Parameters (default storage) */
struct P_drivepoint_QCar_T_ {
  ...
  real_T xg[2];                        /* Variable: xg
                                        ...
                                        */
  real_T arewethereyet_const;          /* Mask Parameter: arewethereyet_const
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T velocitygainKv_Gain;          /* Expression: 0.5
                                        * Referenced by: '<Root>/velocity gain Kv'
                                        */
  real_T commandsaturation_UpperSat;   /* Expression: 0.5
                                        * Referenced by: '<S7>/command saturation'
                                        */
  real_T commandsaturation_LowerSat;   /* Expression: -0.5
                                        * Referenced by: '<S7>/command saturation'
                                        */
  ...
  real_T wheelradius_Gain;             /* Expression: 0.0342
                                        ...
                                        */
  real_T Offset_Gain;                  /* Expression: 1
  ...
  real_T Gain1_Gain;                   /* Expression: -1
                                        ...
                                        */
  real_T headinggainKh_Gain;           /* Expression: 1
  ...
  real_T Saturation_LowerSat;          /* Expression: -0.5
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T steeringlimit_UpperSat;       /* Expression: 0.5
                                        * Referenced by: '<S1>/steering limit'
                                        */
  real_T steeringlimit_LowerSat;       /* Expression: -0.5
                                        * Referenced by: '<S1>/steering limit'
                                        */
  real_T vehiclelength_Value;          /* Expression: 0.425
                                        * Referenced by: '<S8>/vehicle length'
                                        */
  real_T velocitylimit_UpperSat;       /* Expression: 0.2
                                        * Referenced by: '<S1>/velocity limit'
                                        */
  real_T velocitylimit_LowerSat;       /* Expression: -0.2
                                        * Referenced by: '<S1>/velocity limit'
                                        */
  real_T accelerationlimit_RisingLim;  /* Expression: 0.5
                                        * Referenced by: '<S1>/acceleration limit'
                                        */
  real_T accelerationlimit_FallingLim; /* Expression: -0.5
                                        * Referenced by: '<S1>/acceleration limit'
                                        */
  ...
  real_T Unwrap224_Modulus;            /* Expression: modulus
                                        ...
                                        */
  real_T Kim_Gain;                     /* Expression: 0.6
...
struct tag_RTM_drivepoint_QCar_T {
  const char_T *path;
...
extern P_drivepoint_QCar_T drivepoint_QCar_P;

/* Block signals (default storage) */
extern B_drivepoint_QCar_T drivepoint_QCar_B;

/* Continuous states (default storage) */
extern X_drivepoint_QCar_T drivepoint_QCar_X;

/* Block states (default storage) */
extern DW_drivepoint_QCar_T drivepoint_QCar_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_drivepoint_QCar_T drivepoint_QCar_PrevZCX;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_drivepoint_QCar_T drivepoint_QCar_Y;

/* Model entry point functions */
extern void drivepoint_QCar_initialize(void);
extern void drivepoint_QCar_output(void);
extern void drivepoint_QCar_update(void);
extern void drivepoint_QCar_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern drivepoint_QCar_rtModel *drivepoint_QCar(void);
...
extern RT_MODEL_drivepoint_QCar_T *const drivepoint_QCar_M;
 ...
 *
 * '<Root>' : 'drivepoint_QCar'
 * '<S1>'   : 'drivepoint_QCar/Bicycle Model'
 * '<S2>'   : 'drivepoint_QCar/MATLAB Function2'
 * '<S3>'   : 'drivepoint_QCar/Second-Order Low-Pass Filter'
 * '<S4>'   : 'drivepoint_QCar/XY Graph'
 * '<S5>'   : 'drivepoint_QCar/are we there yet?'
 * '<S6>'   : 'drivepoint_QCar/basicSpeedEstimation'
 * '<S7>'   : 'drivepoint_QCar/speedController'
 * '<S8>'   : 'drivepoint_QCar/Bicycle Model/tan(gamma)//L'
 * '<S9>'   : 'drivepoint_QCar/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_drivepoint_QCar_h_ */
