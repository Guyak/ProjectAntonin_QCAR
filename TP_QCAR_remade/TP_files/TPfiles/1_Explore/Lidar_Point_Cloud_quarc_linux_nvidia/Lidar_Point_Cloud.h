...
typedef struct {
  ...
  real_T ChangextofrontofQCar[720];    /* '<S4>/Change +x to front of QCar ' */
  real_T pX_data[720];
  real_T Switch2[720];                 /* '<S7>/Switch2' */
  real_T X[720];                       /* '<S6>/findXYContour' */
  real_T Y[720];                       /* '<S6>/findXYContour' */
  real_T actualsampletime;             /* '<S5>/Sample Time' */
  real_T reference;                    /* '<S5>/Constant' */
  real_T computationtime;              /* '<S5>/Computation Time' */
  t_channel Channel;                   /* '<S3>/Channel' */
  uint8_T ImageCompress[160000];       /* '<S3>/Image Compress' */
...
typedef struct {
  ...
  real_T mapInternal[160000];          /* '<S6>/contourToPointCloud' */
  t_jpeg_compress ImageCompress_Compress;/* '<S3>/Image Compress' */
  t_ranging_sensor RangingSensor_Sensor;/* '<S4>/Ranging Sensor' */
  struct {
    void *Fifo;
  } Channel_PWORK;                     /* '<S3>/Channel' */

  struct {
    void *LoggedData;
  } Scope_PWORK;                       /* '<Root>/Scope' */

  int32_T ImageCompress_DIMS1;         /* '<S3>/Image Compress' */
  int32_T SFunction_DIMS2;             /* '<S6>/findXYContour' */
  int32_T SFunction_DIMS3;             /* '<S6>/findXYContour' */
  int_T BodyFramePolarPlot_IWORK[2];   /* '<Root>/Body Frame  Polar Plot' */
  uint8_T ImageCompress_ScanLine[3200];/* '<S3>/Image Compress' */
  boolean_T BodyFramePolarPlot_IsFull; /* '<Root>/Body Frame  Polar Plot' */
  boolean_T mapInternal_not_empty;     /* '<S6>/contourToPointCloud' */
...
struct P_Lidar_Point_Cloud_T_ {
  ...
  real_T RangingSensor_MaxInterpolationA;/* Expression: max_interpolated_angle
                                          * Referenced by: '<S4>/Ranging Sensor'
                                          */
  real_T ChangetoCCWrotation_Gain;     /* Expression: -1
                                        * Referenced by: '<S4>/Change to  CCW rotation'
                                        */
  real_T ChangextofrontofQCar_Bias;    /* Expression: pi/2
  ...
  real_T Constant1_Value;              /* Expression: 0
                                        ...
                                        */
  real_T decay_Value;                  /* Expression: 0
 ...
 * '<S3>'   : 'Lidar_Point_Cloud/Video Compressed Display'
 * '<S4>'   : 'Lidar_Point_Cloud/captureLIDAR'
 * '<S5>'   : 'Lidar_Point_Cloud/monitorTiming '
 * '<S6>'   : 'Lidar_Point_Cloud/pointCloud'
