...
void KeyboardAndLights_output(void)
{
  ...
  if (rtmIsMajorTimeStep(KeyboardAndLights_M)) {
    ...
    KeyboardAndLights_B.DataTypeConversion3[0] = rtb_HostKeyboard_o2[0];
    KeyboardAndLights_B.DataTypeConversion3[1] = rtb_HostKeyboard_o2[1];
    KeyboardAndLights_B.DataTypeConversion3[2] = rtb_HostKeyboard_o2[2];
    KeyboardAndLights_B.DataTypeConversion3[3] = rtb_HostKeyboard_o2[3];

    /* Gain: '<Root>/Gain1' */
    rtb_commandsaturation = KeyboardAndLights_P.Gain1_Gain *
      KeyboardAndLights_B.DataTypeConversion3[3];

    /* Gain: '<S6>/direction convention' incorporates:
     *  Gain: '<Root>/Gain'
     *  Sum: '<Root>/Add1'
     */
    rtb_commandsaturation = (KeyboardAndLights_P.Gain_Gain *
      KeyboardAndLights_B.DataTypeConversion3[0] + rtb_commandsaturation) *
     ...
     *  Gain: '<Root>/Gain3'
     */
    rtb_frontleftheadlamp = KeyboardAndLights_P.Gain2_Gain *
      KeyboardAndLights_B.DataTypeConversion3[1] +
      KeyboardAndLights_P.Gain3_Gain * KeyboardAndLights_B.DataTypeConversion3[2];
...
RT_MODEL_KeyboardAndLights_T *KeyboardAndLights(void)
{
  ...
  /* External mode info */
  KeyboardAndLights_M->Sizes.checksums[0] = (1644563278U);
  KeyboardAndLights_M->Sizes.checksums[1] = (4047958349U);
  KeyboardAndLights_M->Sizes.checksums[2] = (3764825643U);
  KeyboardAndLights_M->Sizes.checksums[3] = (3684895215U);
  ...
  KeyboardAndLights_M->Sizes.numBlocks = (74);/* Number of blocks */
  KeyboardAndLights_M->Sizes.numBlockIO = (20);/* Number of block outputs */
