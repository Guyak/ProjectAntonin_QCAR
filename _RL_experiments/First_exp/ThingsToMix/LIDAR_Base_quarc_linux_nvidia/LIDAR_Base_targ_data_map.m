  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% LIDAR_Base_P.BodyFramePolarPlot_maximum_rho
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_maximum_thet
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 5;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_minimum_rho
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 6;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_minimum_thet
	  ...
	  ;% LIDAR_Base_P.BodyFramePolarPlot_direction
	  section.data(1).logicalSrcIdx = 8;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_update_rate
	  section.data(2).logicalSrcIdx = 9;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_zero_locatio
	  ...
	  ;% LIDAR_Base_P.HILRead_encoder_channels
	  section.data(1).logicalSrcIdx = 11;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_P.HILWrite1_other_channels
	  section.data(2).logicalSrcIdx = 12;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_Base_P.HILWrite1_pwm_channels
	  ...
	  ;% LIDAR_Base_P.Constant_Value
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_P.HILInitialize1_OOTerminate
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_Base_P.HILInitialize1_OOExit
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% LIDAR_Base_P.HILInitialize1_OOStart
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	
	  ;% LIDAR_Base_P.HILInitialize1_OOEnter
	  ...
	  ;% LIDAR_Base_P.HILInitialize1_OOFinal
	  section.data(7).logicalSrcIdx = 20;
	  section.data(7).dtTransOffset = 6;
	
	  ;% LIDAR_Base_P.HILInitialize1_AIHigh
	  section.data(8).logicalSrcIdx = 21;
	  section.data(8).dtTransOffset = 7;
	
	  ;% LIDAR_Base_P.HILInitialize1_AILow
	  section.data(9).logicalSrcIdx = 22;
	  section.data(9).dtTransOffset = 8;
	
	  ;% LIDAR_Base_P.HILInitialize1_EIFrequency
	  ...
	  ;% LIDAR_Base_P.HILInitialize1_OOInitial
	  section.data(14).logicalSrcIdx = 27;
	  section.data(14).dtTransOffset = 13;
	
	  ;% LIDAR_Base_P.RangingSensor_Budget
	  section.data(15).logicalSrcIdx = 28;
	  section.data(15).dtTransOffset = 14;
	
	  ;% LIDAR_Base_P.RangingSensor_Period
	  ...
	  ;% LIDAR_Base_P.Motor_commandsat_UpperSat
	  section.data(60).logicalSrcIdx = 73;
	  section.data(60).dtTransOffset = 808;
	
	  ;% LIDAR_Base_P.Motor_commandsat_LowerSat
	  ...
	  ;% LIDAR_Base_P.HILInitialize1_EIInitial
	  ...
	  ;% LIDAR_Base_P.HILInitialize1_POConfiguration
	  section.data(3).logicalSrcIdx = 85;
	  section.data(3).dtTransOffset = 3;
	
	  ;% LIDAR_Base_P.HILInitialize1_POAlignment
	  section.data(4).logicalSrcIdx = 86;
	  section.data(4).dtTransOffset = 4;
	
	  ;% LIDAR_Base_P.HILInitialize1_POPolarity
	  section.data(5).logicalSrcIdx = 87;
	  section.data(5).dtTransOffset = 5;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L1Style
	  section.data(6).logicalSrcIdx = 88;
	  section.data(6).dtTransOffset = 6;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L1Marker
	  section.data(7).logicalSrcIdx = 89;
	  section.data(7).dtTransOffset = 7;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L2Style
	  section.data(8).logicalSrcIdx = 90;
	  section.data(8).dtTransOffset = 8;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L2Marker
	  section.data(9).logicalSrcIdx = 91;
	  section.data(9).dtTransOffset = 9;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L3Style
	  section.data(10).logicalSrcIdx = 92;
	  section.data(10).dtTransOffset = 10;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L3Marker
	  section.data(11).logicalSrcIdx = 93;
	  section.data(11).dtTransOffset = 11;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L4Style
	  section.data(12).logicalSrcIdx = 94;
	  section.data(12).dtTransOffset = 12;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L4Marker
	  section.data(13).logicalSrcIdx = 95;
	  section.data(13).dtTransOffset = 13;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L5Style
	  section.data(14).logicalSrcIdx = 96;
	  section.data(14).dtTransOffset = 14;
	
	  ;% LIDAR_Base_P.BodyFramePolarPlot_L5Marker
	  ...
	  ;% LIDAR_Base_P.HILInitialize1_AIChannels
	  section.data(1).logicalSrcIdx = 98;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_P.HILInitialize1_DIChannels
	  ...
	  ;% LIDAR_Base_P.HILInitialize1_EIChannels
	  section.data(4).logicalSrcIdx = 101;
	  section.data(4).dtTransOffset = 27;
	
	  ;% LIDAR_Base_P.HILInitialize1_EIQuadrature
	  ...
	  ;% LIDAR_Base_P.RangingSensor_Range
	  ...
	  ;% LIDAR_Base_P.HILInitialize1_Active
	  section.data(1).logicalSrcIdx = 106;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_P.HILInitialize1_AOTerminate
	  section.data(2).logicalSrcIdx = 107;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_Base_P.HILInitialize1_AOExit
	  section.data(3).logicalSrcIdx = 108;
	  section.data(3).dtTransOffset = 2;
	
	  ;% LIDAR_Base_P.HILInitialize1_DOTerminate
	  section.data(4).logicalSrcIdx = 109;
	  section.data(4).dtTransOffset = 3;
	
	  ;% LIDAR_Base_P.HILInitialize1_DOExit
	  section.data(5).logicalSrcIdx = 110;
	  section.data(5).dtTransOffset = 4;
	
	  ;% LIDAR_Base_P.HILInitialize1_POTerminate
	  section.data(6).logicalSrcIdx = 111;
	  section.data(6).dtTransOffset = 5;
	
	  ;% LIDAR_Base_P.HILInitialize1_POExit
	  section.data(7).logicalSrcIdx = 112;
	  section.data(7).dtTransOffset = 6;
	
	  ;% LIDAR_Base_P.HILInitialize1_CKPStart
	  section.data(8).logicalSrcIdx = 113;
	  section.data(8).dtTransOffset = 7;
	
	  ;% LIDAR_Base_P.HILInitialize1_CKPEnter
	  section.data(9).logicalSrcIdx = 114;
	  section.data(9).dtTransOffset = 8;
	
	  ;% LIDAR_Base_P.HILInitialize1_CKStart
	  section.data(10).logicalSrcIdx = 115;
	  section.data(10).dtTransOffset = 9;
	
	  ;% LIDAR_Base_P.HILInitialize1_CKEnter
	  section.data(11).logicalSrcIdx = 116;
	  section.data(11).dtTransOffset = 10;
	
	  ;% LIDAR_Base_P.HILInitialize1_AIPStart
	  section.data(12).logicalSrcIdx = 117;
	  section.data(12).dtTransOffset = 11;
	
	  ;% LIDAR_Base_P.HILInitialize1_AIPEnter
	  section.data(13).logicalSrcIdx = 118;
	  section.data(13).dtTransOffset = 12;
	
	  ;% LIDAR_Base_P.HILInitialize1_AOPStart
	  section.data(14).logicalSrcIdx = 119;
	  section.data(14).dtTransOffset = 13;
	
	  ;% LIDAR_Base_P.HILInitialize1_AOPEnter
	  section.data(15).logicalSrcIdx = 120;
	  section.data(15).dtTransOffset = 14;
	
	  ;% LIDAR_Base_P.HILInitialize1_AOStart
	  section.data(16).logicalSrcIdx = 121;
	  section.data(16).dtTransOffset = 15;
	
	  ;% LIDAR_Base_P.HILInitialize1_AOEnter
	  section.data(17).logicalSrcIdx = 122;
	  section.data(17).dtTransOffset = 16;
	
	  ;% LIDAR_Base_P.HILInitialize1_AOReset
	  section.data(18).logicalSrcIdx = 123;
	  section.data(18).dtTransOffset = 17;
	
	  ;% LIDAR_Base_P.HILInitialize1_DOPStart
	  section.data(19).logicalSrcIdx = 124;
	  section.data(19).dtTransOffset = 18;
	
	  ;% LIDAR_Base_P.HILInitialize1_DOPEnter
	  section.data(20).logicalSrcIdx = 125;
	  section.data(20).dtTransOffset = 19;
	
	  ;% LIDAR_Base_P.HILInitialize1_DOStart
	  section.data(21).logicalSrcIdx = 126;
	  section.data(21).dtTransOffset = 20;
	
	  ;% LIDAR_Base_P.HILInitialize1_DOEnter
	  section.data(22).logicalSrcIdx = 127;
	  section.data(22).dtTransOffset = 21;
	
	  ;% LIDAR_Base_P.HILInitialize1_DOReset
	  section.data(23).logicalSrcIdx = 128;
	  section.data(23).dtTransOffset = 22;
	
	  ;% LIDAR_Base_P.HILInitialize1_EIPStart
	  section.data(24).logicalSrcIdx = 129;
	  section.data(24).dtTransOffset = 23;
	
	  ;% LIDAR_Base_P.HILInitialize1_EIPEnter
	  section.data(25).logicalSrcIdx = 130;
	  section.data(25).dtTransOffset = 24;
	
	  ;% LIDAR_Base_P.HILInitialize1_EIStart
	  section.data(26).logicalSrcIdx = 131;
	  section.data(26).dtTransOffset = 25;
	
	  ;% LIDAR_Base_P.HILInitialize1_EIEnter
	  section.data(27).logicalSrcIdx = 132;
	  section.data(27).dtTransOffset = 26;
	
	  ;% LIDAR_Base_P.HILInitialize1_POPStart
	  section.data(28).logicalSrcIdx = 133;
	  section.data(28).dtTransOffset = 27;
	
	  ;% LIDAR_Base_P.HILInitialize1_POPEnter
	  section.data(29).logicalSrcIdx = 134;
	  section.data(29).dtTransOffset = 28;
	
	  ;% LIDAR_Base_P.HILInitialize1_POStart
	  section.data(30).logicalSrcIdx = 135;
	  section.data(30).dtTransOffset = 29;
	
	  ;% LIDAR_Base_P.HILInitialize1_POEnter
	  section.data(31).logicalSrcIdx = 136;
	  section.data(31).dtTransOffset = 30;
	
	  ;% LIDAR_Base_P.HILInitialize1_POReset
	  section.data(32).logicalSrcIdx = 137;
	  section.data(32).dtTransOffset = 31;
	
	  ;% LIDAR_Base_P.HILInitialize1_OOReset
	  section.data(33).logicalSrcIdx = 138;
	  section.data(33).dtTransOffset = 32;
	
	  ;% LIDAR_Base_P.HILInitialize1_DOFinal
	  ...
	  ;% LIDAR_Base_P.RangingSensor_Active
	  section.data(36).logicalSrcIdx = 141;
	  section.data(36).dtTransOffset = 35;
	
	  ;% LIDAR_Base_P.HILWrite1_Active
	  section.data(37).logicalSrcIdx = 142;
	  section.data(37).dtTransOffset = 36;
	
	  ;% LIDAR_Base_P.HILRead_Active
	  ...
	  ;% LIDAR_Base_P.BodyFramePolarPlot_Mode
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (LIDAR_Base_B)
    ;%
      section.nData     = 23;
      section.data(23)  = dumData; %prealloc
      
	  ;% LIDAR_Base_B.RangingSensor_o1
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_B.RangingSensor_o2
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 720;
	
	  ;% LIDAR_Base_B.RangingSensor_o3
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 1440;
	
	  ;% LIDAR_Base_B.RangingSensor_o4
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 2160;
	
	  ;% LIDAR_Base_B.Constant1
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 2880;
	
	  ;% LIDAR_Base_B.desired
	  section.data(6).logicalSrcIdx = 5;
	  ...
	  ;% LIDAR_Base_B.Product1
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 3602;
	
	  ;% LIDAR_Base_B.measured
	  ...
	  ;% LIDAR_Base_B.RateTransition
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 3615;
	
	  ;% LIDAR_Base_B.correctedDistances
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (LIDAR_Base_DW)
    ;%
      section.nData     = 1;
      section.data(1)  = dumData; %prealloc
      
	  ;% LIDAR_Base_DW.RangingSensor_Measurements
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% LIDAR_Base_DW.AnimationSFunction_DSTATE
	  section.data(1).logicalSrcIdx = 1;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_DW.HILInitialize1_AIMinimums
	  section.data(2).logicalSrcIdx = 2;
	  section.data(2).dtTransOffset = 6;
	
	  ;% LIDAR_Base_DW.HILInitialize1_AIMaximums
	  section.data(3).logicalSrcIdx = 3;
	  section.data(3).dtTransOffset = 13;
	
	  ;% LIDAR_Base_DW.HILInitialize1_FilterFrequency
	  ...
	  ;% LIDAR_Base_DW.HILInitialize1_POValues
	  section.data(6).logicalSrcIdx = 6;
	  section.data(6).dtTransOffset = 26;
	
	  ;% LIDAR_Base_DW.HILInitialize1_OOValues
	  section.data(7).logicalSrcIdx = 7;
	  section.data(7).dtTransOffset = 27;
	
	  ;% LIDAR_Base_DW.BodyFramePolarPlot_XBuffer
	  section.data(8).logicalSrcIdx = 8;
	  section.data(8).dtTransOffset = 40;
	
	  ;% LIDAR_Base_DW.BodyFramePolarPlot_YBuffer
	  ...
	  ;% LIDAR_Base_DW.RangingSensor_Sensor
	  ...
	  ;% LIDAR_Base_DW.HILWrite1_PWORK
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_DW.HILRead_PWORK
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_Base_DW.Scope_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	  ...
	  ;% LIDAR_Base_DW.HILInitialize1_DOStates
	  section.data(1).logicalSrcIdx = 17;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_DW.HILInitialize1_QuadratureModes
	  section.data(2).logicalSrcIdx = 18;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_Base_DW.HILInitialize1_InitialEICounts
	  ...
	  ;% LIDAR_Base_DW.BodyFramePolarPlot_IWORK
	  section.data(1).logicalSrcIdx = 22;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_DW.Integrator1_IWORK
	  ...
	  ;% LIDAR_Base_DW.BodyFramePolarPlot_IsFull
	  section.data(1).logicalSrcIdx = 24;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Base_DW.Unwrap224_FirstSample
  ...
  targMap.checksum0 = 4180851271;
  targMap.checksum1 = 2605836963;
  targMap.checksum2 = 2671706920;
  targMap.checksum3 = 3837333528;
