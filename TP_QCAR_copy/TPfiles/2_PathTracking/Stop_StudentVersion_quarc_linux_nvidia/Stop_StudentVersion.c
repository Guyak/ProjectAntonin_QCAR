...
void Stop_StudentVersion_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Stop_StudentVersion_M)) {
     ...
     *  Constant: '<Root>/m//s'
     */
    if ((Stop_StudentVersion_B.Selector > 0.05) &&
...
RT_MODEL_Stop_StudentVersion_T *Stop_StudentVersion(void)
{
  ...
  /* External mode info */
  Stop_StudentVersion_M->Sizes.checksums[0] = (434541839U);
  Stop_StudentVersion_M->Sizes.checksums[1] = (1816020233U);
  Stop_StudentVersion_M->Sizes.checksums[2] = (1086010853U);
  Stop_StudentVersion_M->Sizes.checksums[3] = (1612699329U);
