###########################################################################
## Makefile generated for component 'KeyboardAndLights'. 
## 
## Makefile     : KeyboardAndLights.mk
## Generated on : Tue Oct 18 10:02:01 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/KeyboardAndLights.rt-linux_nvidia
...
PRODUCT_NAME              = KeyboardAndLights
MAKEFILE                  = KeyboardAndLights.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/ProjectAntonin/TP_QCAR_copy/TPfiles/4_LIDARObstacleAvoidance
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/KeyboardAndLights.rt-linux_nvidia
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/KeyboardAndLights_quarc_linux_nvidia -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=KeyboardAndLights -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/KeyboardAndLights.c $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/KeyboardAndLights_data.c $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/KeyboardAndLights_main.c $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = KeyboardAndLights.o KeyboardAndLights_data.o KeyboardAndLights_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
LIBS = C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/libhil.a C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI5A2F~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LIBQUA~4.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI5C03~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LIBQUA~3.A
...
%.o : $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
KeyboardAndLights.o : $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/KeyboardAndLights.c
	$(CC) $(CFLAGS) -o"$@" "$<"


KeyboardAndLights_data.o : $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/KeyboardAndLights_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


KeyboardAndLights_main.o : $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/KeyboardAndLights_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/KeyboardAndLights_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
