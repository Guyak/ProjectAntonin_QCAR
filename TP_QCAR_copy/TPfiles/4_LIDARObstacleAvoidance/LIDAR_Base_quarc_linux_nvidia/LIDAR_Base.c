 ...
 * C source code generated on : Wed Oct 19 09:14:33 2022
 *
...
RT_MODEL_LIDAR_Base_T *LIDAR_Base(void)
{
  ...
  /* External mode info */
  LIDAR_Base_M->Sizes.checksums[0] = (2163359010U);
  LIDAR_Base_M->Sizes.checksums[1] = (2055963889U);
  LIDAR_Base_M->Sizes.checksums[2] = (1619460731U);
  LIDAR_Base_M->Sizes.checksums[3] = (1872742890U);
