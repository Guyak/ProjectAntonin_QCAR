###########################################################################
## Makefile generated for component 'LIDAR_AvoidAndStop'. 
## 
## Makefile     : LIDAR_AvoidAndStop.mk
## Generated on : Wed Oct 19 07:55:17 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LIDAR_AvoidAndStop.rt-linux_nvidia
...
PRODUCT_NAME              = LIDAR_AvoidAndStop
MAKEFILE                  = LIDAR_AvoidAndStop.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LIDAR_AvoidAndStop.rt-linux_nvidia
...
DEFINES_STANDARD = -DMODEL=LIDAR_AvoidAndStop -DNUMST=3 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/LIDAR_AvoidAndStop.c $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/LIDAR_AvoidAndStop_data.c $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/LIDAR_AvoidAndStop_main.c $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = LIDAR_AvoidAndStop.o LIDAR_AvoidAndStop_data.o LIDAR_AvoidAndStop_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
LIDAR_AvoidAndStop.o : $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/LIDAR_AvoidAndStop.c
	$(CC) $(CFLAGS) -o"$@" "$<"


LIDAR_AvoidAndStop_data.o : $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/LIDAR_AvoidAndStop_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


LIDAR_AvoidAndStop_main.o : $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/LIDAR_AvoidAndStop_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/LIDAR_AvoidAndStop_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
