  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(4).dtTransOffset = 606;
	
	  ;% Path_following_TP_P.yaw_ic
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 607;
  ...
  targMap.checksum0 = 4278793368;
  targMap.checksum1 = 3295387589;
  targMap.checksum2 = 3627295;
  targMap.checksum3 = 1278609232;
