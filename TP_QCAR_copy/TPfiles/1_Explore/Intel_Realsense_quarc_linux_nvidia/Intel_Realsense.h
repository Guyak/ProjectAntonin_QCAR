 ...
 * C source code generated on : Mon Oct 17 11:05:05 2022
 *
...
#ifndef RTW_HEADER_Intel_Realsense_h_
#define RTW_HEADER_Intel_Realsense_h_
#include <string.h>
#ifndef Intel_Realsense_COMMON_INCLUDES_
#define Intel_Realsense_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Intel_Realsense_COMMON_INCLUDES_ */

#include "Intel_Realsense_types.h"
...
#define Intel_Realsense_rtModel        RT_MODEL_Intel_Realsense_T
...
typedef struct {
  ...
  t_channel Channel;                   /* '<S7>/Channel' */
  t_channel Channel_f;                 /* '<S6>/Channel' */
  real32_T Depth_o1[921600];           /* '<S3>/Depth' */
  uint8_T RGB_o1[2764800];             /* '<S3>/RGB' */
  uint8_T ImageCompress[2764800];      /* '<S7>/Image Compress' */
  uint8_T ImageCompress_i[2764800];    /* '<S6>/Image Compress' */
  uint8_T ImageTransform[2764800];     /* '<S4>/Image Transform' */
  boolean_T Depth_o4;                  /* '<S3>/Depth' */
...
typedef struct {
  ...
  t_colorization ImageTransform_AlgHandle;/* '<S4>/Image Transform' */
  t_jpeg_compress ImageCompress_Compress;/* '<S7>/Image Compress' */
  t_jpeg_compress ImageCompress_Compress_m;/* '<S6>/Image Compress' */
  struct {
    void *Fifo;
  } Channel_PWORK;                     /* '<S7>/Channel' */

  struct {
    void *Fifo;
  } Channel_PWORK_p;                   /* '<S6>/Channel' */

  int32_T ImageCompress_DIMS1;         /* '<S7>/Image Compress' */
  int32_T ImageCompress_DIMS1_o;       /* '<S6>/Image Compress' */
  int8_T enabledDisplay_SubsysRanBC;   /* '<Root>/enabledDisplay' */
  int8_T depthDisplay_SubsysRanBC;     /* '<Root>/depthDisplay' */
  uint8_T ImageCompress_ScanLine[30720];/* '<S7>/Image Compress' */
  uint8_T ImageCompress_ScanLine_k[30720];/* '<S6>/Image Compress' */
} DW_Intel_Realsense_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Intel_Realsense_B
#define BlockIO                        B_Intel_Realsense_T
#define rtP                            Intel_Realsense_P
#define Parameters                     P_Intel_Realsense_T
#define rtDWork                        Intel_Realsense_DW
#define D_Work                         DW_Intel_Realsense_T

/* Parameters (default storage) */
struct P_Intel_Realsense_T_ {
  ...
  boolean_T VideoDisplay_UseHardware;
                                  ...
                                  */
  boolean_T VideoDisplay_UseHardware_k;
...
struct tag_RTM_Intel_Realsense_T {
  const char_T *path;
...
extern P_Intel_Realsense_T Intel_Realsense_P;

/* Block signals (default storage) */
extern B_Intel_Realsense_T Intel_Realsense_B;

/* Block states (default storage) */
extern DW_Intel_Realsense_T Intel_Realsense_DW;

/* Model entry point functions */
extern void Intel_Realsense_initialize(void);
extern void Intel_Realsense_output(void);
extern void Intel_Realsense_update(void);
extern void Intel_Realsense_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Intel_Realsense_rtModel *Intel_Realsense(void);
...
extern RT_MODEL_Intel_Realsense_T *const Intel_Realsense_M;
 ...
 *
 * '<Root>' : 'Intel_Realsense'
 * '<S1>'   : 'Intel_Realsense/Powered by QUARC'
 * '<S2>'   : 'Intel_Realsense/Quanser'
 * '<S3>'   : 'Intel_Realsense/captureRGBD'
 * '<S4>'   : 'Intel_Realsense/depthDisplay'
 * '<S5>'   : 'Intel_Realsense/enabledDisplay'
 * '<S6>'   : 'Intel_Realsense/depthDisplay/Video Compressed Display'
 * '<S7>'   : 'Intel_Realsense/enabledDisplay/Video Compressed Display'
 */
#endif                                 /* RTW_HEADER_Intel_Realsense_h_ */
