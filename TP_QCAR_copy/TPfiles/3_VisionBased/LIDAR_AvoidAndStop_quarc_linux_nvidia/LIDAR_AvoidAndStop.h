 ...
 * C source code generated on : Tue Oct 18 10:59:08 2022
 *
...
#ifndef RTW_HEADER_LIDAR_AvoidAndStop_h_
#define RTW_HEADER_LIDAR_AvoidAndStop_h_
#include <math.h>
#include <string.h>
#ifndef LIDAR_AvoidAndStop_COMMON_INCLUDES_
#define LIDAR_AvoidAndStop_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* LIDAR_AvoidAndStop_COMMON_INCLUDES_ */

#include "LIDAR_AvoidAndStop_types.h"
...
#define LIDAR_AvoidAndStop_rtModel     RT_MODEL_LIDAR_AvoidAndStop_T
...
typedef struct {
  ...
  boolean_T Y[720];                    /* '<Root>/MATLAB Function1' */
} B_LIDAR_AvoidAndStop_T;
...
} XDis_LIDAR_AvoidAndStop_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator1_Reset_ZCE;    /* '<S8>/Integrator1' */
} PrevZCX_LIDAR_AvoidAndStop_T;
...
#define rtB                            LIDAR_AvoidAndStop_B
#define BlockIO                        B_LIDAR_AvoidAndStop_T
#define rtX                            LIDAR_AvoidAndStop_X
#define ContinuousStates               X_LIDAR_AvoidAndStop_T
#define rtXdot                         LIDAR_AvoidAndStop_XDot
#define StateDerivatives               XDot_LIDAR_AvoidAndStop_T
#define tXdis                          LIDAR_AvoidAndStop_XDis
#define StateDisabled                  XDis_LIDAR_AvoidAndStop_T
#define rtP                            LIDAR_AvoidAndStop_P
#define Parameters                     P_LIDAR_AvoidAndStop_T
#define rtDWork                        LIDAR_AvoidAndStop_DW
#define D_Work                         DW_LIDAR_AvoidAndStop_T
#define rtPrevZCSigState               LIDAR_AvoidAndStop_PrevZCX
#define PrevZCSigStates                PrevZCX_LIDAR_AvoidAndStop_T

/* Parameters (default storage) */
struct P_LIDAR_AvoidAndStop_T_ {
...
struct tag_RTM_LIDAR_AvoidAndStop_T {
  const char_T *path;
...
extern P_LIDAR_AvoidAndStop_T LIDAR_AvoidAndStop_P;

/* Block signals (default storage) */
extern B_LIDAR_AvoidAndStop_T LIDAR_AvoidAndStop_B;

/* Continuous states (default storage) */
extern X_LIDAR_AvoidAndStop_T LIDAR_AvoidAndStop_X;

/* Block states (default storage) */
extern DW_LIDAR_AvoidAndStop_T LIDAR_AvoidAndStop_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_LIDAR_AvoidAndStop_T LIDAR_AvoidAndStop_PrevZCX;
...
extern void LIDAR_AvoidAndStop_initialize(void);
extern void LIDAR_AvoidAndStop_output0(void);
extern void LIDAR_AvoidAndStop_update0(void);
extern void LIDAR_AvoidAndStop_output2(void);
extern void LIDAR_AvoidAndStop_update2(void);
extern void LIDAR_AvoidAndStop_output(int_T tid);
extern void LIDAR_AvoidAndStop_update(int_T tid);
extern void LIDAR_AvoidAndStop_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern LIDAR_AvoidAndStop_rtModel *LIDAR_AvoidAndStop(void);
...
extern RT_MODEL_LIDAR_AvoidAndStop_T *const LIDAR_AvoidAndStop_M;
 ...
 *
 * '<Root>' : 'LIDAR_AvoidAndStop'
 * '<S1>'   : 'LIDAR_AvoidAndStop/MATLAB Function1'
 * '<S2>'   : 'LIDAR_AvoidAndStop/Quanser2'
 * '<S3>'   : 'LIDAR_AvoidAndStop/basicSpeedEstimation'
 * '<S4>'   : 'LIDAR_AvoidAndStop/captureLIDAR'
 * '<S5>'   : 'LIDAR_AvoidAndStop/filtering'
 * '<S6>'   : 'LIDAR_AvoidAndStop/plot 2D planar vehicle'
 * '<S7>'   : 'LIDAR_AvoidAndStop/simple kinematic 2D steered vehicle model'
 * '<S8>'   : 'LIDAR_AvoidAndStop/speedController'
 * '<S9>'   : 'LIDAR_AvoidAndStop/captureLIDAR/MATLAB Function'
 * '<S10>'  : 'LIDAR_AvoidAndStop/filtering/Second-Order Low-Pass Filter'
 * '<S11>'  : 'LIDAR_AvoidAndStop/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_LIDAR_AvoidAndStop_h_ */
