...
typedef RT_MODEL_Autonomous_Driving_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Autonomous_Driving(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Autonomous_Driving_M, GBLbuf.message);
}
...
static int_T tSubRate(RT_MODEL * S, qsem_t * sem, int_T tid)
{
  while (1) {
    ...
    if (is_sample2_hit) {
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&Autonomous_Driving_DW.ComputationTime_ComputationTi_o, &end_time,
           &Autonomous_Driving_DW.ComputationTime_BeginTime_b);
      }
    ...
    if (is_sample3_hit) {
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&Autonomous_Driving_DW.ComputationTime_ComputationT_om, &end_time,
           &Autonomous_Driving_DW.ComputationTime_BeginTime_p);
      }
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Autonomous_Driving -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
