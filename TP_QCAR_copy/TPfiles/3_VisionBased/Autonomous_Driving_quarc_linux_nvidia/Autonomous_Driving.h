 ...
 * C source code generated on : Tue Oct 18 09:33:42 2022
 *
...
#ifndef RTW_HEADER_Autonomous_Driving_h_
#define RTW_HEADER_Autonomous_Driving_h_
#include <math.h>
#include <stdlib.h>
#include <string.h>
#ifndef Autonomous_Driving_COMMON_INCLUDES_
#define Autonomous_Driving_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
...
#endif                                 /* Autonomous_Driving_COMMON_INCLUDES_ */

#include "Autonomous_Driving_types.h"
...
#define Autonomous_Driving_rtModel     RT_MODEL_Autonomous_Driving_T

/* Block signals (default storage) */
typedef struct {
  uint8_T ImageTransform[167895];      /* '<S12>/Image Transform' */
  uint8_T imageToThreshold[167895];    /* '<Root>/MATLAB Function' */
  real_T region[14400];          /* '<S17>/Steering based  image subselector' */
  uint8_T y_m[112614];                 /* '<S19>/Quick Resize1' */
  uint8_T y_d[112614];                 /* '<S19>/Combine images' */
  ...
  int8_T o_data[6279];
  uint8_T y_b[6279];                   /* '<S19>/Quick Resize' */
  uint8_T x_tmp_data[6279];
...
} XDis_Autonomous_Driving_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator1_Reset_ZCE;    /* '<S18>/Integrator1' */
} PrevZCX_Autonomous_Driving_T;
...
#define rtB                            Autonomous_Driving_B
#define BlockIO                        B_Autonomous_Driving_T
#define rtX                            Autonomous_Driving_X
#define ContinuousStates               X_Autonomous_Driving_T
#define rtXdot                         Autonomous_Driving_XDot
#define StateDerivatives               XDot_Autonomous_Driving_T
#define tXdis                          Autonomous_Driving_XDis
#define StateDisabled                  XDis_Autonomous_Driving_T
#define rtP                            Autonomous_Driving_P
#define Parameters                     P_Autonomous_Driving_T
#define rtDWork                        Autonomous_Driving_DW
#define D_Work                         DW_Autonomous_Driving_T
#define rtPrevZCSigState               Autonomous_Driving_PrevZCX
#define PrevZCSigStates                PrevZCX_Autonomous_Driving_T

/* Parameters (default storage) */
struct P_Autonomous_Driving_T_ {
  ...
  real_T Constant2_Value_f;            /* Expression: 1
                                        ...
                                        */
  real_T SpeedMaxms_Value;             /* Expression: 1
  ...
  real_T ImageTransform_RCoeff[2];     /* Expression: radial_coeffs
                                        * Referenced by: '<S12>/Image Transform'
                                        */
  real_T HueMin_Value;                 /* Expression: 50
                                        * Referenced by: '<S21>/Hue Min'
                                        */
  real_T HueMax_Value;                 /* Expression: 80
  ...
  real_T Gain6_Gain;                   /* Expression: 255/360
                                        ...
                                        */
  real_T SatMin_Value;                 /* Expression: 100
                                        * Referenced by: '<S21>/Sat Min'
                                        */
  real_T SatMax_Value;                 /* Expression: 255
  ...
  real_T Constant6_Value_l;            /* Expression: 1
                                        ...
                                        */
  real_T ValMin_Value;                 /* Expression: 100
...
struct tag_RTM_Autonomous_Driving_T {
  const char_T *path;
...
extern P_Autonomous_Driving_T Autonomous_Driving_P;

/* Block signals (default storage) */
extern B_Autonomous_Driving_T Autonomous_Driving_B;

/* Continuous states (default storage) */
extern X_Autonomous_Driving_T Autonomous_Driving_X;

/* Block states (default storage) */
extern DW_Autonomous_Driving_T Autonomous_Driving_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_Autonomous_Driving_T Autonomous_Driving_PrevZCX;
...
extern void Autonomous_Driving_initialize(void);
extern void Autonomous_Driving_output0(void);
extern void Autonomous_Driving_update0(void);
extern void Autonomous_Driving_output2(void);
extern void Autonomous_Driving_update2(void);
extern void Autonomous_Driving_output3(void);
extern void Autonomous_Driving_update3(void);
extern void Autonomous_Driving_output(int_T tid);
extern void Autonomous_Driving_update(int_T tid);
extern void Autonomous_Driving_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Autonomous_Driving_rtModel *Autonomous_Driving(void);
...
extern RT_MODEL_Autonomous_Driving_T *const Autonomous_Driving_M;
 ...
 *
 * '<Root>' : 'Autonomous_Driving'
 * '<S1>'   : 'Autonomous_Driving/Display Depth'
 * '<S2>'   : 'Autonomous_Driving/Display RGB'
 * '<S3>'   : 'Autonomous_Driving/MATLAB Function'
 * '<S4>'   : 'Autonomous_Driving/Powered by QUARC'
 * '<S5>'   : 'Autonomous_Driving/Quanser'
 * '<S6>'   : 'Autonomous_Driving/RGB Image  Pre-Proccessing'
 * '<S7>'   : 'Autonomous_Driving/automatedDriving'
 * '<S8>'   : 'Autonomous_Driving/basicQCarIO'
 * '<S9>'   : 'Autonomous_Driving/basicSpeedEstimation'
 * '<S10>'  : 'Autonomous_Driving/captureCSI'
 * '<S11>'  : 'Autonomous_Driving/captureDepth'
 * '<S12>'  : 'Autonomous_Driving/colorThresholdingHSV'
 * '<S13>'  : 'Autonomous_Driving/indicatorAndLamps'
 * '<S14>'  : 'Autonomous_Driving/monitorTiming '
 * '<S15>'  : 'Autonomous_Driving/monitorTiming 1'
 * '<S16>'  : 'Autonomous_Driving/monitorTiming 2'
 * '<S17>'  : 'Autonomous_Driving/obstacleDetection'
 * '<S18>'  : 'Autonomous_Driving/speedController'
 * '<S19>'  : 'Autonomous_Driving/steeringCalculation'
 * '<S20>'  : 'Autonomous_Driving/turnSpeedHandling'
 * '<S21>'  : 'Autonomous_Driving/userInput'
 * '<S22>'  : 'Autonomous_Driving/Display Depth/Depth Camera Information'
 * '<S23>'  : 'Autonomous_Driving/Display RGB/RGB Image Processed'
 * '<S24>'  : 'Autonomous_Driving/RGB Image  Pre-Proccessing/RGB Image No Threshold'
 * '<S25>'  : 'Autonomous_Driving/automatedDriving/MATLAB Function'
 * '<S26>'  : 'Autonomous_Driving/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S27>'  : 'Autonomous_Driving/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S28>'  : 'Autonomous_Driving/basicQCarIO/Second-Order Low-Pass Filter2'
 * '<S29>'  : 'Autonomous_Driving/colorThresholdingHSV/Subsystem'
 * '<S30>'  : 'Autonomous_Driving/indicatorAndLamps/Compare To Constant1'
 * '<S31>'  : 'Autonomous_Driving/indicatorAndLamps/Compare To Constant2'
 * '<S32>'  : 'Autonomous_Driving/indicatorAndLamps/Compare To Constant3'
 * '<S33>'  : 'Autonomous_Driving/indicatorAndLamps/Left Steering Limit'
 * '<S34>'  : 'Autonomous_Driving/indicatorAndLamps/One Shot'
 * '<S35>'  : 'Autonomous_Driving/indicatorAndLamps/Right Steering Limit'
 * '<S36>'  : 'Autonomous_Driving/obstacleDetection/Draw Lines Module'
 * '<S37>'  : 'Autonomous_Driving/obstacleDetection/MATLAB Function'
 * '<S38>'  : 'Autonomous_Driving/obstacleDetection/Steering based  image subselector'
 * '<S39>'  : 'Autonomous_Driving/speedController/Compare To Zero'
 * '<S40>'  : 'Autonomous_Driving/steeringCalculation/Combine images'
 * '<S41>'  : 'Autonomous_Driving/steeringCalculation/Find slope and intercept'
 * '<S42>'  : 'Autonomous_Driving/steeringCalculation/MATLAB Function'
 * '<S43>'  : 'Autonomous_Driving/steeringCalculation/Quick Resize'
 * '<S44>'  : 'Autonomous_Driving/steeringCalculation/Quick Resize1'
 * '<S45>'  : 'Autonomous_Driving/userInput/Brightness Mean (0)'
 * '<S46>'  : 'Autonomous_Driving/userInput/Brightness Window (1)'
 * '<S47>'  : 'Autonomous_Driving/userInput/Color Mixing Mean (0)'
 * '<S48>'  : 'Autonomous_Driving/userInput/Color Mixing Window (1)'
 * '<S49>'  : 'Autonomous_Driving/userInput/Color Selecting Mean (0)'
 * '<S50>'  : 'Autonomous_Driving/userInput/Color Selecting Window (1)'
 * '<S51>'  : 'Autonomous_Driving/userInput/Distane To Lane (0) '
 * '<S52>'  : 'Autonomous_Driving/userInput/Speed Selector (1)'
 * '<S53>'  : 'Autonomous_Driving/userInput/Stopping Distance Offset (0)'
 */
#endif                                 /* RTW_HEADER_Autonomous_Driving_h_ */
