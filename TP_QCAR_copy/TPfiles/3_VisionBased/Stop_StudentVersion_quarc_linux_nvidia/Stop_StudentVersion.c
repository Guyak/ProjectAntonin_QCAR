...
void Stop_StudentVersion_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Stop_StudentVersion_M)) {
    ...
    if ((Stop_StudentVersion_B.Selector < 0.4) &&
        (Stop_StudentVersion_B.Selector > 0.05)) {
      rtb_SteeringBias = 0.0;
    } else {
...
RT_MODEL_Stop_StudentVersion_T *Stop_StudentVersion(void)
{
  ...
  /* External mode info */
  Stop_StudentVersion_M->Sizes.checksums[0] = (1145381730U);
  Stop_StudentVersion_M->Sizes.checksums[1] = (3207851109U);
  Stop_StudentVersion_M->Sizes.checksums[2] = (1689980265U);
  Stop_StudentVersion_M->Sizes.checksums[3] = (433238208U);
