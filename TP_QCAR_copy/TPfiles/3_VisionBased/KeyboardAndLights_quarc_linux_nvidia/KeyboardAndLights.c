 ...
 * C source code generated on : Wed Oct 19 10:17:56 2022
 *
...
void KeyboardAndLights_output(void)
{
  ...
  KeyboardAndLights_B.Product = ((KeyboardAndLights_B.Unwrap224 -
    ...
    KeyboardAndLights_P.Constant1_Value_f) * KeyboardAndLights_P.Constant2_Value;
  ...
  if (rtmIsMajorTimeStep(KeyboardAndLights_M)) {
     ...
     *  Gain: '<Root>/Gain3'
     */
    rtb_Add = KeyboardAndLights_P.Gain2_Gain * (real_T)rtb_HostKeyboard_o2[1] +
      KeyboardAndLights_P.Gain3_Gain * (real_T)rtb_HostKeyboard_o2[2];

    /* DiscretePulseGenerator: '<S1>/Pulsing Light' */
    rtb_brakelights = (KeyboardAndLights_DW.clockTickCounter <
                       KeyboardAndLights_P.PulsingLight_Duty) &&
      (KeyboardAndLights_DW.clockTickCounter >= 0) ?
      KeyboardAndLights_P.PulsingLight_Amp : 0.0;
    if (KeyboardAndLights_DW.clockTickCounter >=
        KeyboardAndLights_P.PulsingLight_Period - 1.0) {
      KeyboardAndLights_DW.clockTickCounter = 0;
    } else {
      KeyboardAndLights_DW.clockTickCounter++;
    }

    /* End of DiscretePulseGenerator: '<S1>/Pulsing Light' */

    /* Switch: '<S1>/Switch' */
    if (rtb_brakelights > KeyboardAndLights_P.Switch_Threshold) {
      /* RelationalOperator: '<S2>/Compare' incorporates:
       *  Constant: '<S2>/Constant'
       */
      rtb_Compare = (rtb_Add > KeyboardAndLights_P.LeftSteeringLimit_const);

      /* RelationalOperator: '<S5>/Compare' incorporates:
       *  Constant: '<S5>/Constant'
       */
      rtb_Compare_k = (rtb_Add < KeyboardAndLights_P.RightSteeringLimit_const);
       ...
       */
      rtb_TmpSignalConversionAtHILWri[1] = rtb_Compare;
      rtb_TmpSignalConversionAtHILWri[2] = rtb_Compare_k;
      rtb_TmpSignalConversionAtHILWri[3] = rtb_Compare;
      rtb_TmpSignalConversionAtHILWri[4] = rtb_Compare_k;
    } else {
      /* SignalConversion generated from: '<S6>/HIL Write' incorporates:
       *  Constant: '<S1>/Constant1'
       */
      rtb_TmpSignalConversionAtHILWri[1] = KeyboardAndLights_P.Constant1_Value;
      rtb_TmpSignalConversionAtHILWri[2] = KeyboardAndLights_P.Constant1_Value;
      rtb_TmpSignalConversionAtHILWri[3] = KeyboardAndLights_P.Constant1_Value;
      rtb_TmpSignalConversionAtHILWri[4] = KeyboardAndLights_P.Constant1_Value;
    }

    /* End of Switch: '<S1>/Switch' */

    /* SignalConversion generated from: '<S6>/HIL Write' incorporates:
     *  Bias: '<S6>/Steering Bias'
     *  Gain: '<S6>/Gain'
     */
    rtb_TmpSignalConversionAtHILWri[0] = KeyboardAndLights_P.Gain_Gain_b *
      rtb_Add + KeyboardAndLights_P.SteeringBias_Bias;
     ...
     *  DataTypeConversion: '<Root>/Data Type Conversion3'
     */
    rtb_TmpSignalConversionAtHILWri[6] = rtb_HostKeyboard_o2[3];
...
void KeyboardAndLights_initialize(void)
{
  ...
  /* S-Function Block: KeyboardAndLights/basicQCarIO/HIL Initialize (hil_initialize_block) */
  {
    ...
    result = hil_set_card_specific_options
      (KeyboardAndLights_DW.HILInitialize_Card, " ", 2);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(KeyboardAndLights_M, _rt_error_message);
  ...
  /* InitializeConditions for DiscretePulseGenerator: '<S1>/Pulsing Light' */
  KeyboardAndLights_DW.clockTickCounter = 0;
...
RT_MODEL_KeyboardAndLights_T *KeyboardAndLights(void)
{
  ...
  /* External mode info */
  KeyboardAndLights_M->Sizes.checksums[0] = (3830601166U);
  KeyboardAndLights_M->Sizes.checksums[1] = (154600253U);
  KeyboardAndLights_M->Sizes.checksums[2] = (2807996345U);
  KeyboardAndLights_M->Sizes.checksums[3] = (438087729U);
  ...
  KeyboardAndLights_M->Sizes.numBlocks = (71);/* Number of blocks */
  KeyboardAndLights_M->Sizes.numBlockIO = (14);/* Number of block outputs */
  KeyboardAndLights_M->Sizes.numBlockPrms = (193);/* Sum of parameter "widths" */
