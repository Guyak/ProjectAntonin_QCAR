###########################################################################
## Makefile generated for component 'Manual_Drive'. 
## 
## Makefile     : Manual_Drive.mk
## Generated on : Mon Jan 17 10:36:33 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Manual_Drive.rt-linux_nvidia
...
PRODUCT_NAME              = Manual_Drive
MAKEFILE                  = Manual_Drive.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/TP_QCAR/TP_21_22/SAUSSE_MARREC_PIMPARD/TPfiles/4_LIDARObstacleAvoidance
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Manual_Drive.rt-linux_nvidia
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Manual_Drive_quarc_linux_nvidia -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=Manual_Drive -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Manual_Drive_quarc_linux_nvidia/Manual_Drive.c $(START_DIR)/Manual_Drive_quarc_linux_nvidia/Manual_Drive_data.c $(START_DIR)/Manual_Drive_quarc_linux_nvidia/Manual_Drive_main.c $(START_DIR)/Manual_Drive_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/Manual_Drive_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/Manual_Drive_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = Manual_Drive.o Manual_Drive_data.o Manual_Drive_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/Manual_Drive_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/Manual_Drive_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
Manual_Drive.o : $(START_DIR)/Manual_Drive_quarc_linux_nvidia/Manual_Drive.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Manual_Drive_data.o : $(START_DIR)/Manual_Drive_quarc_linux_nvidia/Manual_Drive_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Manual_Drive_main.o : $(START_DIR)/Manual_Drive_quarc_linux_nvidia/Manual_Drive_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/Manual_Drive_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/Manual_Drive_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/Manual_Drive_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
