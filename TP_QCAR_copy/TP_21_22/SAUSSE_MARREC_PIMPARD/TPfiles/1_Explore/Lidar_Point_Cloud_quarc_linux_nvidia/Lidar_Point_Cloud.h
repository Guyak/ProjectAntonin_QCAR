...
typedef struct {
  real_T RangingSensor1_o1[2000];      /* '<S3>/Ranging Sensor1' */
  real_T RangingSensor1_o2[2000];      /* '<S3>/Ranging Sensor1' */
  real_T RangingSensor1_o3[2000];      /* '<S3>/Ranging Sensor1' */
  real_T RangingSensor1_o4[2000];      /* '<S3>/Ranging Sensor1' */
...
typedef struct {
  t_ranging_measurement RangingSensor1_Measurements[2000];/* '<S3>/Ranging Sensor1' */
