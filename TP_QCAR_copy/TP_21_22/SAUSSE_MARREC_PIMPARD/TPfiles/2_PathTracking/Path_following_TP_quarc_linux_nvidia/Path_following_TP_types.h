...
#ifndef struct_tag_LwMkLfKNooFEGgqqZadUtG
#define struct_tag_LwMkLfKNooFEGgqqZadUtG

struct tag_LwMkLfKNooFEGgqqZadUtG
{
  ...
  real_T LastPose[3];
  real_T WaypointsInternal[1258];
};

#endif                                 /* struct_tag_LwMkLfKNooFEGgqqZadUtG */

#ifndef typedef_nav_slalgs_internal_PurePursu_T
#define typedef_nav_slalgs_internal_PurePursu_T

typedef struct tag_LwMkLfKNooFEGgqqZadUtG nav_slalgs_internal_PurePursu_T;
