  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Path_following_TP_P.p2
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_P.vehicle_length
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 1260;
	
	  ;% Path_following_TP_P.yaw_ic
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 1261;
  ...
  targMap.checksum0 = 3578838489;
  targMap.checksum1 = 2310218526;
  targMap.checksum2 = 199625702;
  targMap.checksum3 = 4009779772;
