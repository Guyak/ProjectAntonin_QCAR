...
RT_MODEL_Stop_StudentVersion_T *Stop_StudentVersion(void)
{
  ...
  /* External mode info */
  Stop_StudentVersion_M->Sizes.checksums[0] = (670471114U);
  Stop_StudentVersion_M->Sizes.checksums[1] = (3092843662U);
  Stop_StudentVersion_M->Sizes.checksums[2] = (1924635911U);
  Stop_StudentVersion_M->Sizes.checksums[3] = (3020047488U);
