  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Path_following_TP_P.target
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_P.vehicle_length
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 562;
	
	  ;% Path_following_TP_P.yaw_ic
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 563;
  ...
  targMap.checksum0 = 3941707123;
  targMap.checksum1 = 3510006984;
  targMap.checksum2 = 3717956031;
  targMap.checksum3 = 1926485205;
