...
#ifndef RTW_HEADER_LIDAR_Stop_h_
#define RTW_HEADER_LIDAR_Stop_h_
#include <math.h>
#include <string.h>
#ifndef LIDAR_Stop_COMMON_INCLUDES_
#define LIDAR_Stop_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* LIDAR_Stop_COMMON_INCLUDES_ */

#include "LIDAR_Stop_types.h"
...
#define LIDAR_Stop_rtModel             RT_MODEL_LIDAR_Stop_T
...
#define rtB                            LIDAR_Stop_B
#define BlockIO                        B_LIDAR_Stop_T
#define rtX                            LIDAR_Stop_X
#define ContinuousStates               X_LIDAR_Stop_T
#define rtXdot                         LIDAR_Stop_XDot
#define StateDerivatives               XDot_LIDAR_Stop_T
#define tXdis                          LIDAR_Stop_XDis
#define StateDisabled                  XDis_LIDAR_Stop_T
#define rtP                            LIDAR_Stop_P
#define Parameters                     P_LIDAR_Stop_T
#define rtDWork                        LIDAR_Stop_DW
#define D_Work                         DW_LIDAR_Stop_T
#define rtPrevZCSigState               LIDAR_Stop_PrevZCX
#define PrevZCSigStates                PrevZCX_LIDAR_Stop_T

/* Parameters (default storage) */
struct P_LIDAR_Stop_T_ {
  ...
  real_T Unwrap224_Modulus;            /* Expression: modulus
                                        ...
                                        */
  real_T Kim_Gain;                     /* Expression: 0.4
...
extern P_LIDAR_Stop_T LIDAR_Stop_P;

/* Block signals (default storage) */
extern B_LIDAR_Stop_T LIDAR_Stop_B;

/* Continuous states (default storage) */
extern X_LIDAR_Stop_T LIDAR_Stop_X;

/* Block states (default storage) */
extern DW_LIDAR_Stop_T LIDAR_Stop_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_LIDAR_Stop_T LIDAR_Stop_PrevZCX;
...
extern void LIDAR_Stop_initialize(void);
extern void LIDAR_Stop_output0(void);
extern void LIDAR_Stop_update0(void);
extern void LIDAR_Stop_output2(void);
extern void LIDAR_Stop_update2(void);
extern void LIDAR_Stop_output(int_T tid);
extern void LIDAR_Stop_update(int_T tid);
extern void LIDAR_Stop_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern LIDAR_Stop_rtModel *LIDAR_Stop(void);
...
extern RT_MODEL_LIDAR_Stop_T *const LIDAR_Stop_M;
 ...
 *
 * '<Root>' : 'LIDAR_Stop'
 * '<S1>'   : 'LIDAR_Stop/MATLAB Function1'
 * '<S2>'   : 'LIDAR_Stop/Quanser2'
 * '<S3>'   : 'LIDAR_Stop/basicSpeedEstimation'
 * '<S4>'   : 'LIDAR_Stop/captureLIDAR'
 * '<S5>'   : 'LIDAR_Stop/filtering'
 * '<S6>'   : 'LIDAR_Stop/plot 2D planar vehicle'
 * '<S7>'   : 'LIDAR_Stop/simple kinematic 2D steered vehicle model'
 * '<S8>'   : 'LIDAR_Stop/speedController'
 * '<S9>'   : 'LIDAR_Stop/captureLIDAR/MATLAB Function'
 * '<S10>'  : 'LIDAR_Stop/filtering/Second-Order Low-Pass Filter'
 * '<S11>'  : 'LIDAR_Stop/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_LIDAR_Stop_h_ */
