###########################################################################
## Makefile generated for component 'LIDAR_Stop'. 
## 
## Makefile     : LIDAR_Stop.mk
## Generated on : Mon Jan 24 17:35:33 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LIDAR_Stop.rt-linux_nvidia
...
PRODUCT_NAME              = LIDAR_Stop
MAKEFILE                  = LIDAR_Stop.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/TP_QCAR/TP_21_22/IDELMOU_ELMORSLI_MATAICH_MOUTAIB/4_LIDARObstacleAvoidance
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LIDAR_Stop.rt-linux_nvidia
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/LIDAR_Stop_quarc_linux_nvidia -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=LIDAR_Stop -DNUMST=3 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/LIDAR_Stop.c $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/LIDAR_Stop_data.c $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/LIDAR_Stop_main.c $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = LIDAR_Stop.o LIDAR_Stop_data.o LIDAR_Stop_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
LIDAR_Stop.o : $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/LIDAR_Stop.c
	$(CC) $(CFLAGS) -o"$@" "$<"


LIDAR_Stop_data.o : $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/LIDAR_Stop_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


LIDAR_Stop_main.o : $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/LIDAR_Stop_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/LIDAR_Stop_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
