  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% LIDAR_Stop_P.RangingSensor1_Budget
	  section.data(15).logicalSrcIdx = 28;
	  section.data(15).dtTransOffset = 14;
	
	  ;% LIDAR_Stop_P.RangingSensor1_Period
	  ...
	  ;% LIDAR_Stop_P.RangingSensor1_Range
	  ...
	  ;% LIDAR_Stop_P.RangingSensor1_Active
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% LIDAR_Stop_B.RangingSensor1_o1
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_Stop_B.RangingSensor1_o2
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1300;
	
	  ;% LIDAR_Stop_B.RangingSensor1_o3
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2600;
	
	  ;% LIDAR_Stop_B.RangingSensor1_o4
	  section.data(4).logicalSrcIdx = 3;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% LIDAR_Stop_DW.RangingSensor1_Measurements
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
  ...
  targMap.checksum0 = 3299257801;
  targMap.checksum1 = 1202896259;
  targMap.checksum2 = 3512035380;
  targMap.checksum3 = 4226527302;
