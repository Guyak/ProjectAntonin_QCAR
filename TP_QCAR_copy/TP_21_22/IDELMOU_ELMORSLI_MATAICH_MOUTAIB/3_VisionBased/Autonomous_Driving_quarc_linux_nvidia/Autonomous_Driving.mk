###########################################################################
## Makefile generated for component 'Autonomous_Driving'. 
## 
## Makefile     : Autonomous_Driving.mk
## Generated on : Mon Jan 24 16:18:31 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Autonomous_Driving.rt-linux_nvidia
...
PRODUCT_NAME              = Autonomous_Driving
MAKEFILE                  = Autonomous_Driving.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Autonomous_Driving.rt-linux_nvidia
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Autonomous_Driving_quarc_linux_nvidia -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=Autonomous_Driving -DNUMST=4 -DNCSTATES=7 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/Autonomous_Driving.c $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/Autonomous_Driving_data.c $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/Autonomous_Driving_main.c $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = Autonomous_Driving.o Autonomous_Driving_data.o Autonomous_Driving_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
LIBS = C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI5A2F~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LIBQUA~4.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/libhil.a C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI8DF1~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI2456~1.A
...
%.o : $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
Autonomous_Driving.o : $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/Autonomous_Driving.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Autonomous_Driving_data.o : $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/Autonomous_Driving_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Autonomous_Driving_main.o : $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/Autonomous_Driving_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/Autonomous_Driving_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
