...
## Generated on : Mon Jan 24 15:41:06 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RGBD_Imaging.rt-linux_nvidia
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RGBD_Imaging.rt-linux_nvidia
...
SRCS = $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/RGBD_Imaging.c $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/RGBD_Imaging_data.c $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/RGBD_Imaging_main.c $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
%.o : $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
RGBD_Imaging.o : $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/RGBD_Imaging.c
	$(CC) $(CFLAGS) -o"$@" "$<"


RGBD_Imaging_data.o : $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/RGBD_Imaging_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


RGBD_Imaging_main.o : $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/RGBD_Imaging_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/RGBD_Imaging_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
