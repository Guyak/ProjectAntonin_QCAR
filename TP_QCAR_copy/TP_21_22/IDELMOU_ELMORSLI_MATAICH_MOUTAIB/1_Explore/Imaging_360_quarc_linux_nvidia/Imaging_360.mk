###########################################################################
## Makefile generated for component 'Imaging_360'. 
## 
## Makefile     : Imaging_360.mk
## Generated on : Mon Jan 24 08:57:09 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Imaging_360.rt-linux_nvidia
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Imaging_360.rt-linux_nvidia
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Imaging_360_quarc_linux_nvidia -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=Imaging_360 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Imaging_360_quarc_linux_nvidia/Imaging_360.c $(START_DIR)/Imaging_360_quarc_linux_nvidia/Imaging_360_data.c $(START_DIR)/Imaging_360_quarc_linux_nvidia/Imaging_360_main.c $(START_DIR)/Imaging_360_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/Imaging_360_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/Imaging_360_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = Imaging_360.o Imaging_360_data.o Imaging_360_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
LIBS = C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI5A2F~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LIBQUA~4.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI8DF1~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI2456~1.A
...
%.o : $(START_DIR)/Imaging_360_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/Imaging_360_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
Imaging_360.o : $(START_DIR)/Imaging_360_quarc_linux_nvidia/Imaging_360.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Imaging_360_data.o : $(START_DIR)/Imaging_360_quarc_linux_nvidia/Imaging_360_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Imaging_360_main.o : $(START_DIR)/Imaging_360_quarc_linux_nvidia/Imaging_360_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/Imaging_360_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/Imaging_360_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/Imaging_360_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
