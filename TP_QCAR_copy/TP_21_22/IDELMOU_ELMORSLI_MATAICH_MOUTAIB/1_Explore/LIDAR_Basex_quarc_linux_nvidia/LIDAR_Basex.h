...
#ifndef RTW_HEADER_LIDAR_Basex_h_
#define RTW_HEADER_LIDAR_Basex_h_
#include <math.h>
#include <string.h>
#ifndef LIDAR_Basex_COMMON_INCLUDES_
#define LIDAR_Basex_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* LIDAR_Basex_COMMON_INCLUDES_ */

#include "LIDAR_Basex_types.h"
...
#define LIDAR_Basex_rtModel            RT_MODEL_LIDAR_Basex_T

/* Block signals (default storage) */
typedef struct {
  real_T RangingSensor1_o1[1300];      /* '<S4>/Ranging Sensor1' */
  real_T RangingSensor1_o2[1300];      /* '<S4>/Ranging Sensor1' */
  real_T RangingSensor1_o3[1300];      /* '<S4>/Ranging Sensor1' */
  real_T RangingSensor1_o4[1300];      /* '<S4>/Ranging Sensor1' */
...
typedef struct {
  t_ranging_measurement RangingSensor1_Measurements[1300];/* '<S4>/Ranging Sensor1' */
  ...
  t_ranging_sensor RangingSensor1_Sensor;/* '<S4>/Ranging Sensor1' */
...
#define rtB                            LIDAR_Basex_B
#define BlockIO                        B_LIDAR_Basex_T
#define rtX                            LIDAR_Basex_X
#define ContinuousStates               X_LIDAR_Basex_T
#define rtXdot                         LIDAR_Basex_XDot
#define StateDerivatives               XDot_LIDAR_Basex_T
#define tXdis                          LIDAR_Basex_XDis
#define StateDisabled                  XDis_LIDAR_Basex_T
#define rtP                            LIDAR_Basex_P
#define Parameters                     P_LIDAR_Basex_T
#define rtDWork                        LIDAR_Basex_DW
#define D_Work                         DW_LIDAR_Basex_T
#define rtPrevZCSigState               LIDAR_Basex_PrevZCX
#define PrevZCSigStates                PrevZCX_LIDAR_Basex_T

/* Parameters (default storage) */
struct P_LIDAR_Basex_T_ {
  ...
  real_T RangingSensor1_Budget;        /* Expression: timing_budget
                                        * Referenced by: '<S4>/Ranging Sensor1'
                                        */
  ...
  real_T RangingSensor1_MaxInterpolation;/* Expression: max_interpolated_distance
                                          * Referenced by: '<S4>/Ranging Sensor1'
                                          */
  real_T RangingSensor1_MaxInterpolati_p;/* Expression: max_interpolated_angle
                                          * Referenced by: '<S4>/Ranging Sensor1'
                                          */
...
extern P_LIDAR_Basex_T LIDAR_Basex_P;

/* Block signals (default storage) */
extern B_LIDAR_Basex_T LIDAR_Basex_B;

/* Continuous states (default storage) */
extern X_LIDAR_Basex_T LIDAR_Basex_X;

/* Block states (default storage) */
extern DW_LIDAR_Basex_T LIDAR_Basex_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_LIDAR_Basex_T LIDAR_Basex_PrevZCX;
...
extern void LIDAR_Basex_initialize(void);
extern void LIDAR_Basex_output0(void);
extern void LIDAR_Basex_update0(void);
extern void LIDAR_Basex_output2(void);
extern void LIDAR_Basex_update2(void);
extern void LIDAR_Basex_output(int_T tid);
extern void LIDAR_Basex_update(int_T tid);
extern void LIDAR_Basex_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern LIDAR_Basex_rtModel *LIDAR_Basex(void);
...
extern RT_MODEL_LIDAR_Basex_T *const LIDAR_Basex_M;
 ...
 *
 * '<Root>' : 'LIDAR_Basex'
 * '<S1>'   : 'LIDAR_Basex/MATLAB Function1'
 * '<S2>'   : 'LIDAR_Basex/Quanser2'
 * '<S3>'   : 'LIDAR_Basex/basicSpeedEstimation'
 * '<S4>'   : 'LIDAR_Basex/captureLIDAR'
 * '<S5>'   : 'LIDAR_Basex/filtering'
 * '<S6>'   : 'LIDAR_Basex/plot 2D planar vehicle'
 * '<S7>'   : 'LIDAR_Basex/simple kinematic 2D steered vehicle model'
 * '<S8>'   : 'LIDAR_Basex/speedController'
 * '<S9>'   : 'LIDAR_Basex/captureLIDAR/MATLAB Function'
 * '<S10>'  : 'LIDAR_Basex/filtering/Second-Order Low-Pass Filter'
 * '<S11>'  : 'LIDAR_Basex/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_LIDAR_Basex_h_ */
