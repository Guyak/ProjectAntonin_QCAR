...
typedef RT_MODEL_Intel_Realsense_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Intel_Realsense(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Intel_Realsense_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Intel_Realsense -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
