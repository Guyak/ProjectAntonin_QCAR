...
void Basic_IO_initialize(void)
{
  ...
  /* S-Function Block: Basic_IO/basicQCarIO/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    result = hil_set_card_specific_options(Basic_IO_DW.HILInitialize_Card,
    ...
    result = hil_set_digital_directions(Basic_IO_DW.HILInitialize_Card,
      Basic_IO_P.HILInitialize_DIChannels, 20U,
    ...
    if ((Basic_IO_P.HILInitialize_POPStart && !is_switching) ||
      ...
      Basic_IO_DW.HILInitialize_POModeValues[0] =
        (Basic_IO_P.HILInitialize_POModes[0]);

      {
        int_T i1;
        int32_T *dw_POModeValues = &Basic_IO_DW.HILInitialize_POModeValues[1];
        for (i1=0; i1 < 7; i1++) {
          dw_POModeValues[i1] = (Basic_IO_P.HILInitialize_POModes[1]);
        }
      }

      result = hil_set_pwm_mode(Basic_IO_DW.HILInitialize_Card,
        Basic_IO_P.HILInitialize_POChannels, 8U, (t_pwm_mode *)
        &Basic_IO_DW.HILInitialize_POModeValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
...

      {
        ...
        int32_T *dw_POModeValues = &Basic_IO_DW.HILInitialize_POModeValues[0];
        for (i1=0; i1 < 8; i1++) {
          if (dw_POModeValues[i1] == PWM_DUTY_CYCLE_MODE || dw_POModeValues[i1] ==
            ...
            Basic_IO_DW.HILInitialize_POSortedFreqs[num_duty_cycle_modes] =
              Basic_IO_P.HILInitialize_POFrequency;
            num_duty_cycle_modes++;
          } else {
            Basic_IO_DW.HILInitialize_POSortedChans[7U - num_frequency_modes] =
              (p_HILInitialize_POChannels[i1]);
            Basic_IO_DW.HILInitialize_POSortedFreqs[7U - num_frequency_modes] =
              Basic_IO_P.HILInitialize_POFrequency;
            num_frequency_modes++;
          }
        }
      ...
      if (num_duty_cycle_modes > 0) {
        result = hil_set_pwm_frequency(Basic_IO_DW.HILInitialize_Card,
          &Basic_IO_DW.HILInitialize_POSortedChans[0], num_duty_cycle_modes,
          &Basic_IO_DW.HILInitialize_POSortedFreqs[0]);
        if (result < 0) {
          msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
            (_rt_error_message));
          rtmSetErrorStatus(Basic_IO_M, _rt_error_message);
...

      {
        ...
        int32_T *dw_POModeValues = &Basic_IO_DW.HILInitialize_POModeValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POModeValues[i1] = Basic_IO_P.HILInitialize_POConfiguration;
        }
      }

      {
        int_T i1;
        int32_T *dw_POAlignValues = &Basic_IO_DW.HILInitialize_POAlignValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POAlignValues[i1] = Basic_IO_P.HILInitialize_POAlignment;
        }
      }

      {
        int_T i1;
        int32_T *dw_POPolarityVals = &Basic_IO_DW.HILInitialize_POPolarityVals[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POPolarityVals[i1] = Basic_IO_P.HILInitialize_POPolarity;
        }
      }

      result = hil_set_pwm_configuration(Basic_IO_DW.HILInitialize_Card,
        Basic_IO_P.HILInitialize_POChannels, 8U,
        (t_pwm_configuration *) &Basic_IO_DW.HILInitialize_POModeValues[0],
        (t_pwm_alignment *) &Basic_IO_DW.HILInitialize_POAlignValues[0],
        (t_pwm_polarity *) &Basic_IO_DW.HILInitialize_POPolarityVals[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(Basic_IO_M, _rt_error_message);
    ...
    if ((Basic_IO_P.HILInitialize_POStart && !is_switching) ||
      ...
      {
        int_T i1;
        real_T *dw_POValues = &Basic_IO_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POValues[i1] = Basic_IO_P.HILInitialize_POInitial;
        }
      }

      result = hil_write_pwm(Basic_IO_DW.HILInitialize_Card,
        Basic_IO_P.HILInitialize_POChannels, 8U,
        &Basic_IO_DW.HILInitialize_POValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(Basic_IO_M, _rt_error_message);
    ...
    if (Basic_IO_P.HILInitialize_POReset) {
      {
        ...
        real_T *dw_POValues = &Basic_IO_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POValues[i1] = Basic_IO_P.HILInitialize_POWatchdog;
        }
      }

      result = hil_watchdog_set_pwm_expiration_state
        (Basic_IO_DW.HILInitialize_Card, Basic_IO_P.HILInitialize_POChannels, 8U,
         &Basic_IO_DW.HILInitialize_POValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
  ...
  /* S-Function Block: Basic_IO/basicQCarIO/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((Basic_IO_P.HILInitialize_POTerminate && !is_switching) ||
        (Basic_IO_P.HILInitialize_POExit && is_switching)) {
      {
        ...
        real_T *dw_POValues = &Basic_IO_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POValues[i1] = Basic_IO_P.HILInitialize_POFinal;
        }
      }
...
RT_MODEL_Basic_IO_T *Basic_IO(void)
{
  ...
  /* External mode info */
  Basic_IO_M->Sizes.checksums[0] = (3107849579U);
  Basic_IO_M->Sizes.checksums[1] = (2927918445U);
  Basic_IO_M->Sizes.checksums[2] = (2057113826U);
  Basic_IO_M->Sizes.checksums[3] = (2109129241U);
  ...
  Basic_IO_M->Sizes.numBlockPrms = (158);/* Sum of parameter "widths" */
  return Basic_IO_M;
}
