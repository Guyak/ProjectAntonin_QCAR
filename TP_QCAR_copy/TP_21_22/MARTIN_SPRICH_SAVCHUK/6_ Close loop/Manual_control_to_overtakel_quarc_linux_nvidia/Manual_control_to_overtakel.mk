###########################################################################
## Makefile generated for component 'Manual_control_to_overtakel'. 
## 
## Makefile     : Manual_control_to_overtakel.mk
## Generated on : Fri Jan 28 15:29:07 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Manual_control_to_overtakel.rt-linux_nvidia
...
PRODUCT_NAME              = Manual_control_to_overtakel
MAKEFILE                  = Manual_control_to_overtakel.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/TP_QCAR/TP_21_22/MARTIN_SPRICH_SAVCHUK/6_ Close loop
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Manual_control_to_overtakel.rt-linux_nvidia
...
DEFINES_STANDARD = -DMODEL=Manual_control_to_overtakel -DNUMST=2 -DNCSTATES=9 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/Manual_control_to_overtakel.c $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/Manual_control_to_overtakel_data.c $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/Manual_control_to_overtakel_main.c $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = Manual_control_to_overtakel.o Manual_control_to_overtakel_data.o Manual_control_to_overtakel_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
Manual_control_to_overtakel.o : $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/Manual_control_to_overtakel.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Manual_control_to_overtakel_data.o : $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/Manual_control_to_overtakel_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Manual_control_to_overtakel_main.o : $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/Manual_control_to_overtakel_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/Manual_control_to_overtakel_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
