...
#ifndef struct_tag_SSwWYTTGrEZ72uqOjEOOfC
#define struct_tag_SSwWYTTGrEZ72uqOjEOOfC

struct tag_SSwWYTTGrEZ72uqOjEOOfC
{
  ...
  real_T LastPose[3];
  real_T WaypointsInternal[1260];
};

#endif                                 /* struct_tag_SSwWYTTGrEZ72uqOjEOOfC */

#ifndef typedef_nav_slalgs_internal_PurePursu_T
#define typedef_nav_slalgs_internal_PurePursu_T

typedef struct tag_SSwWYTTGrEZ72uqOjEOOfC nav_slalgs_internal_PurePursu_T;
