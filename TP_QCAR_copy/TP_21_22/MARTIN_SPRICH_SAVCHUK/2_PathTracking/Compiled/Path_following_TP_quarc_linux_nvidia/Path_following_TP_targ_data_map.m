  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Path_following_TP_P.p6
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_P.vehicle_length
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 1262;
	
	  ;% Path_following_TP_P.yaw_ic
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 1263;
  ...
  targMap.checksum0 = 836904162;
  targMap.checksum1 = 260636972;
  targMap.checksum2 = 1316605079;
  targMap.checksum3 = 3708731846;
