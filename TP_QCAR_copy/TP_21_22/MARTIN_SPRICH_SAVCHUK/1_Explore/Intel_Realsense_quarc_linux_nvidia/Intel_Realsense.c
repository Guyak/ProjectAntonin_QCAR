 ...
 * C source code generated on : Thu Jan  6 16:54:27 2022
 *
...
RT_MODEL_Intel_Realsense_T *Intel_Realsense(void)
{
  ...
  /* External mode info */
  Intel_Realsense_M->Sizes.checksums[0] = (63614210U);
  Intel_Realsense_M->Sizes.checksums[1] = (2520008281U);
  Intel_Realsense_M->Sizes.checksums[2] = (526921233U);
  Intel_Realsense_M->Sizes.checksums[3] = (4080843889U);
  ...
  Intel_Realsense_M->Sizes.numBlocks = (13);/* Number of blocks */
