...
typedef RT_MODEL_Basic_IO_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Basic_IO(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Basic_IO_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Basic_IO -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
