...
#ifndef RTW_HEADER_Path_Programming_h_
#define RTW_HEADER_Path_Programming_h_
#include <math.h>
#include <string.h>
#ifndef Path_Programming_COMMON_INCLUDES_
#define Path_Programming_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Path_Programming_COMMON_INCLUDES_ */

#include "Path_Programming_types.h"
...
#define Path_Programming_rtModel       RT_MODEL_Path_Programming_T
...
#define rtB                            Path_Programming_B
#define BlockIO                        B_Path_Programming_T
#define rtX                            Path_Programming_X
#define ContinuousStates               X_Path_Programming_T
#define rtXdot                         Path_Programming_XDot
#define StateDerivatives               XDot_Path_Programming_T
#define tXdis                          Path_Programming_XDis
#define StateDisabled                  XDis_Path_Programming_T
#define rtP                            Path_Programming_P
#define Parameters                     P_Path_Programming_T
#define rtDWork                        Path_Programming_DW
#define D_Work                         DW_Path_Programming_T
#define rtPrevZCSigState               Path_Programming_PrevZCX
#define PrevZCSigStates                PrevZCX_Path_Programming_T

/* Parameters (default storage) */
struct P_Path_Programming_T_ {
...
struct tag_RTM_Path_Programming_T {
  const char_T *path;
...
extern P_Path_Programming_T Path_Programming_P;

/* Block signals (default storage) */
extern B_Path_Programming_T Path_Programming_B;

/* Continuous states (default storage) */
extern X_Path_Programming_T Path_Programming_X;

/* Block states (default storage) */
extern DW_Path_Programming_T Path_Programming_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_Path_Programming_T Path_Programming_PrevZCX;
...
extern void Path_Programming_initialize(void);
extern void Path_Programming_output0(void);
extern void Path_Programming_update0(void);
extern void Path_Programming_output2(void);
extern void Path_Programming_update2(void);
extern void Path_Programming_output(int_T tid);
extern void Path_Programming_update(int_T tid);
extern void Path_Programming_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Path_Programming_rtModel *Path_Programming(void);
...
extern RT_MODEL_Path_Programming_T *const Path_Programming_M;
 ...
 *
 * '<Root>' : 'Path_Programming'
 * '<S1>'   : 'Path_Programming/Second-Order Low-Pass Filter'
 * '<S2>'   : 'Path_Programming/XY Graph'
 * '<S3>'   : 'Path_Programming/basicSpeedEstimation'
 * '<S4>'   : 'Path_Programming/plot 2D planar vehicle'
 * '<S5>'   : 'Path_Programming/simple kinematic 2D steered vehicle model'
 * '<S6>'   : 'Path_Programming/speedController'
 * '<S7>'   : 'Path_Programming/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_Path_Programming_h_ */
