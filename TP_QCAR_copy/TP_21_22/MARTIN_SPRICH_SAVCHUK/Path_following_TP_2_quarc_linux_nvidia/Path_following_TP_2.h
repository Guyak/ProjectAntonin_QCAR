...
#ifndef RTW_HEADER_Path_following_TP_2_h_
#define RTW_HEADER_Path_following_TP_2_h_
#include <math.h>
#include <string.h>
#ifndef Path_following_TP_2_COMMON_INCLUDES_
#define Path_following_TP_2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                /* Path_following_TP_2_COMMON_INCLUDES_ */

#include "Path_following_TP_2_types.h"
...
#define Path_following_TP_2_rtModel    RT_MODEL_Path_following_TP_2_T
...
} DW_Path_following_TP_2_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator2_CSTATE;           /* '<S1>/Integrator2' */
  real_T Integrator1_CSTATE;           /* '<S6>/Integrator1' */
  real_T Integrator1_CSTATE_o;         /* '<S5>/Integrator1' */
  real_T Integrator2_CSTATE_o;         /* '<S5>/Integrator2' */
  real_T Integrator_CSTATE;            /* '<S5>/Integrator' */
  real_T Integrator1_CSTATE_d;         /* '<S1>/Integrator1' */
} X_Path_following_TP_2_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE;            /* '<S5>/Integrator' */
  real_T Integrator1_CSTATE_d;         /* '<S1>/Integrator1' */
} XDot_Path_following_TP_2_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator2_CSTATE;        /* '<S1>/Integrator2' */
  boolean_T Integrator1_CSTATE;        /* '<S6>/Integrator1' */
  boolean_T Integrator1_CSTATE_o;      /* '<S5>/Integrator1' */
  boolean_T Integrator2_CSTATE_o;      /* '<S5>/Integrator2' */
  boolean_T Integrator_CSTATE;         /* '<S5>/Integrator' */
  boolean_T Integrator1_CSTATE_d;      /* '<S1>/Integrator1' */
} XDis_Path_following_TP_2_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator1_Reset_ZCE;    /* '<S6>/Integrator1' */
} PrevZCX_Path_following_TP_2_T;
...
#define rtB                            Path_following_TP_2_B
#define BlockIO                        B_Path_following_TP_2_T
#define rtX                            Path_following_TP_2_X
#define ContinuousStates               X_Path_following_TP_2_T
#define rtXdot                         Path_following_TP_2_XDot
#define StateDerivatives               XDot_Path_following_TP_2_T
#define tXdis                          Path_following_TP_2_XDis
#define StateDisabled                  XDis_Path_following_TP_2_T
#define rtP                            Path_following_TP_2_P
#define Parameters                     P_Path_following_TP_2_T
#define rtDWork                        Path_following_TP_2_DW
#define D_Work                         DW_Path_following_TP_2_T
#define rtPrevZCSigState               Path_following_TP_2_PrevZCX
#define PrevZCSigStates                PrevZCX_Path_following_TP_2_T

/* Parameters (default storage) */
struct P_Path_following_TP_2_T_ {
  ...
  real_T HILInitialize1_OOInitial;     /* Expression: initial_other_outputs
                                        * Referenced by: '<Root>/HIL Initialize1'
                                        */
  real_T Speed_Value;                  /* Expression: 0.3
  ...
  real_T Step1_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T Step1_YFinal;                 /* Expression: 0.37
                                        * Referenced by: '<Root>/Step1'
                                        */
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: -0.37
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step2_Time;                   /* Expression: 4
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_YFinal;                 /* Expression: -0.37
                                        * Referenced by: '<Root>/Step2'
                                        */
  ...
  real_T Step3_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step3'
                                        */
  real_T Step3_YFinal;                 /* Expression: 0.37
                                        * Referenced by: '<Root>/Step3'
                                        */
  real_T Step4_Time;                   /* Expression: 6
                                        * Referenced by: '<Root>/Step4'
                                        */
  real_T Step4_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step4'
                                        */
  real_T Step4_YFinal;                 /* Expression: -0.37
                                        * Referenced by: '<Root>/Step4'
                                        */
  real_T Step7_Time;                   /* Expression: 7
                                        * Referenced by: '<Root>/Step7'
                                        */
  real_T Step7_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step7'
                                        */
  real_T Step7_YFinal;                 /* Expression: 0.37
                                        * Referenced by: '<Root>/Step7'
                                        */
  real_T Step5_Time;                   /* Expression: 8
                                        * Referenced by: '<Root>/Step5'
                                        */
  real_T Step5_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step5'
                                        */
  real_T Step5_YFinal;                 /* Expression: 0.37
                                        * Referenced by: '<Root>/Step5'
                                        */
  real_T Step6_Time;                   /* Expression: 9
                                        * Referenced by: '<Root>/Step6'
                                        */
  real_T Step6_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step6'
                                        */
  real_T Step6_YFinal;                 /* Expression: -0.37
                                        * Referenced by: '<Root>/Step6'
                                        */
...
struct tag_RTM_Path_following_TP_2_T {
  const char_T *path;
...
extern P_Path_following_TP_2_T Path_following_TP_2_P;

/* Block signals (default storage) */
extern B_Path_following_TP_2_T Path_following_TP_2_B;

/* Continuous states (default storage) */
extern X_Path_following_TP_2_T Path_following_TP_2_X;

/* Block states (default storage) */
extern DW_Path_following_TP_2_T Path_following_TP_2_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_Path_following_TP_2_T Path_following_TP_2_PrevZCX;
...
extern void Path_following_TP_2_initialize(void);
extern void Path_following_TP_2_output0(void);
extern void Path_following_TP_2_update0(void);
extern void Path_following_TP_2_output2(void);
extern void Path_following_TP_2_update2(void);
extern void Path_following_TP_2_output(int_T tid);
extern void Path_following_TP_2_update(int_T tid);
extern void Path_following_TP_2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Path_following_TP_2_rtModel *Path_following_TP_2(void);
...
extern RT_MODEL_Path_following_TP_2_T *const Path_following_TP_2_M;
 ...
 *
 * '<Root>' : 'Path_following_TP_2'
 * '<S1>'   : 'Path_following_TP_2/Second-Order Low-Pass Filter'
 * '<S2>'   : 'Path_following_TP_2/XY Graph'
 * '<S3>'   : 'Path_following_TP_2/basicSpeedEstimation'
 * '<S4>'   : 'Path_following_TP_2/plot 2D planar vehicle'
 * '<S5>'   : 'Path_following_TP_2/simple kinematic 2D steered vehicle model'
 * '<S6>'   : 'Path_following_TP_2/speedController'
 * '<S7>'   : 'Path_following_TP_2/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_Path_following_TP_2_h_ */
