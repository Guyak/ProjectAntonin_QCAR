...
void Keyboard_initialize(void)
{
  ...
  /* S-Function Block: Keyboard/basicQCarIO/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    result = hil_set_card_specific_options(Keyboard_DW.HILInitialize_Card,
    ...
    result = hil_set_digital_directions(Keyboard_DW.HILInitialize_Card,
      Keyboard_P.HILInitialize_DIChannels, 20U,
    ...
    if ((Keyboard_P.HILInitialize_POPStart && !is_switching) ||
      ...
      Keyboard_DW.HILInitialize_POModeValues[0] =
        (Keyboard_P.HILInitialize_POModes[0]);

      {
        int_T i1;
        int32_T *dw_POModeValues = &Keyboard_DW.HILInitialize_POModeValues[1];
        for (i1=0; i1 < 7; i1++) {
          dw_POModeValues[i1] = (Keyboard_P.HILInitialize_POModes[1]);
        }
      }

      result = hil_set_pwm_mode(Keyboard_DW.HILInitialize_Card,
        Keyboard_P.HILInitialize_POChannels, 8U, (t_pwm_mode *)
        &Keyboard_DW.HILInitialize_POModeValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
...

      {
        ...
        int32_T *dw_POModeValues = &Keyboard_DW.HILInitialize_POModeValues[0];
        for (i1=0; i1 < 8; i1++) {
          if (dw_POModeValues[i1] == PWM_DUTY_CYCLE_MODE || dw_POModeValues[i1] ==
            ...
            Keyboard_DW.HILInitialize_POSortedFreqs[num_duty_cycle_modes] =
              Keyboard_P.HILInitialize_POFrequency;
            num_duty_cycle_modes++;
          } else {
            Keyboard_DW.HILInitialize_POSortedChans[7U - num_frequency_modes] =
              (p_HILInitialize_POChannels[i1]);
            Keyboard_DW.HILInitialize_POSortedFreqs[7U - num_frequency_modes] =
              Keyboard_P.HILInitialize_POFrequency;
            num_frequency_modes++;
          }
        }
      ...
      if (num_duty_cycle_modes > 0) {
        result = hil_set_pwm_frequency(Keyboard_DW.HILInitialize_Card,
          &Keyboard_DW.HILInitialize_POSortedChans[0], num_duty_cycle_modes,
          &Keyboard_DW.HILInitialize_POSortedFreqs[0]);
        if (result < 0) {
          msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
            (_rt_error_message));
          rtmSetErrorStatus(Keyboard_M, _rt_error_message);
...

      {
        ...
        int32_T *dw_POModeValues = &Keyboard_DW.HILInitialize_POModeValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POModeValues[i1] = Keyboard_P.HILInitialize_POConfiguration;
        }
      }

      {
        int_T i1;
        int32_T *dw_POAlignValues = &Keyboard_DW.HILInitialize_POAlignValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POAlignValues[i1] = Keyboard_P.HILInitialize_POAlignment;
        }
      }

      {
        int_T i1;
        int32_T *dw_POPolarityVals = &Keyboard_DW.HILInitialize_POPolarityVals[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POPolarityVals[i1] = Keyboard_P.HILInitialize_POPolarity;
        }
      }

      result = hil_set_pwm_configuration(Keyboard_DW.HILInitialize_Card,
        Keyboard_P.HILInitialize_POChannels, 8U,
        (t_pwm_configuration *) &Keyboard_DW.HILInitialize_POModeValues[0],
        (t_pwm_alignment *) &Keyboard_DW.HILInitialize_POAlignValues[0],
        (t_pwm_polarity *) &Keyboard_DW.HILInitialize_POPolarityVals[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(Keyboard_M, _rt_error_message);
    ...
    if ((Keyboard_P.HILInitialize_POStart && !is_switching) ||
      ...
      {
        int_T i1;
        real_T *dw_POValues = &Keyboard_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POValues[i1] = Keyboard_P.HILInitialize_POInitial;
        }
      }

      result = hil_write_pwm(Keyboard_DW.HILInitialize_Card,
        Keyboard_P.HILInitialize_POChannels, 8U,
        &Keyboard_DW.HILInitialize_POValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(Keyboard_M, _rt_error_message);
    ...
    if (Keyboard_P.HILInitialize_POReset) {
      {
        ...
        real_T *dw_POValues = &Keyboard_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POValues[i1] = Keyboard_P.HILInitialize_POWatchdog;
        }
      }

      result = hil_watchdog_set_pwm_expiration_state
        (Keyboard_DW.HILInitialize_Card, Keyboard_P.HILInitialize_POChannels, 8U,
         &Keyboard_DW.HILInitialize_POValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
  ...
  /* S-Function Block: Keyboard/basicQCarIO/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((Keyboard_P.HILInitialize_POTerminate && !is_switching) ||
        (Keyboard_P.HILInitialize_POExit && is_switching)) {
      {
        ...
        real_T *dw_POValues = &Keyboard_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POValues[i1] = Keyboard_P.HILInitialize_POFinal;
        }
      }
...
RT_MODEL_Keyboard_T *Keyboard(void)
{
  ...
  /* External mode info */
  Keyboard_M->Sizes.checksums[0] = (492523220U);
  Keyboard_M->Sizes.checksums[1] = (1478770340U);
  Keyboard_M->Sizes.checksums[2] = (1616447673U);
  Keyboard_M->Sizes.checksums[3] = (830126006U);
  ...
  Keyboard_M->Sizes.numBlockPrms = (198);/* Sum of parameter "widths" */
  return Keyboard_M;
}
