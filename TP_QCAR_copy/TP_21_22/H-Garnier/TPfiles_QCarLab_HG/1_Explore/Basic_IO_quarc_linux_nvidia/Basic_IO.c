...
void Basic_IO_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Basic_IO_M)) {
    ...
    /* S-Function Block: Basic_IO/basicQCar_IO/HIL Read (hil_read_block) */
    {
    ...
    /* S-Function Block: Basic_IO/basicQCar_IO/Unwrap 2^24 (inverse_modulus_block) */
    {
  ...
  if (rtmIsMajorTimeStep(Basic_IO_M)) {
    ...
    /* S-Function Block: Basic_IO/basicQCar_IO/HIL Write (hil_write_block) */
    {
      t_error result;
...
void Basic_IO_initialize(void)
{
  ...
  /* S-Function Block: Basic_IO/basicQCar_IO/HIL Initialize (hil_initialize_block) */
  {
    t_int result;
...
RT_MODEL_Basic_IO_T *Basic_IO(void)
{
  ...
  /* External mode info */
  Basic_IO_M->Sizes.checksums[0] = (4220641903U);
  Basic_IO_M->Sizes.checksums[1] = (5991872U);
  Basic_IO_M->Sizes.checksums[2] = (4276876534U);
  Basic_IO_M->Sizes.checksums[3] = (2517010720U);
