###########################################################################
## Makefile generated for component 'Basic_IO'. 
## 
## Makefile     : Basic_IO.mk
## Generated on : Thu Jan 06 15:32:20 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Basic_IO.rt-linux_nvidia
...
PRODUCT_NAME              = Basic_IO
MAKEFILE                  = Basic_IO.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/TP_SIA/TP_21_22/H-Garnier/TPfiles_QCarLab_HG/1_Explore/compiled
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Basic_IO.rt-linux_nvidia
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Basic_IO_quarc_linux_nvidia -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=Basic_IO -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Basic_IO_quarc_linux_nvidia/Basic_IO.c $(START_DIR)/Basic_IO_quarc_linux_nvidia/Basic_IO_data.c $(START_DIR)/Basic_IO_quarc_linux_nvidia/Basic_IO_main.c $(START_DIR)/Basic_IO_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/Basic_IO_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/Basic_IO_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = Basic_IO.o Basic_IO_data.o Basic_IO_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/Basic_IO_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/Basic_IO_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
Basic_IO.o : $(START_DIR)/Basic_IO_quarc_linux_nvidia/Basic_IO.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Basic_IO_data.o : $(START_DIR)/Basic_IO_quarc_linux_nvidia/Basic_IO_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Basic_IO_main.o : $(START_DIR)/Basic_IO_quarc_linux_nvidia/Basic_IO_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/Basic_IO_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/Basic_IO_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/Basic_IO_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
