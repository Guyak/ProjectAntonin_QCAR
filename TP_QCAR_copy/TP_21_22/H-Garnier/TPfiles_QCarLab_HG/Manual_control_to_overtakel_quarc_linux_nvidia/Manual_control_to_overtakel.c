 ...
 * C source code generated on : Fri Jan 28 16:44:19 2022
 *
...
#define Manual_control_to_overta_period (0.033333333333333333)
...
void Manual_control_to_overtakel_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Manual_control_to_overtakel_M)) {
    ...
    if (0.0 > Manual_control_to_overtakel_P.Bicycle_alim) {
      rtb_DataTypeConversion = Manual_control_to_overtakel_P.Bicycle_alim;
    } else if (0.0 < -Manual_control_to_overtakel_P.Bicycle_alim) {
      rtb_DataTypeConversion = -Manual_control_to_overtakel_P.Bicycle_alim;
    } else {
    ...
    rtb_d = rtb_DataTypeConversion - Manual_control_to_overtakel_DW.PrevY;
    if (rtb_d > Manual_control_to_overtakel_P.Bicycle_steer_rate *
        Manual_control_to_overta_period) {
      rtb_DataTypeConversion = Manual_control_to_overtakel_P.Bicycle_steer_rate *
        Manual_control_to_overta_period + Manual_control_to_overtakel_DW.PrevY;
    } else {
      rtb_sinpsi = -Manual_control_to_overtakel_P.Bicycle_steer_rate *
        Manual_control_to_overta_period;
      if (rtb_d < rtb_sinpsi) {
        rtb_DataTypeConversion = rtb_sinpsi +
          Manual_control_to_overtakel_DW.PrevY;
      }
    }

    Manual_control_to_overtakel_DW.PrevY = rtb_DataTypeConversion;

    /* End of RateLimiter: '<S1>/steering rate limit' */

    /* Fcn: '<S1>/Fcn' */
    Manual_control_to_overtakel_B.Fcn = tan(rtb_DataTypeConversion);

    /* Saturate: '<S1>/vel limit' */
    if (0.0 > Manual_control_to_overtakel_P.Bicycle_vlim) {
      rtb_DataTypeConversion = Manual_control_to_overtakel_P.Bicycle_vlim;
    } else if (0.0 < -Manual_control_to_overtakel_P.Bicycle_vlim) {
      rtb_DataTypeConversion = -Manual_control_to_overtakel_P.Bicycle_vlim;
    } else {
      rtb_DataTypeConversion = 0.0;
    }
    ...
    rtb_d = rtb_DataTypeConversion - Manual_control_to_overtakel_DW.PrevY_l;
    if (rtb_d > Manual_control_to_overtakel_P.Bicycle_accel *
        Manual_control_to_overta_period) {
      /* RateLimiter: '<S1>/acceleration limit' */
      Manual_control_to_overtakel_B.accelerationlimit =
        Manual_control_to_overtakel_P.Bicycle_accel *
        Manual_control_to_overta_period + Manual_control_to_overtakel_DW.PrevY_l;
    } else {
      rtb_sinpsi = -Manual_control_to_overtakel_P.Bicycle_accel *
        Manual_control_to_overta_period;
      if (rtb_d < rtb_sinpsi) {
        /* RateLimiter: '<S1>/acceleration limit' */
        Manual_control_to_overtakel_B.accelerationlimit = rtb_sinpsi +
          Manual_control_to_overtakel_DW.PrevY_l;
      } else {
        /* RateLimiter: '<S1>/acceleration limit' */
        Manual_control_to_overtakel_B.accelerationlimit = rtb_DataTypeConversion;
      }
    }
  ...
  Manual_control_to_overtakel_B.Product[1] = sin
    (Manual_control_to_overtakel_X.Integrator1_CSTATE[2]) *
    Manual_control_to_overtakel_B.accelerationlimit;
  Manual_control_to_overtakel_B.Product[2] = Manual_control_to_overtakel_B.Fcn *
    Manual_control_to_overtakel_B.accelerationlimit;
   ...
   */
  rtb_d = Manual_control_to_overtakel_P.xg[0] -
    Manual_control_to_overtakel_B.Integrator;
  rtb_Sum1_j_idx_1 = Manual_control_to_overtakel_P.xg[1] -
    Manual_control_to_overtakel_B.Integrator1;

  /* Fcn: '<Root>/distance to goal' */
  rtb_DataTypeConversion = rt_powd_snf(rtb_d, 2.0) + rt_powd_snf
    (rtb_Sum1_j_idx_1, 2.0);
  if (rtb_DataTypeConversion < 0.0) {
    /* Fcn: '<Root>/distance to goal' */
    Manual_control_to_overtakel_B.distanceerror = -sqrt(-rtb_DataTypeConversion);
  } else {
    /* Fcn: '<Root>/distance to goal' */
    Manual_control_to_overtakel_B.distanceerror = sqrt(rtb_DataTypeConversion);
  }
  ...
  if (Manual_control_to_overtakel_B.speedcommand >
    ...
    rtb_sinpsi = Manual_control_to_overtakel_P.commandsaturation_UpperSat;
  } else if (Manual_control_to_overtakel_B.speedcommand <
             Manual_control_to_overtakel_P.commandsaturation_LowerSat) {
    rtb_sinpsi = Manual_control_to_overtakel_P.commandsaturation_LowerSat;
  } else {
    rtb_sinpsi = Manual_control_to_overtakel_B.speedcommand;
  }
   ...
   */
  Manual_control_to_overtakel_B.desired = rtb_sinpsi *
  ...
  /* Sum: '<S8>/Sum' */
  rtb_DataTypeConversion = Manual_control_to_overtakel_B.desired -
   ...
   *  Sum: '<S8>/Add'
   */
  rtb_sinpsi = (Manual_control_to_overtakel_P.Kpms_Gain * rtb_DataTypeConversion
                + Manual_control_to_overtakel_X.Integrator1_CSTATE_f) +
    Manual_control_to_overtakel_P.Kffms_Gain *
    Manual_control_to_overtakel_B.desired;

  /* Saturate: '<S8>/Motor_command  sat' */
  if (rtb_sinpsi > Manual_control_to_overtakel_P.Motor_commandsat_UpperSat) {
    rtb_sinpsi = Manual_control_to_overtakel_P.Motor_commandsat_UpperSat;
  } else if (rtb_sinpsi <
             Manual_control_to_overtakel_P.Motor_commandsat_LowerSat) {
    rtb_sinpsi = Manual_control_to_overtakel_P.Motor_commandsat_LowerSat;
  }
   ...
   */
  rtb_sinpsi = rtb_sinpsi * Manual_control_to_overtakel_P.Constant4_Value *
    Manual_control_to_overtakel_P.directionconvention_Gain;

  /* Saturate: '<Root>/command saturation' */
  if (rtb_sinpsi > Manual_control_to_overtakel_P.commandsaturation_UpperSat_e) {
    /* Saturate: '<Root>/command saturation' */
    ...
    /* Saturate: '<Root>/command saturation' */
    Manual_control_to_overtakel_B.commandsaturation = rtb_sinpsi;
  }
   ...
   */
  rtb_d = Manual_control_to_overtakel_B.psi_headingrad - rt_atan2d_snf
    (rtb_Sum1_j_idx_1, rtb_d);
  if (rtIsNaN(rtb_d + 3.1415926535897931) || rtIsInf(rtb_d + 3.1415926535897931))
  {
    ...
    rtb_sinpsi = fmod(rtb_d + 3.1415926535897931, 6.2831853071795862);
    rEQ0 = (rtb_sinpsi == 0.0);
    if (!rEQ0) {
  ...
  Manual_control_to_overtakel_B.psidotrads = 1.0 /
    ...
    Manual_control_to_overtakel_B.Offset * ((rtb_sinpsi - 3.1415926535897931) *
    Manual_control_to_overtakel_P.Gain_Gain);

  /* Gain: '<S7>/Gain' */
  rtb_d = Manual_control_to_overtakel_P.vehicle_length / 2.0 *
    Manual_control_to_overtakel_B.psidotrads;

  /* Trigonometry: '<S7>/Trigonometric Function1' */
  rtb_sinpsi = sin(Manual_control_to_overtakel_B.psi_headingrad);

  /* Trigonometry: '<S7>/Trigonometric Function' */
  rtb_Sum1_j_idx_1 = cos(Manual_control_to_overtakel_B.psi_headingrad);

  /* Sum: '<S7>/Sum' incorporates:
   *  Product: '<S7>/Product1'
   *  Product: '<S7>/Product3'
   */
  Manual_control_to_overtakel_B.v_Xms = Manual_control_to_overtakel_B.Offset *
    rtb_Sum1_j_idx_1 - rtb_d * rtb_sinpsi;

  /* Sum: '<S7>/Sum1' incorporates:
   *  Product: '<S7>/Product'
   *  Product: '<S7>/Product4'
   */
  Manual_control_to_overtakel_B.v_Yms = Manual_control_to_overtakel_B.Offset *
    rtb_sinpsi + rtb_d * rtb_Sum1_j_idx_1;
  if (rtmIsMajorTimeStep(Manual_control_to_overtakel_M)) {
  }
...
RT_MODEL_Manual_control_to_overtakel_T *Manual_control_to_overtakel(void)
{
  ...
  rtmSetTFinal(Manual_control_to_overtakel_M, 15.0);
  ...
  /* External mode info */
  Manual_control_to_overtakel_M->Sizes.checksums[0] = (1479782620U);
  Manual_control_to_overtakel_M->Sizes.checksums[1] = (501783324U);
  Manual_control_to_overtakel_M->Sizes.checksums[2] = (1555476693U);
  Manual_control_to_overtakel_M->Sizes.checksums[3] = (240606374U);
  ...
  Manual_control_to_overtakel_M->Sizes.numBlocks = (80);/* Number of blocks */
  Manual_control_to_overtakel_M->Sizes.numBlockIO = (23);/* Number of block outputs */
  Manual_control_to_overtakel_M->Sizes.numBlockPrms = (158);/* Sum of parameter "widths" */
