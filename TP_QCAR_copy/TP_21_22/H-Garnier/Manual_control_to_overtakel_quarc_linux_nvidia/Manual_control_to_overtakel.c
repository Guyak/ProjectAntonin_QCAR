 ...
 * C source code generated on : Fri Jan 28 18:01:40 2022
 *
...
void Manual_control_to_overtakel_output(void)
{
  ...
  rtb_Product1 = rt_powd_snf(rtb_Sum1_j_idx_0, 2.0) + rt_powd_snf
    (rtb_Sum1_j_idx_1, 2.0);
  if (rtb_Product1 < 0.0) {
    /* Fcn: '<Root>/distance to goal' */
    Manual_control_to_overtakel_B.distanceerror = -sqrt(-rtb_Product1);
  } else {
    /* Fcn: '<Root>/distance to goal' */
    Manual_control_to_overtakel_B.distanceerror = sqrt(rtb_Product1);
  }

  /* End of Fcn: '<Root>/distance to goal' */

  /* Gain: '<Root>/velocity gain Kv' */
  ...
  if (Manual_control_to_overtakel_B.speedcommand >
    ...
    rtb_Product1 = Manual_control_to_overtakel_P.commandsaturation_UpperSat;
  } else if (Manual_control_to_overtakel_B.speedcommand <
             Manual_control_to_overtakel_P.commandsaturation_LowerSat) {
    rtb_Product1 = Manual_control_to_overtakel_P.commandsaturation_LowerSat;
  } else {
    rtb_Product1 = Manual_control_to_overtakel_B.speedcommand;
  }
   ...
   */
  Manual_control_to_overtakel_B.desired = rtb_Product1 *
  ...
  /* Sum: '<S8>/Sum' */
  rtb_Product1 = Manual_control_to_overtakel_B.desired -
   ...
   *  Sum: '<S8>/Add'
   */
  q = (Manual_control_to_overtakel_P.Kpms_Gain * rtb_Product1 +
       Manual_control_to_overtakel_X.Integrator1_CSTATE_f) +
    Manual_control_to_overtakel_P.Kffms_Gain *
    Manual_control_to_overtakel_B.desired;

  /* Saturate: '<S8>/Motor_command  sat' */
  if (q > Manual_control_to_overtakel_P.Motor_commandsat_UpperSat) {
    q = Manual_control_to_overtakel_P.Motor_commandsat_UpperSat;
  } else if (q < Manual_control_to_overtakel_P.Motor_commandsat_LowerSat) {
    q = Manual_control_to_overtakel_P.Motor_commandsat_LowerSat;
  }
   ...
   */
  rtb_Sum1_j_idx_0 = rt_atan2d_snf(rtb_Sum1_j_idx_1, rtb_Sum1_j_idx_0) -
    Manual_control_to_overtakel_B.Integrator1[2];
  if (rtIsNaN(rtb_Sum1_j_idx_0 + 3.1415926535897931) || rtIsInf(rtb_Sum1_j_idx_0
       + 3.1415926535897931)) {
    rtb_Sum1_j_idx_1 = (rtNaN);
  } else if (rtb_Sum1_j_idx_0 + 3.1415926535897931 == 0.0) {
    rtb_Sum1_j_idx_1 = 0.0;
  } else {
    rtb_Sum1_j_idx_1 = fmod(rtb_Sum1_j_idx_0 + 3.1415926535897931,
      6.2831853071795862);
    rEQ0 = (rtb_Sum1_j_idx_1 == 0.0);
    if (!rEQ0) {
      q = fabs((rtb_Sum1_j_idx_0 + 3.1415926535897931) / 6.2831853071795862);
    ...
    if (rEQ0) {
      ...
      rtb_Sum1_j_idx_1 += 6.2831853071795862;
    }
  }
   ...
   */
  Manual_control_to_overtakel_B.Gain = (rtb_Sum1_j_idx_1 - 3.1415926535897931) *
    Manual_control_to_overtakel_P.Gain_Gain;

  /* Saturate: '<Root>/angle saturation1' */
  if (Manual_control_to_overtakel_B.Gain >
      Manual_control_to_overtakel_P.anglesaturation1_UpperSat) {
    /* Saturate: '<Root>/angle saturation1' */
    Manual_control_to_overtakel_B.anglesaturation1 =
      Manual_control_to_overtakel_P.anglesaturation1_UpperSat;
  } else if (Manual_control_to_overtakel_B.Gain <
             Manual_control_to_overtakel_P.anglesaturation1_LowerSat) {
    /* Saturate: '<Root>/angle saturation1' */
    Manual_control_to_overtakel_B.anglesaturation1 =
      Manual_control_to_overtakel_P.anglesaturation1_LowerSat;
  } else {
    /* Saturate: '<Root>/angle saturation1' */
    Manual_control_to_overtakel_B.anglesaturation1 =
      Manual_control_to_overtakel_B.Gain;
  }
  ...
  Manual_control_to_overtakel_B.Integrator2 =
    Manual_control_to_overtakel_X.Integrator2_CSTATE_p;
  if (rtmIsMajorTimeStep(Manual_control_to_overtakel_M)) {
  }

  /* Integrator: '<Root>/Integrator1' */
  Manual_control_to_overtakel_B.Integrator1_h =
    Manual_control_to_overtakel_X.Integrator1_CSTATE_p;
  if (rtmIsMajorTimeStep(Manual_control_to_overtakel_M)) {
  }
  ...
  if (Manual_control_to_overtakel_B.Gain >
    ...
    /* Saturate: '<S1>/steering angle limit' */
    rtb_Sum1_j_idx_1 = Manual_control_to_overtakel_P.Bicycle_alim;
  } else if (Manual_control_to_overtakel_B.Gain <
             -Manual_control_to_overtakel_P.Bicycle_alim) {
    /* Saturate: '<S1>/steering angle limit' */
    rtb_Sum1_j_idx_1 = -Manual_control_to_overtakel_P.Bicycle_alim;
    ...
    /* Saturate: '<S1>/steering angle limit' */
    rtb_Sum1_j_idx_1 = Manual_control_to_overtakel_B.Gain;
  }
  ...
  if (Manual_control_to_overtakel_DW.LastMajorTime == (rtInf)) {
    /* RateLimiter: '<S1>/steering rate limit' */
    Manual_control_to_overtakel_B.steeringratelimit = rtb_Sum1_j_idx_1;
  } else {
    q = Manual_control_to_overtakel_M->Timing.t[0] -
      Manual_control_to_overtakel_DW.LastMajorTime;
    riseValLimit = q * Manual_control_to_overtakel_P.Bicycle_steer_rate;
    rtb_Sum1_j_idx_0 = rtb_Sum1_j_idx_1 - Manual_control_to_overtakel_DW.PrevY;
    if (rtb_Sum1_j_idx_0 > riseValLimit) {
      /* RateLimiter: '<S1>/steering rate limit' */
      Manual_control_to_overtakel_B.steeringratelimit =
        Manual_control_to_overtakel_DW.PrevY + riseValLimit;
    } else {
      q *= -Manual_control_to_overtakel_P.Bicycle_steer_rate;
      if (rtb_Sum1_j_idx_0 < q) {
        /* RateLimiter: '<S1>/steering rate limit' */
        Manual_control_to_overtakel_B.steeringratelimit =
          Manual_control_to_overtakel_DW.PrevY + q;
      } else {
        /* RateLimiter: '<S1>/steering rate limit' */
        Manual_control_to_overtakel_B.steeringratelimit = rtb_Sum1_j_idx_1;
      }
  ...
  if (Manual_control_to_overtakel_B.Offset >
      Manual_control_to_overtakel_P.Bicycle_vlim) {
    /* Saturate: '<S1>/vel limit' */
    rtb_Sum1_j_idx_1 = Manual_control_to_overtakel_P.Bicycle_vlim;
  } else if (Manual_control_to_overtakel_B.Offset <
             -Manual_control_to_overtakel_P.Bicycle_vlim) {
    /* Saturate: '<S1>/vel limit' */
    rtb_Sum1_j_idx_1 = -Manual_control_to_overtakel_P.Bicycle_vlim;
  } else {
    /* Saturate: '<S1>/vel limit' */
    rtb_Sum1_j_idx_1 = Manual_control_to_overtakel_B.Offset;
  }
  ...
  if (Manual_control_to_overtakel_DW.LastMajorTime_j == (rtInf)) {
    /* RateLimiter: '<S1>/acceleration limit' */
    Manual_control_to_overtakel_B.accelerationlimit = rtb_Sum1_j_idx_1;
  } else {
    q = Manual_control_to_overtakel_M->Timing.t[0] -
      Manual_control_to_overtakel_DW.LastMajorTime_j;
    riseValLimit = q * Manual_control_to_overtakel_P.Bicycle_accel;
    rtb_Sum1_j_idx_0 = rtb_Sum1_j_idx_1 - Manual_control_to_overtakel_DW.PrevY_l;
    if (rtb_Sum1_j_idx_0 > riseValLimit) {
      /* RateLimiter: '<S1>/acceleration limit' */
      Manual_control_to_overtakel_B.accelerationlimit =
        Manual_control_to_overtakel_DW.PrevY_l + riseValLimit;
    } else {
      q *= -Manual_control_to_overtakel_P.Bicycle_accel;
      if (rtb_Sum1_j_idx_0 < q) {
        /* RateLimiter: '<S1>/acceleration limit' */
        Manual_control_to_overtakel_B.accelerationlimit =
          Manual_control_to_overtakel_DW.PrevY_l + q;
      } else {
        /* RateLimiter: '<S1>/acceleration limit' */
        Manual_control_to_overtakel_B.accelerationlimit = rtb_Sum1_j_idx_1;
      }
  ...
  Manual_control_to_overtakel_B.Product[2] = tan
    (Manual_control_to_overtakel_B.steeringratelimit) / 0.43 *
    Manual_control_to_overtakel_B.accelerationlimit;
  if (rtmIsMajorTimeStep(Manual_control_to_overtakel_M)) {
    ...
    /* S-Function Block: Manual_control_to_overtakel/HIL Read (hil_read_block) */
    {
      t_error result = hil_read
        (Manual_control_to_overtakel_DW.HILInitialize1_Card,
         ...
         NULL, 0U,
         Manual_control_to_overtakel_P.HILRead_other_channels, 3U,
         NULL,
         &Manual_control_to_overtakel_DW.HILRead_EncoderBuffer,
         NULL,
         &Manual_control_to_overtakel_DW.HILRead_OtherBuffer[0]
         );
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        ...
        Manual_control_to_overtakel_B.motorcounts =
          Manual_control_to_overtakel_DW.HILRead_EncoderBuffer;
        Manual_control_to_overtakel_B.HILRead_o2 =
          Manual_control_to_overtakel_DW.HILRead_OtherBuffer[0];
        Manual_control_to_overtakel_B.HILRead_o3 =
          Manual_control_to_overtakel_DW.HILRead_OtherBuffer[1];
        Manual_control_to_overtakel_B.HILRead_o4 =
          Manual_control_to_overtakel_DW.HILRead_OtherBuffer[2];
      }
    }
   ...
   */
  rtb_Product1 = sin(Manual_control_to_overtakel_X.Integrator2_CSTATE_o);

  /* Trigonometry: '<S7>/Trigonometric Function' incorporates:
   *  Integrator: '<S7>/Integrator2'
   */
  rtb_Sum1_j_idx_0 = cos(Manual_control_to_overtakel_X.Integrator2_CSTATE_o);

  /* Sum: '<S7>/Sum' incorporates:
   *  Product: '<S7>/Product1'
   *  Product: '<S7>/Product3'
   */
  Manual_control_to_overtakel_B.v_Xms = 0.0 * rtb_Sum1_j_idx_0 -
    Manual_control_to_overtakel_B.L2psidot * rtb_Product1;

  /* Sum: '<S7>/Sum1' incorporates:
   *  Product: '<S7>/Product'
   *  Product: '<S7>/Product4'
   */
  Manual_control_to_overtakel_B.v_Yms = 0.0 * rtb_Product1 +
    Manual_control_to_overtakel_B.L2psidot * rtb_Sum1_j_idx_0;
}
...
void Manual_control_to_overtakel_derivatives(void)
{
  ...
  _rtXdot->Integrator2_CSTATE_p = Manual_control_to_overtakel_B.HILRead_o4;

  /* Derivatives for Integrator: '<Root>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_p = Manual_control_to_overtakel_B.HILRead_o3;

  /* Derivatives for Integrator: '<Root>/Integrator' */
  _rtXdot->Integrator_CSTATE = Manual_control_to_overtakel_B.HILRead_o2;

  /* Derivatives for Integrator: '<S2>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_d = Manual_control_to_overtakel_B.Product1;

  /* Derivatives for Integrator: '<S7>/Integrator' */
  _rtXdot->Integrator_CSTATE_p = Manual_control_to_overtakel_B.v_Xms;
...
void Manual_control_to_overtakel_initialize(void)
{
  ...
  Manual_control_to_overtakel_X.Integrator2_CSTATE_p =
    Manual_control_to_overtakel_P.Integrator2_IC_i;

  /* InitializeConditions for Integrator: '<Root>/Integrator1' */
  Manual_control_to_overtakel_X.Integrator1_CSTATE_p =
    Manual_control_to_overtakel_P.Integrator1_IC_d;

  /* InitializeConditions for Integrator: '<Root>/Integrator' */
  Manual_control_to_overtakel_X.Integrator_CSTATE =
    Manual_control_to_overtakel_P.Integrator_IC;
  ...
  Manual_control_to_overtakel_X.Integrator_CSTATE_p =
...
RT_MODEL_Manual_control_to_overtakel_T *Manual_control_to_overtakel(void)
{
  ...
  rtmSetTFinal(Manual_control_to_overtakel_M, 25.0);
  ...
  /* External mode info */
  Manual_control_to_overtakel_M->Sizes.checksums[0] = (4204092114U);
  Manual_control_to_overtakel_M->Sizes.checksums[1] = (2900975268U);
  Manual_control_to_overtakel_M->Sizes.checksums[2] = (944842432U);
  Manual_control_to_overtakel_M->Sizes.checksums[3] = (1713546063U);
  ...
  /* Initialize Sizes */
  Manual_control_to_overtakel_M->Sizes.numContStates = (12);/* Number of continuous states */
  ...
  Manual_control_to_overtakel_M->Sizes.numBlocks = (88);/* Number of blocks */
  Manual_control_to_overtakel_M->Sizes.numBlockIO = (32);/* Number of block outputs */
  Manual_control_to_overtakel_M->Sizes.numBlockPrms = (164);/* Sum of parameter "widths" */
