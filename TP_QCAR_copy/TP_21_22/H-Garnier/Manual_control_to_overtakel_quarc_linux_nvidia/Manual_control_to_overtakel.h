...
#ifndef RTW_HEADER_Manual_control_to_overtakel_h_
#define RTW_HEADER_Manual_control_to_overtakel_h_
#include <math.h>
#include <string.h>
#ifndef Manual_control_to_overtakel_COMMON_INCLUDES_
#define Manual_control_to_overtakel_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                        /* Manual_control_to_overtakel_COMMON_INCLUDES_ */

#include "Manual_control_to_overtakel_types.h"
...
#define Manual_control_to_overtakel_rtModel RT_MODEL_Manual_control_to_overtakel_T

/* Block signals (default storage) */
typedef struct {
  real_T Integrator1[3];               /* '<S1>/Integrator1' */
  real_T distanceerror;                /* '<Root>/distance to goal' */
  ...
  real_T steeringratelimit;            /* '<S1>/steering rate limit' */
  ...
  boolean_T Compare_c;                 /* '<S5>/Compare' */
} B_Manual_control_to_overtakel_T;
...
typedef struct {
  ...
  real_T PrevY;                        /* '<S1>/steering rate limit' */
  real_T LastMajorTime;                /* '<S1>/steering rate limit' */
  real_T PrevY_l;                      /* '<S1>/acceleration limit' */
  real_T LastMajorTime_j;              /* '<S1>/acceleration limit' */
  real_T HILRead_OtherBuffer[3];       /* '<Root>/HIL Read' */
...
} DW_Manual_control_to_overtakel_T;
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_p;         /* '<Root>/Integrator2' */
  real_T Integrator1_CSTATE_p;         /* '<Root>/Integrator1' */
...
} X_Manual_control_to_overtakel_T;
...
typedef struct {
  ...
  real_T Integrator1_CSTATE_o;         /* '<S7>/Integrator1' */
  real_T Integrator2_CSTATE_o;         /* '<S7>/Integrator2' */
} XDot_Manual_control_to_overtakel_T;
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_p;      /* '<Root>/Integrator2' */
  boolean_T Integrator1_CSTATE_p;      /* '<Root>/Integrator1' */
...
} XDis_Manual_control_to_overtakel_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator1_Reset_ZCE;    /* '<S8>/Integrator1' */
} PrevZCX_Manual_control_to_overtakel_T;
...
#define rtB                            Manual_control_to_overtakel_B
#define BlockIO                        B_Manual_control_to_overtakel_T
#define rtX                            Manual_control_to_overtakel_X
#define ContinuousStates               X_Manual_control_to_overtakel_T
#define rtXdot                         Manual_control_to_overtakel_XDot
#define StateDerivatives               XDot_Manual_control_to_overtakel_T
#define tXdis                          Manual_control_to_overtakel_XDis
#define StateDisabled                  XDis_Manual_control_to_overtakel_T
#define rtP                            Manual_control_to_overtakel_P
#define Parameters                     P_Manual_control_to_overtakel_T
#define rtDWork                        Manual_control_to_overtakel_DW
#define D_Work                         DW_Manual_control_to_overtakel_T
#define rtPrevZCSigState               Manual_control_to_overtakel_PrevZCX
#define PrevZCSigStates                PrevZCX_Manual_control_to_overtakel_T

/* Parameters (default storage) */
struct P_Manual_control_to_overtakel_T_ {
  ...
  real_T arewethereyet_const;          /* Mask Parameter: arewethereyet_const
                                        ...
                                        */
  real_T Bicycle_steer_rate;           /* Mask Parameter: Bicycle_steer_rate
  ...
  uint32_T HILWrite1_other_channels; /* Mask Parameter: HILWrite1_other_channels
                                      ...
                                      */
  uint32_T HILRead_other_channels[3];  /* Mask Parameter: HILRead_other_channels
                                        * Referenced by: '<Root>/HIL Read'
                                        */
  ...
  real_T HILInitialize1_OOInitial;     /* Expression: initial_other_outputs
                                        * Referenced by: '<Root>/HIL Initialize1'
                                        */
  real_T velocitygainKv_Gain;          /* Expression: 0.25
  ...
  real_T Offset_Gain;                  /* Expression: 0.87
                                        ...
                                        */
  real_T Kpms_Gain;                    /* Expression: 0.6
...
struct tag_RTM_Manual_control_to_overtakel_T {
  const char_T *path;
...
extern P_Manual_control_to_overtakel_T Manual_control_to_overtakel_P;

/* Block signals (default storage) */
extern B_Manual_control_to_overtakel_T Manual_control_to_overtakel_B;

/* Continuous states (default storage) */
extern X_Manual_control_to_overtakel_T Manual_control_to_overtakel_X;

/* Block states (default storage) */
extern DW_Manual_control_to_overtakel_T Manual_control_to_overtakel_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_Manual_control_to_overtakel_T Manual_control_to_overtakel_PrevZCX;

/* Model entry point functions */
extern void Manual_control_to_overtakel_initialize(void);
extern void Manual_control_to_overtakel_output(void);
extern void Manual_control_to_overtakel_update(void);
extern void Manual_control_to_overtakel_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Manual_control_to_overtakel_rtModel *Manual_control_to_overtakel(void);
...
extern RT_MODEL_Manual_control_to_overtakel_T *const
 ...
 *
 * '<Root>' : 'Manual_control_to_overtakel'
 * '<S1>'   : 'Manual_control_to_overtakel/Bicycle'
 * '<S2>'   : 'Manual_control_to_overtakel/Second-Order Low-Pass Filter'
 * '<S3>'   : 'Manual_control_to_overtakel/XY Graph'
 * '<S4>'   : 'Manual_control_to_overtakel/angdiff'
 * '<S5>'   : 'Manual_control_to_overtakel/are we there yet?'
 * '<S6>'   : 'Manual_control_to_overtakel/basicSpeedEstimation'
 * '<S7>'   : 'Manual_control_to_overtakel/simple kinematic 2D steered vehicle model'
 * '<S8>'   : 'Manual_control_to_overtakel/speedController'
 * '<S9>'   : 'Manual_control_to_overtakel/angdiff/MATLAB Function'
 * '<S10>'  : 'Manual_control_to_overtakel/speedController/Compare To Zero'
 */
#endif                           /* RTW_HEADER_Manual_control_to_overtakel_h_ */
