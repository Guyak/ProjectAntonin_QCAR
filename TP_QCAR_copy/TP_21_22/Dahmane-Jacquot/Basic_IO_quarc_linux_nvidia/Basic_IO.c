...
void Basic_IO_output(void)
{
  ...
  Basic_IO_B.headingpositiongyroscope = Basic_IO_X.Integrator1_CSTATE;
  if (rtmIsMajorTimeStep(Basic_IO_M)) {
    ...
    /* S-Function Block: Basic_IO/basicQCarIO/HIL Read (hil_read_block) */
    {
      t_error result = hil_read(Basic_IO_DW.HILInitialize_Card,
        ...
        NULL, 0U,
        &Basic_IO_P.HILRead_other_channels, 1U,
      ...
      if (result < 0) {
        ...
        Basic_IO_B.HILRead_o4 = Basic_IO_DW.HILRead_OtherBuffer;
      }
    }
  ...
  if (Basic_IO_DW.Integrator1_IWORK != 0) {
    Basic_IO_X.Integrator1_CSTATE_d = Basic_IO_B.Unwrap224;
  }
   ...
   *  Sum: '<S6>/Sum1'
   */
  Basic_IO_B.Product = ((Basic_IO_B.Unwrap224 - Basic_IO_X.Integrator1_CSTATE_d)
  ...
  if (Basic_IO_DW.Integrator1_IWORK_j != 0) {
    Basic_IO_X.Integrator1_CSTATE_b = Basic_IO_B.HILRead_o4;
  }

  /* Integrator: '<S9>/Integrator1' */
  Basic_IO_B.Integrator1_p = Basic_IO_X.Integrator1_CSTATE_b;
   ...
   *  Sum: '<S9>/Sum1'
   */
  Basic_IO_B.Product_e = ((Basic_IO_B.HILRead_o4 - Basic_IO_B.Integrator1_p) -
    Basic_IO_X.Integrator2_CSTATE_aw * Basic_IO_P.Constant_Value_d *
    Basic_IO_P.Constant7_Value) * Basic_IO_P.Constant8_Value;

  /* Product: '<S9>/Product1' incorporates:
   *  Constant: '<S5>/Constant8'
   *  Integrator: '<S9>/Integrator2'
   */
  Basic_IO_B.Product1_n = Basic_IO_P.Constant8_Value *
    Basic_IO_X.Integrator2_CSTATE_aw;
  if (rtmIsMajorTimeStep(Basic_IO_M)) {
...
void Basic_IO_update(void)
{
  ...
  Basic_IO_DW.Integrator1_IWORK_j = 0;
  if (rtmIsMajorTimeStep(Basic_IO_M)) {
...
void Basic_IO_derivatives(void)
{
  ...
  _rtXdot->Integrator1_CSTATE = Basic_IO_B.Integrator1_p;

  /* Derivatives for Integrator: '<S6>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_d = Basic_IO_B.Product1;
  ...
  _rtXdot->Integrator1_CSTATE_b = Basic_IO_B.Product1_n;

  /* Derivatives for Integrator: '<S9>/Integrator2' */
  _rtXdot->Integrator2_CSTATE_aw = Basic_IO_B.Product_e;
}
...
void Basic_IO_initialize(void)
{
  ...
  if (rtmIsFirstInitCond(Basic_IO_M)) {
    ...
    Basic_IO_X.Integrator1_CSTATE_b = 0.0;
  }
  ...
  Basic_IO_DW.Integrator1_IWORK_j = 1;

  /* InitializeConditions for Integrator: '<S9>/Integrator2' */
  Basic_IO_X.Integrator2_CSTATE_aw = Basic_IO_P.Integrator2_IC_b;
...
RT_MODEL_Basic_IO_T *Basic_IO(void)
{
  ...
  /* External mode info */
  Basic_IO_M->Sizes.checksums[0] = (1805362737U);
  Basic_IO_M->Sizes.checksums[1] = (3093291923U);
  Basic_IO_M->Sizes.checksums[2] = (2073862745U);
  Basic_IO_M->Sizes.checksums[3] = (1326174660U);
  ...
  /* Initialize Sizes */
  Basic_IO_M->Sizes.numContStates = (9);/* Number of continuous states */
  ...
  Basic_IO_M->Sizes.numBlocks = (69);  /* Number of blocks */
  Basic_IO_M->Sizes.numBlockIO = (17); /* Number of block outputs */
  Basic_IO_M->Sizes.numBlockPrms = (156);/* Sum of parameter "widths" */
  return Basic_IO_M;
}
