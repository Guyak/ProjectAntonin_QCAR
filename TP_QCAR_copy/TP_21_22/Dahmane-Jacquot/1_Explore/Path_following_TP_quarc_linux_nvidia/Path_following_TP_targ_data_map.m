  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Path_following_TP_P.circuit
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_P.vehicle_length
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 578;
	
	  ;% Path_following_TP_P.yaw_ic
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 579;
  ...
  targMap.checksum0 = 3317389653;
  targMap.checksum1 = 1460179150;
  targMap.checksum2 = 2920257977;
  targMap.checksum3 = 2576620204;
