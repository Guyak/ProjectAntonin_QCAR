...
static DataTypeTransition rtBTransitions[] = {
  ...
  { (char_T *)(&Lidar_Point_Cloud_DW.BodyFramePolarPlot_IWORK[0]), 10, 0, 4 },

  { (char_T *)(&Lidar_Point_Cloud_DW.BodyFramePolarPlot_IsFull), 8, 0, 3 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&Lidar_Point_Cloud_P.BodyFramePolarPlot_maximum_rho), 0, 0, 8 },

  { (char_T *)(&Lidar_Point_Cloud_P.BodyFramePolarPlot_direction), 6, 0, 6 },

  { (char_T *)(&Lidar_Point_Cloud_P.RangingSensor1_Budget), 0, 0, 838 },

  { (char_T *)(&Lidar_Point_Cloud_P.BodyFramePolarPlot_L1Style), 6, 0, 20 },

  { (char_T *)(&Lidar_Point_Cloud_P.RangingSensor1_Range), 7, 0, 1 },

  { (char_T *)(&Lidar_Point_Cloud_P.RangingSensor1_Active), 8, 0, 2 },

  { (char_T *)(&Lidar_Point_Cloud_P.BodyFramePolarPlot_Mode), 3, 0, 2 }
};
