...
void Lidar_Point_Cloud_output(void)
{
  ...
  {
    t_error result;
    result = rplidar_read(Lidar_Point_Cloud_DW.RangingSensor1_Sensor,
...
void Lidar_Point_Cloud_initialize(void)
{
  ...
  /* S-Function Block: Lidar_Point_Cloud/captureLIDAR/Ranging Sensor1 (ranging_sensor_block) */
  {
    ...
    result = rplidar_open("serial-cpu://localhost:2?baud='115200',word='8',parity='none',stop='1',flow='none',dsr='on'",
                          (t_ranging_distance)
                          (Lidar_Point_Cloud_P.RangingSensor1_Range - 1),
...
void Lidar_Point_Cloud_terminate(void)
{
  ...
  /* S-Function Block: Lidar_Point_Cloud/captureLIDAR/Ranging Sensor1 (ranging_sensor_block) */
  {
    rplidar_close(Lidar_Point_Cloud_DW.RangingSensor1_Sensor);
...
RT_MODEL_Lidar_Point_Cloud_T *Lidar_Point_Cloud(void)
{
  ...
  /* External mode info */
  Lidar_Point_Cloud_M->Sizes.checksums[0] = (88827182U);
  Lidar_Point_Cloud_M->Sizes.checksums[1] = (2593209677U);
  Lidar_Point_Cloud_M->Sizes.checksums[2] = (3330169660U);
  Lidar_Point_Cloud_M->Sizes.checksums[3] = (3389867906U);
  ...
  Lidar_Point_Cloud_M->Sizes.numBlocks = (23);/* Number of blocks */
  Lidar_Point_Cloud_M->Sizes.numBlockIO = (10);/* Number of block outputs */
  Lidar_Point_Cloud_M->Sizes.numBlockPrms = (877);/* Sum of parameter "widths" */
