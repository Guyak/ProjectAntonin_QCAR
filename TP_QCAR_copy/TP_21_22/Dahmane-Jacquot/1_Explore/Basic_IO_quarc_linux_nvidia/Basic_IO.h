 ...
 * C source code generated on : Mon Jan 17 08:40:34 2022
 *
...
#ifndef RTW_HEADER_Basic_IO_h_
#define RTW_HEADER_Basic_IO_h_
#include <string.h>
#ifndef Basic_IO_COMMON_INCLUDES_
#define Basic_IO_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Basic_IO_COMMON_INCLUDES_ */

#include "Basic_IO_types.h"
...
#define Basic_IO_rtModel               RT_MODEL_Basic_IO_T

/* Block signals (default storage) */
typedef struct {
  real_T headingpositiongyroscope;     /* '<S5>/Integrator1' */
  real_T motorcurrent;                 /* '<S5>/HIL Read' */
  real_T batteryvoltage;               /* '<S5>/HIL Read' */
  real_T encodercounts;                /* '<S5>/HIL Read' */
  real_T HILRead_o4;                   /* '<S5>/HIL Read' */
  real_T Unwrap224;                    /* '<S5>/Unwrap 2^24' */
  real_T Product;                      /* '<S6>/Product' */
  real_T Product1;                     /* '<S6>/Product1' */
  real_T Integrator1;                  /* '<S7>/Integrator1' */
  real_T Product_h;                    /* '<S7>/Product' */
  real_T Product1_e;                   /* '<S7>/Product1' */
  real_T Integrator1_o;                /* '<S8>/Integrator1' */
  real_T Product_j;                    /* '<S8>/Product' */
  real_T Product1_m;                   /* '<S8>/Product1' */
  real_T Integrator1_p;                /* '<S9>/Integrator1' */
  real_T Product_e;                    /* '<S9>/Product' */
  real_T Product1_n;                   /* '<S9>/Product1' */
} B_Basic_IO_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_AIMinimums[7];  /* '<S5>/HIL Initialize' */
  real_T HILInitialize_AIMaximums[7];  /* '<S5>/HIL Initialize' */
  real_T HILInitialize_FilterFrequency[5];/* '<S5>/HIL Initialize' */
  real_T HILInitialize_POSortedFreqs;  /* '<S5>/HIL Initialize' */
  real_T HILInitialize_POValues;       /* '<S5>/HIL Initialize' */
  real_T HILInitialize_OOValues[13];   /* '<S5>/HIL Initialize' */
  real_T HILRead_AnalogBuffer[2];      /* '<S5>/HIL Read' */
  real_T HILRead_OtherBuffer;          /* '<S5>/HIL Read' */
  ...
  int32_T HILInitialize_DOStates;      /* '<S5>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[5];/* '<S5>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[5];/* '<S5>/HIL Initialize' */
  int32_T HILRead_EncoderBuffer;       /* '<S5>/HIL Read' */
  uint32_T HILInitialize_POSortedChans;/* '<S5>/HIL Initialize' */
  int_T Integrator1_IWORK;             /* '<S6>/Integrator1' */
  int_T Integrator1_IWORK_d;           /* '<S7>/Integrator1' */
  int_T Integrator1_IWORK_c;           /* '<S8>/Integrator1' */
  int_T Integrator1_IWORK_j;           /* '<S9>/Integrator1' */
  boolean_T Unwrap224_FirstSample;     /* '<S5>/Unwrap 2^24' */
  t_boolean HILWrite_DigitalBuffer;    /* '<S5>/HIL Write' */
} DW_Basic_IO_T;
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_c;         /* '<S7>/Integrator2' */
  real_T Integrator1_CSTATE_e;         /* '<S8>/Integrator1' */
  real_T Integrator2_CSTATE_a;         /* '<S8>/Integrator2' */
  real_T Integrator1_CSTATE_b;         /* '<S9>/Integrator1' */
  real_T Integrator2_CSTATE_aw;        /* '<S9>/Integrator2' */
} X_Basic_IO_T;
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_c;      /* '<S7>/Integrator2' */
  boolean_T Integrator1_CSTATE_e;      /* '<S8>/Integrator1' */
  boolean_T Integrator2_CSTATE_a;      /* '<S8>/Integrator2' */
  boolean_T Integrator1_CSTATE_b;      /* '<S9>/Integrator1' */
  boolean_T Integrator2_CSTATE_aw;     /* '<S9>/Integrator2' */
} XDis_Basic_IO_T;
...
#define rtB                            Basic_IO_B
#define BlockIO                        B_Basic_IO_T
#define rtX                            Basic_IO_X
#define ContinuousStates               X_Basic_IO_T
#define rtXdot                         Basic_IO_XDot
#define StateDerivatives               XDot_Basic_IO_T
#define tXdis                          Basic_IO_XDis
#define StateDisabled                  XDis_Basic_IO_T
#define rtP                            Basic_IO_P
#define Parameters                     P_Basic_IO_T
#define rtDWork                        Basic_IO_DW
#define D_Work                         DW_Basic_IO_T

/* Parameters (default storage) */
struct P_Basic_IO_T_ {
  real_T Throttle02to02_gain;          /* Mask Parameter: Throttle02to02_gain
                                        * Referenced by: '<S4>/Slider Gain'
                                        */
  real_T Steeringrad05to05_gain;       /* Mask Parameter: Steeringrad05to05_gain
...
extern P_Basic_IO_T Basic_IO_P;

/* Block signals (default storage) */
extern B_Basic_IO_T Basic_IO_B;

/* Continuous states (default storage) */
extern X_Basic_IO_T Basic_IO_X;

/* Block states (default storage) */
extern DW_Basic_IO_T Basic_IO_DW;

/* Model entry point functions */
extern void Basic_IO_initialize(void);
extern void Basic_IO_output(void);
extern void Basic_IO_update(void);
extern void Basic_IO_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Basic_IO_rtModel *Basic_IO(void);
...
extern RT_MODEL_Basic_IO_T *const Basic_IO_M;
 ...
 *
 * '<Root>' : 'Basic_IO'
 * '<S1>'   : 'Basic_IO/Powered by QUARC'
 * '<S2>'   : 'Basic_IO/Quanser'
 * '<S3>'   : 'Basic_IO/Steering (rad) {-0.5 to 0.5}'
 * '<S4>'   : 'Basic_IO/Throttle (%) {-0.2 to 0.2}'
 * '<S5>'   : 'Basic_IO/basicQCarIO'
 * '<S6>'   : 'Basic_IO/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S7>'   : 'Basic_IO/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S8>'   : 'Basic_IO/basicQCarIO/Second-Order Low-Pass Filter2'
 * '<S9>'   : 'Basic_IO/basicQCarIO/Second-Order Low-Pass Filter3'
 */
#endif                                 /* RTW_HEADER_Basic_IO_h_ */
