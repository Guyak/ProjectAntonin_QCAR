...
#ifndef struct_tag_A30WMsfxj6QFxgjzOlxUkG
#define struct_tag_A30WMsfxj6QFxgjzOlxUkG

struct tag_A30WMsfxj6QFxgjzOlxUkG
{
  ...
  real_T LastPose[3];
  real_T WaypointsInternal[140];
};

#endif                                 /* struct_tag_A30WMsfxj6QFxgjzOlxUkG */

#ifndef typedef_nav_slalgs_internal_PurePursu_T
#define typedef_nav_slalgs_internal_PurePursu_T

typedef struct tag_A30WMsfxj6QFxgjzOlxUkG nav_slalgs_internal_PurePursu_T;
