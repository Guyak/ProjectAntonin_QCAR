###########################################################################
## Makefile generated for component 'Stop_StudentVersionRP'. 
## 
## Makefile     : Stop_StudentVersionRP.mk
## Generated on : Tue Jan 11 17:41:28 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Stop_StudentVersionRP.rt-linux_nvidia
...
PRODUCT_NAME              = Stop_StudentVersionRP
MAKEFILE                  = Stop_StudentVersionRP.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/TP_QCAR/TP_21_22/Dahmane-Jacquot/3_VisionBased
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Stop_StudentVersionRP.rt-linux_nvidia
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=Stop_StudentVersionRP -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/Stop_StudentVersionRP.c $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/Stop_StudentVersionRP_data.c $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/Stop_StudentVersionRP_main.c $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = Stop_StudentVersionRP.o Stop_StudentVersionRP_data.o Stop_StudentVersionRP_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
LIBS = C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI8DF1~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI2456~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LIBQUA~4.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/LI5A2F~1.A C:/PROGRA~1/Quanser/QUARC/lib/LINUX_~3/libhil.a
...
%.o : $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
Stop_StudentVersionRP.o : $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/Stop_StudentVersionRP.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Stop_StudentVersionRP_data.o : $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/Stop_StudentVersionRP_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


Stop_StudentVersionRP_main.o : $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/Stop_StudentVersionRP_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/Stop_StudentVersionRP_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
