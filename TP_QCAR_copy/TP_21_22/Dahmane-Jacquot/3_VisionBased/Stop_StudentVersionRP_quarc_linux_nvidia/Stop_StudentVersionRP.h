...
#ifndef RTW_HEADER_Stop_StudentVersionRP_h_
#define RTW_HEADER_Stop_StudentVersionRP_h_
#include <math.h>
#include <string.h>
#ifndef Stop_StudentVersionRP_COMMON_INCLUDES_
#define Stop_StudentVersionRP_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
...
#endif                              /* Stop_StudentVersionRP_COMMON_INCLUDES_ */

#include "Stop_StudentVersionRP_types.h"
...
#define Stop_StudentVersionRP_rtModel  RT_MODEL_Stop_StudentVersionR_T
...
} XDis_Stop_StudentVersionRP_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator1_Reset_ZCE;    /* '<S10>/Integrator1' */
} PrevZCX_Stop_StudentVersionRP_T;
...
#define rtB                            Stop_StudentVersionRP_B
#define BlockIO                        B_Stop_StudentVersionRP_T
#define rtX                            Stop_StudentVersionRP_X
#define ContinuousStates               X_Stop_StudentVersionRP_T
#define rtXdot                         Stop_StudentVersionRP_XDot
#define StateDerivatives               XDot_Stop_StudentVersionRP_T
#define tXdis                          Stop_StudentVersionRP_XDis
#define StateDisabled                  XDis_Stop_StudentVersionRP_T
#define rtP                            Stop_StudentVersionRP_P
#define Parameters                     P_Stop_StudentVersionRP_T
#define rtDWork                        Stop_StudentVersionRP_DW
#define D_Work                         DW_Stop_StudentVersionRP_T
#define rtPrevZCSigState               Stop_StudentVersionRP_PrevZCX
#define PrevZCSigStates                PrevZCX_Stop_StudentVersionRP_T

/* Parameters (default storage) */
struct P_Stop_StudentVersionRP_T_ {
...
struct tag_RTM_Stop_StudentVersionRP_T {
  const char_T *path;
...
extern P_Stop_StudentVersionRP_T Stop_StudentVersionRP_P;

/* Block signals (default storage) */
extern B_Stop_StudentVersionRP_T Stop_StudentVersionRP_B;

/* Continuous states (default storage) */
extern X_Stop_StudentVersionRP_T Stop_StudentVersionRP_X;

/* Block states (default storage) */
extern DW_Stop_StudentVersionRP_T Stop_StudentVersionRP_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_Stop_StudentVersionRP_T Stop_StudentVersionRP_PrevZCX;

/* Model entry point functions */
extern void Stop_StudentVersionRP_initialize(void);
extern void Stop_StudentVersionRP_output(void);
extern void Stop_StudentVersionRP_update(void);
extern void Stop_StudentVersionRP_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Stop_StudentVersionRP_rtModel *Stop_StudentVersionRP(void);
...
extern RT_MODEL_Stop_StudentVersionR_T *const Stop_StudentVersionRP_M;
 ...
 *
 * '<Root>' : 'Stop_StudentVersionRP'
 * '<S1>'   : 'Stop_StudentVersionRP/MATLAB Function1'
 * '<S2>'   : 'Stop_StudentVersionRP/Powered by QUARC'
 * '<S3>'   : 'Stop_StudentVersionRP/QCar'
 * '<S4>'   : 'Stop_StudentVersionRP/Quanser'
 * '<S5>'   : 'Stop_StudentVersionRP/basicSpeedEstimation'
 * '<S6>'   : 'Stop_StudentVersionRP/captureRGBD'
 * '<S7>'   : 'Stop_StudentVersionRP/findStopSignDistance'
 * '<S8>'   : 'Stop_StudentVersionRP/findStopSignLocation'
 * '<S9>'   : 'Stop_StudentVersionRP/monitorTiming '
 * '<S10>'  : 'Stop_StudentVersionRP/speedController'
 * '<S11>'  : 'Stop_StudentVersionRP/QCar/Second-Order Low-Pass Filter'
 * '<S12>'  : 'Stop_StudentVersionRP/findStopSignDistance/Depth Image (m)'
 * '<S13>'  : 'Stop_StudentVersionRP/findStopSignLocation/Binary showing blob found'
 * '<S14>'  : 'Stop_StudentVersionRP/findStopSignLocation/Compare To Constant'
 * '<S15>'  : 'Stop_StudentVersionRP/findStopSignLocation/Raw RGB'
 * '<S16>'  : 'Stop_StudentVersionRP/findStopSignLocation/colorThresholdingHSV'
 * '<S17>'  : 'Stop_StudentVersionRP/findStopSignLocation/colorThresholdingHSV/Compare To Constant'
 * '<S18>'  : 'Stop_StudentVersionRP/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_Stop_StudentVersionRP_h_ */
