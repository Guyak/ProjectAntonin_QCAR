 ...
 * C source code generated on : Mon Jan 10 09:08:05 2022
 *
...
typedef struct {
  real_T motorcurrent;                 /* '<S4>/HIL Read' */
  real_T batteryvoltage;               /* '<S4>/HIL Read' */
  real_T encodercounts;                /* '<S4>/HIL Read' */
  real_T Unwrap224;                    /* '<S4>/Unwrap 2^24' */
  ...
  real_T Product_j;                    /* '<S7>/Product' */
  real_T Product1_m;                   /* '<S7>/Product1' */
} B_Basic_IO_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_AIMinimums[7];  /* '<S4>/HIL Initialize' */
  real_T HILInitialize_AIMaximums[7];  /* '<S4>/HIL Initialize' */
  real_T HILInitialize_FilterFrequency[5];/* '<S4>/HIL Initialize' */
  real_T HILInitialize_POSortedFreqs;  /* '<S4>/HIL Initialize' */
  real_T HILInitialize_POValues;       /* '<S4>/HIL Initialize' */
  real_T HILInitialize_OOValues[13];   /* '<S4>/HIL Initialize' */
  real_T HILRead_AnalogBuffer[2];      /* '<S4>/HIL Read' */
  real_T Unwrap224_PreviousInput;      /* '<S4>/Unwrap 2^24' */
  real_T Unwrap224_Revolutions;        /* '<S4>/Unwrap 2^24' */
  t_card HILInitialize_Card;           /* '<S4>/HIL Initialize' */
  void *HILRead_PWORK;                 /* '<S4>/HIL Read' */
  void *HILWrite_PWORK;                /* '<S4>/HIL Write' */
  int32_T HILInitialize_DOStates;      /* '<S4>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[5];/* '<S4>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[5];/* '<S4>/HIL Initialize' */
  int32_T HILRead_EncoderBuffer;       /* '<S4>/HIL Read' */
  uint32_T HILInitialize_POSortedChans;/* '<S4>/HIL Initialize' */
  int_T Integrator1_IWORK;             /* '<S5>/Integrator1' */
  int_T Integrator1_IWORK_d;           /* '<S6>/Integrator1' */
  int_T Integrator1_IWORK_c;           /* '<S7>/Integrator1' */
  boolean_T Unwrap224_FirstSample;     /* '<S4>/Unwrap 2^24' */
  t_boolean HILWrite_DigitalBuffer;    /* '<S4>/HIL Write' */
} DW_Basic_IO_T;
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_c;         /* '<S6>/Integrator2' */
  real_T Integrator1_CSTATE_e;         /* '<S7>/Integrator1' */
  real_T Integrator2_CSTATE_a;         /* '<S7>/Integrator2' */
} X_Basic_IO_T;
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_c;      /* '<S6>/Integrator2' */
  boolean_T Integrator1_CSTATE_e;      /* '<S7>/Integrator1' */
  boolean_T Integrator2_CSTATE_a;      /* '<S7>/Integrator2' */
} XDis_Basic_IO_T;
...
struct P_Basic_IO_T_ {
  ...
  real_T directionconvention_Gain;     /* Expression: -1
                                        * Referenced by: '<S4>/direction convention'
                                        */
  ...
  real_T coastON_Value;                /* Expression: 0
                                        * Referenced by: '<S4>/coast ON'
                                        */
  real_T Gain_Gain;                    /* Expression: -1
                                        * Referenced by: '<S4>/Gain'
                                        */
  real_T SteeringBias_Bias;            /* Expression: 0.0
                                        * Referenced by: '<S4>/Steering Bias'
                                        */
 ...
 * '<S2>'   : 'Basic_IO/Quanser'
 * '<S3>'   : 'Basic_IO/Throttle (%) {-0.2 to 0.2}'
 * '<S4>'   : 'Basic_IO/basicQCarIO'
 * '<S5>'   : 'Basic_IO/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S6>'   : 'Basic_IO/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S7>'   : 'Basic_IO/basicQCarIO/Second-Order Low-Pass Filter2'
 */
