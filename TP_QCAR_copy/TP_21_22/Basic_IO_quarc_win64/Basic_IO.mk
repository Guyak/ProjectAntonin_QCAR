...
## Generated on : Mon Jan 10 09:08:08 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Basic_IO.rt-win64
...
COMPILER_COMMAND_FILE     = Basic_IO_comp.rsp
CMD_FILE                  = Basic_IO.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Basic_IO.rt-win64
...
SRCS = $(START_DIR)\Basic_IO_quarc_win64\Basic_IO.c $(START_DIR)\Basic_IO_quarc_win64\Basic_IO_data.c $(START_DIR)\Basic_IO_quarc_win64\Basic_IO_main.c $(START_DIR)\Basic_IO_quarc_win64\rtGetInf.c $(START_DIR)\Basic_IO_quarc_win64\rtGetNaN.c $(START_DIR)\Basic_IO_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Basic_IO.obj Basic_IO_data.obj Basic_IO_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Basic_IO_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Basic_IO_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Basic_IO.obj : $(START_DIR)\Basic_IO_quarc_win64\Basic_IO.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Basic_IO_quarc_win64\Basic_IO.c


Basic_IO_data.obj : $(START_DIR)\Basic_IO_quarc_win64\Basic_IO_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Basic_IO_quarc_win64\Basic_IO_data.c


Basic_IO_main.obj : $(START_DIR)\Basic_IO_quarc_win64\Basic_IO_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Basic_IO_quarc_win64\Basic_IO_main.c


rtGetInf.obj : $(START_DIR)\Basic_IO_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Basic_IO_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\Basic_IO_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Basic_IO_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\Basic_IO_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Basic_IO_quarc_win64\rt_nonfinite.c
