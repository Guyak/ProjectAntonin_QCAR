...
void Basic_IO_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Basic_IO_M)) {
    ...
    /* S-Function (inverse_modulus_block): '<S4>/Unwrap 2^24' */
  ...
  if (rtmIsMajorTimeStep(Basic_IO_M)) {
    /* Gain: '<S4>/direction convention' incorporates:
    ...
    /* End of Saturate: '<S4>/command saturation' */

    /* SignalConversion generated from: '<S4>/HIL Write' incorporates:
     *  Bias: '<S4>/Steering Bias'
     *  Gain: '<S4>/Gain'
     */
    rtb_TmpSignalConversionAtHILWri[0] = Basic_IO_P.Gain_Gain * 0.0 +
...
void Basic_IO_initialize(void)
{
  ...
  /* Start for S-Function (inverse_modulus_block): '<S4>/Unwrap 2^24' */
...
RT_MODEL_Basic_IO_T *Basic_IO(void)
{
  ...
  /* External mode info */
  Basic_IO_M->Sizes.checksums[0] = (3221661156U);
  Basic_IO_M->Sizes.checksums[1] = (2765720811U);
  Basic_IO_M->Sizes.checksums[2] = (2297835631U);
  Basic_IO_M->Sizes.checksums[3] = (2514657932U);
  ...
  Basic_IO_M->Sizes.numBlocks = (55);  /* Number of blocks */
  Basic_IO_M->Sizes.numBlockIO = (12); /* Number of block outputs */
  Basic_IO_M->Sizes.numBlockPrms = (149);/* Sum of parameter "widths" */
  return Basic_IO_M;
}
