 ...
 * C source code generated on : Fri Jan 21 09:01:07 2022
 *
...
#ifndef RTW_HEADER_Keyboard_h_
#define RTW_HEADER_Keyboard_h_
#include <string.h>
#ifndef Keyboard_COMMON_INCLUDES_
#define Keyboard_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Keyboard_COMMON_INCLUDES_ */
...
#define Keyboard_rtModel               RT_MODEL_Keyboard_T

/* Block signals (default storage) */
typedef struct {
  real_T motorcurrent;                 /* '<S1>/HIL Read' */
  real_T batteryvoltage;               /* '<S1>/HIL Read' */
  real_T encodercounts;                /* '<S1>/HIL Read' */
  real_T Unwrap224;                    /* '<S1>/Unwrap 2^24' */
  real_T Product;                      /* '<S2>/Product' */
  real_T Product1;                     /* '<S2>/Product1' */
  real_T Integrator1;                  /* '<S3>/Integrator1' */
  real_T Product_h;                    /* '<S3>/Product' */
  real_T Product1_e;                   /* '<S3>/Product1' */
  real_T Integrator1_o;                /* '<S4>/Integrator1' */
  real_T Product_j;                    /* '<S4>/Product' */
...
typedef struct {
  ...
  real_T HILInitialize_AIMinimums[7];  /* '<S1>/HIL Initialize' */
  real_T HILInitialize_AIMaximums[7];  /* '<S1>/HIL Initialize' */
  real_T HILInitialize_FilterFrequency[5];/* '<S1>/HIL Initialize' */
  real_T HILInitialize_POSortedFreqs;  /* '<S1>/HIL Initialize' */
  real_T HILInitialize_POValues;       /* '<S1>/HIL Initialize' */
  real_T HILInitialize_OOValues[13];   /* '<S1>/HIL Initialize' */
  real_T HILRead_AnalogBuffer[2];      /* '<S1>/HIL Read' */
  real_T Unwrap224_PreviousInput;      /* '<S1>/Unwrap 2^24' */
  real_T Unwrap224_Revolutions;        /* '<S1>/Unwrap 2^24' */
  ...
  int32_T HILInitialize_QuadratureModes[5];/* '<S1>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[5];/* '<S1>/HIL Initialize' */
  int32_T HILRead_EncoderBuffer;       /* '<S1>/HIL Read' */
  uint32_T HILInitialize_POSortedChans;/* '<S1>/HIL Initialize' */
  int_T Integrator1_IWORK;             /* '<S2>/Integrator1' */
  int_T Integrator1_IWORK_d;           /* '<S3>/Integrator1' */
  int_T Integrator1_IWORK_c;           /* '<S4>/Integrator1' */
  boolean_T Unwrap224_FirstSample;     /* '<S1>/Unwrap 2^24' */
  boolean_T HostKeyboard_NewData;      /* '<Root>/Host Keyboard' */
  t_boolean HILWrite_DigitalBuffer;    /* '<S1>/HIL Write' */
} DW_Keyboard_T;
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_c;         /* '<S3>/Integrator2' */
  real_T Integrator1_CSTATE_e;         /* '<S4>/Integrator1' */
  real_T Integrator2_CSTATE_a;         /* '<S4>/Integrator2' */
} X_Keyboard_T;
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_c;      /* '<S3>/Integrator2' */
  boolean_T Integrator1_CSTATE_e;      /* '<S4>/Integrator1' */
  boolean_T Integrator2_CSTATE_a;      /* '<S4>/Integrator2' */
} XDis_Keyboard_T;
...
#define rtB                            Keyboard_B
#define BlockIO                        B_Keyboard_T
#define rtX                            Keyboard_X
#define ContinuousStates               X_Keyboard_T
#define rtXdot                         Keyboard_XDot
#define StateDerivatives               XDot_Keyboard_T
#define tXdis                          Keyboard_XDis
#define StateDisabled                  XDis_Keyboard_T
#define rtP                            Keyboard_P
#define Parameters                     P_Keyboard_T
#define rtDWork                        Keyboard_DW
#define D_Work                         DW_Keyboard_T

/* Parameters (default storage) */
struct P_Keyboard_T_ {
  ...
  real_T Integrator2_IC_n;             /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain;                    /* Expression: 0.12
...
extern P_Keyboard_T Keyboard_P;

/* Block signals (default storage) */
extern B_Keyboard_T Keyboard_B;

/* Continuous states (default storage) */
extern X_Keyboard_T Keyboard_X;

/* Block states (default storage) */
extern DW_Keyboard_T Keyboard_DW;

/* Model entry point functions */
extern void Keyboard_initialize(void);
extern void Keyboard_output(void);
extern void Keyboard_update(void);
extern void Keyboard_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Keyboard_rtModel *Keyboard(void);
...
extern RT_MODEL_Keyboard_T *const Keyboard_M;
 ...
 *
 * '<Root>' : 'Keyboard'
 * '<S1>'   : 'Keyboard/basicQCarIO'
 * '<S2>'   : 'Keyboard/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S3>'   : 'Keyboard/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S4>'   : 'Keyboard/basicQCarIO/Second-Order Low-Pass Filter2'
 */
#endif                                 /* RTW_HEADER_Keyboard_h_ */
