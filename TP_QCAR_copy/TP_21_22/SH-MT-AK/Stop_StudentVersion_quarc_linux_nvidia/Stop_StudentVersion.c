 ...
 * C source code generated on : Fri Jan 21 11:03:28 2022
 *
...
void Stop_StudentVersion_output(void)
{
  ...
  if (rtmIsMajorTimeStep(Stop_StudentVersion_M)) {
     ...
     *  Constant: '<Root>/m//s'
     */
    if ((Stop_StudentVersion_B.Selector > 0.5F) &&
        (Stop_StudentVersion_B.Selector < 0.4)) {
      rtb_SteeringBias = 0.0;
    } else {
...
RT_MODEL_Stop_StudentVersion_T *Stop_StudentVersion(void)
{
  ...
  /* External mode info */
  Stop_StudentVersion_M->Sizes.checksums[0] = (468526089U);
  Stop_StudentVersion_M->Sizes.checksums[1] = (2564860008U);
  Stop_StudentVersion_M->Sizes.checksums[2] = (4237589197U);
  Stop_StudentVersion_M->Sizes.checksums[3] = (1543899050U);
