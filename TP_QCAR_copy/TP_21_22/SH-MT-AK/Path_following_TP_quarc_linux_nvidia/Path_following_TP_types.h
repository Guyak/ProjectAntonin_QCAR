...
#ifndef struct_tag_vMMJHYFiyQBVHLMMBqTEkE
#define struct_tag_vMMJHYFiyQBVHLMMBqTEkE

struct tag_vMMJHYFiyQBVHLMMBqTEkE
{
  ...
  real_T LastPose[3];
  real_T WaypointsInternal[6004];
};

#endif                                 /* struct_tag_vMMJHYFiyQBVHLMMBqTEkE */

#ifndef typedef_nav_slalgs_internal_PurePursu_T
#define typedef_nav_slalgs_internal_PurePursu_T

typedef struct tag_vMMJHYFiyQBVHLMMBqTEkE nav_slalgs_internal_PurePursu_T;
