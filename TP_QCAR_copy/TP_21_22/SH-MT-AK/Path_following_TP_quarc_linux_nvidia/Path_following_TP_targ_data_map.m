  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Path_following_TP_P.p4
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_P.vehicle_length
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 6006;
	
	  ;% Path_following_TP_P.yaw_ic
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 6007;
  ...
  targMap.checksum0 = 2018510576;
  targMap.checksum1 = 4227878520;
  targMap.checksum2 = 1093458716;
  targMap.checksum3 = 3068668789;
