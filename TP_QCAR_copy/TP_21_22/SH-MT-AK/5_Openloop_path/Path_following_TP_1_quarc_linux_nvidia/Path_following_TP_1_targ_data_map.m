  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (Path_following_TP_1_P)
    ;%
      section.nData     = 4;
      section.data(4)  = dumData; %prealloc
      
	  ;% Path_following_TP_1_P.X_ic
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Path_following_TP_1_P.Y_ic
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Path_following_TP_1_P.vehicle_length
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_1_P.yaw_ic
	  ...
	  ;% Path_following_TP_1_P.HILRead_encoder_channels
	  section.data(1).logicalSrcIdx = 4;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Path_following_TP_1_P.HILWrite1_other_channels
	  section.data(2).logicalSrcIdx = 5;
	  section.data(2).dtTransOffset = 2;
	
	  ;% Path_following_TP_1_P.HILRead_other_channels
	  section.data(3).logicalSrcIdx = 6;
	  section.data(3).dtTransOffset = 3;
	
	  ;% Path_following_TP_1_P.HILWrite1_pwm_channels
	  ...
	  ;% Path_following_TP_1_P.HILInitialize1_OOTerminate
	  section.data(2).logicalSrcIdx = 9;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Path_following_TP_1_P.HILInitialize1_OOExit
	  section.data(3).logicalSrcIdx = 10;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_1_P.HILInitialize1_OOStart
	  section.data(4).logicalSrcIdx = 11;
	  section.data(4).dtTransOffset = 3;
	
	  ;% Path_following_TP_1_P.HILInitialize1_OOEnter
	  section.data(5).logicalSrcIdx = 12;
	  section.data(5).dtTransOffset = 4;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POFinal
	  section.data(6).logicalSrcIdx = 13;
	  section.data(6).dtTransOffset = 5;
	
	  ;% Path_following_TP_1_P.HILInitialize1_OOFinal
	  section.data(7).logicalSrcIdx = 14;
	  section.data(7).dtTransOffset = 6;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AIHigh
	  section.data(8).logicalSrcIdx = 15;
	  section.data(8).dtTransOffset = 7;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AILow
	  ...
	  ;% Path_following_TP_1_P.HILInitialize1_POInitial
	  section.data(12).logicalSrcIdx = 19;
	  section.data(12).dtTransOffset = 11;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POWatchdog
	  section.data(13).logicalSrcIdx = 20;
	  section.data(13).dtTransOffset = 12;
	
	  ;% Path_following_TP_1_P.HILInitialize1_OOInitial
	  section.data(14).logicalSrcIdx = 21;
	  section.data(14).dtTransOffset = 13;
	
	  ;% Path_following_TP_1_P.Speed_Value
	  ...
	  ;% Path_following_TP_1_P.Kffms_Gain
	  ...
	  ;% Path_following_TP_1_P.countstorotations_Gain
	  section.data(22).logicalSrcIdx = 29;
	  section.data(22).dtTransOffset = 21;
	
	  ;% Path_following_TP_1_P.gearratios_Gain
	  ...
	  ;% Path_following_TP_1_P.wheelradius_Gain
	  section.data(25).logicalSrcIdx = 32;
	  section.data(25).dtTransOffset = 24;
	
	  ;% Path_following_TP_1_P.Offset_Gain
	  section.data(26).logicalSrcIdx = 33;
	  section.data(26).dtTransOffset = 25;
	
	  ;% Path_following_TP_1_P.Kpms_Gain
	  ...
	  ;% Path_following_TP_1_P.Motor_commandsat_UpperSat
	  section.data(31).logicalSrcIdx = 38;
	  section.data(31).dtTransOffset = 30;
	
	  ;% Path_following_TP_1_P.Motor_commandsat_LowerSat
	  ...
	  ;% Path_following_TP_1_P.Constant6_Value
	  ...
	  ;% Path_following_TP_1_P.SineWaveFunction_Freq
	  ...
	  ;% Path_following_TP_1_P.Kim_Gain
	  ...
	  ;% Path_following_TP_1_P.HILInitialize1_POModes
	  ...
	  ;% Path_following_TP_1_P.HILInitialize1_AIChannels
	  section.data(1).logicalSrcIdx = 63;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Path_following_TP_1_P.HILInitialize1_DIChannels
	  ...
	  ;% Path_following_TP_1_P.HILInitialize1_EIChannels
	  section.data(4).logicalSrcIdx = 66;
	  section.data(4).dtTransOffset = 28;
	
	  ;% Path_following_TP_1_P.HILInitialize1_EIQuadrature
	  ...
	  ;% Path_following_TP_1_P.HILInitialize1_Active
	  section.data(1).logicalSrcIdx = 70;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AOTerminate
	  section.data(2).logicalSrcIdx = 71;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AOExit
	  section.data(3).logicalSrcIdx = 72;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_1_P.HILInitialize1_DOTerminate
	  section.data(4).logicalSrcIdx = 73;
	  section.data(4).dtTransOffset = 3;
	
	  ;% Path_following_TP_1_P.HILInitialize1_DOExit
	  section.data(5).logicalSrcIdx = 74;
	  section.data(5).dtTransOffset = 4;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POTerminate
	  section.data(6).logicalSrcIdx = 75;
	  section.data(6).dtTransOffset = 5;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POExit
	  section.data(7).logicalSrcIdx = 76;
	  section.data(7).dtTransOffset = 6;
	
	  ;% Path_following_TP_1_P.HILInitialize1_CKPStart
	  section.data(8).logicalSrcIdx = 77;
	  section.data(8).dtTransOffset = 7;
	
	  ;% Path_following_TP_1_P.HILInitialize1_CKPEnter
	  section.data(9).logicalSrcIdx = 78;
	  section.data(9).dtTransOffset = 8;
	
	  ;% Path_following_TP_1_P.HILInitialize1_CKStart
	  section.data(10).logicalSrcIdx = 79;
	  section.data(10).dtTransOffset = 9;
	
	  ;% Path_following_TP_1_P.HILInitialize1_CKEnter
	  section.data(11).logicalSrcIdx = 80;
	  section.data(11).dtTransOffset = 10;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AIPStart
	  section.data(12).logicalSrcIdx = 81;
	  section.data(12).dtTransOffset = 11;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AIPEnter
	  section.data(13).logicalSrcIdx = 82;
	  section.data(13).dtTransOffset = 12;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AOPStart
	  section.data(14).logicalSrcIdx = 83;
	  section.data(14).dtTransOffset = 13;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AOPEnter
	  section.data(15).logicalSrcIdx = 84;
	  section.data(15).dtTransOffset = 14;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AOStart
	  section.data(16).logicalSrcIdx = 85;
	  section.data(16).dtTransOffset = 15;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AOEnter
	  section.data(17).logicalSrcIdx = 86;
	  section.data(17).dtTransOffset = 16;
	
	  ;% Path_following_TP_1_P.HILInitialize1_AOReset
	  section.data(18).logicalSrcIdx = 87;
	  section.data(18).dtTransOffset = 17;
	
	  ;% Path_following_TP_1_P.HILInitialize1_DOPStart
	  section.data(19).logicalSrcIdx = 88;
	  section.data(19).dtTransOffset = 18;
	
	  ;% Path_following_TP_1_P.HILInitialize1_DOPEnter
	  section.data(20).logicalSrcIdx = 89;
	  section.data(20).dtTransOffset = 19;
	
	  ;% Path_following_TP_1_P.HILInitialize1_DOStart
	  section.data(21).logicalSrcIdx = 90;
	  section.data(21).dtTransOffset = 20;
	
	  ;% Path_following_TP_1_P.HILInitialize1_DOEnter
	  section.data(22).logicalSrcIdx = 91;
	  section.data(22).dtTransOffset = 21;
	
	  ;% Path_following_TP_1_P.HILInitialize1_DOReset
	  section.data(23).logicalSrcIdx = 92;
	  section.data(23).dtTransOffset = 22;
	
	  ;% Path_following_TP_1_P.HILInitialize1_EIPStart
	  section.data(24).logicalSrcIdx = 93;
	  section.data(24).dtTransOffset = 23;
	
	  ;% Path_following_TP_1_P.HILInitialize1_EIPEnter
	  section.data(25).logicalSrcIdx = 94;
	  section.data(25).dtTransOffset = 24;
	
	  ;% Path_following_TP_1_P.HILInitialize1_EIStart
	  section.data(26).logicalSrcIdx = 95;
	  section.data(26).dtTransOffset = 25;
	
	  ;% Path_following_TP_1_P.HILInitialize1_EIEnter
	  section.data(27).logicalSrcIdx = 96;
	  section.data(27).dtTransOffset = 26;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POPStart
	  section.data(28).logicalSrcIdx = 97;
	  section.data(28).dtTransOffset = 27;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POPEnter
	  section.data(29).logicalSrcIdx = 98;
	  section.data(29).dtTransOffset = 28;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POStart
	  section.data(30).logicalSrcIdx = 99;
	  section.data(30).dtTransOffset = 29;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POEnter
	  section.data(31).logicalSrcIdx = 100;
	  section.data(31).dtTransOffset = 30;
	
	  ;% Path_following_TP_1_P.HILInitialize1_POReset
	  section.data(32).logicalSrcIdx = 101;
	  section.data(32).dtTransOffset = 31;
	
	  ;% Path_following_TP_1_P.HILInitialize1_OOReset
	  ...
	  ;% Path_following_TP_1_P.HILWrite1_Active
	  section.data(36).logicalSrcIdx = 105;
	  section.data(36).dtTransOffset = 35;
	
	  ;% Path_following_TP_1_P.HILRead_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (Path_following_TP_1_B)
    ;%
      section.nData     = 21;
      section.data(21)  = dumData; %prealloc
      
	  ;% Path_following_TP_1_B.Speed
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% Path_following_TP_1_B.Product1
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% Path_following_TP_1_B.Offset
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% Path_following_TP_1_B.measured
	  ...
	  ;% Path_following_TP_1_B.Integrator
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 10;
	
	  ;% Path_following_TP_1_B.Integrator1
	  ...
	  ;% Path_following_TP_1_B.Unwrap224
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 14;
	
	  ;% Path_following_TP_1_B.Product_e
	  ...
	  ;% Path_following_TP_1_B.v_Xms
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 17;
	
	  ;% Path_following_TP_1_B.v_Yms
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 18;
	
	  ;% Path_following_TP_1_B.Kim
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 19;
	
	  ;% Path_following_TP_1_B.RateTransition
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (Path_following_TP_1_DW)
    ;%
      section.nData     = 10;
      section.data(10)  = dumData; %prealloc
      
	  ;% Path_following_TP_1_DW.AnimationSFunction_DSTATE
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_AIMinimums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 6;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_AIMaximums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 13;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_FilterFrequency
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 20;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_POSortedFreqs
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 25;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_POValues
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 33;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_OOValues
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 41;
	
	  ;% Path_following_TP_1_DW.HILRead_OtherBuffer
	  section.data(8).logicalSrcIdx = 7;
	  ...
	  ;% Path_following_TP_1_DW.HILWrite1_PWORK
	  section.data(1).logicalSrcIdx = 11;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Path_following_TP_1_DW.Scope_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 12;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Path_following_TP_1_DW.Scope1_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 13;
	  section.data(3).dtTransOffset = 2;
	
	  ;% Path_following_TP_1_DW.HILRead_PWORK
	  section.data(4).logicalSrcIdx = 14;
	  section.data(4).dtTransOffset = 4;
	
	  ;% Path_following_TP_1_DW.Scope_PWORK_n.LoggedData
	  section.data(5).logicalSrcIdx = 15;
	  section.data(5).dtTransOffset = 5;
	
	  ;% Path_following_TP_1_DW.Scope_PWORK_c.LoggedData
	  ...
	  ;% Path_following_TP_1_DW.HILInitialize1_DOStates
	  section.data(1).logicalSrcIdx = 17;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_QuadratureModes
	  section.data(2).logicalSrcIdx = 18;
	  section.data(2).dtTransOffset = 1;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_InitialEICounts
	  section.data(3).logicalSrcIdx = 19;
	  section.data(3).dtTransOffset = 6;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_POModeValues
	  section.data(4).logicalSrcIdx = 20;
	  section.data(4).dtTransOffset = 11;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_POAlignValues
	  section.data(5).logicalSrcIdx = 21;
	  section.data(5).dtTransOffset = 19;
	
	  ;% Path_following_TP_1_DW.HILInitialize1_POPolarityVals
	  section.data(6).logicalSrcIdx = 22;
	  section.data(6).dtTransOffset = 27;
	
	  ;% Path_following_TP_1_DW.HILRead_EncoderBuffer
	  ...
	  ;% Path_following_TP_1_DW.HILInitialize1_POSortedChans
	  ...
	  ;% Path_following_TP_1_DW.Integrator1_IWORK
	  ...
	  ;% Path_following_TP_1_DW.Unwrap224_FirstSample
  ...
  targMap.checksum0 = 789728585;
  targMap.checksum1 = 4026775114;
  targMap.checksum2 = 67514307;
  targMap.checksum3 = 1828624872;
