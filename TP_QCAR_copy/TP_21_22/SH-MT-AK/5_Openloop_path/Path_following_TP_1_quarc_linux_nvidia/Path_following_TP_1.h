...
#ifndef RTW_HEADER_Path_following_TP_1_h_
#define RTW_HEADER_Path_following_TP_1_h_
#include <math.h>
#include <string.h>
#ifndef Path_following_TP_1_COMMON_INCLUDES_
#define Path_following_TP_1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                /* Path_following_TP_1_COMMON_INCLUDES_ */

#include "Path_following_TP_1_types.h"
...
#define Path_following_TP_1_rtModel    RT_MODEL_Path_following_TP_1_T

/* Block signals (default storage) */
typedef struct {
  real_T Speed;                        /* '<S3>/Speed' */
  real_T desired;                      /* '<S7>/Multiply1' */
  real_T Kffms;                        /* '<S7>/Kff  (% // m//s)' */
  ...
  real_T SignalGenerator;              /* '<S3>/Signal Generator' */
...
#define rtB                            Path_following_TP_1_B
#define BlockIO                        B_Path_following_TP_1_T
#define rtX                            Path_following_TP_1_X
#define ContinuousStates               X_Path_following_TP_1_T
#define rtXdot                         Path_following_TP_1_XDot
#define StateDerivatives               XDot_Path_following_TP_1_T
#define tXdis                          Path_following_TP_1_XDis
#define StateDisabled                  XDis_Path_following_TP_1_T
#define rtP                            Path_following_TP_1_P
#define Parameters                     P_Path_following_TP_1_T
#define rtDWork                        Path_following_TP_1_DW
#define D_Work                         DW_Path_following_TP_1_T
#define rtPrevZCSigState               Path_following_TP_1_PrevZCX
#define PrevZCSigStates                PrevZCX_Path_following_TP_1_T

/* Parameters (default storage) */
struct P_Path_following_TP_1_T_ {
  ...
  real_T Bicyclelength_Value;          /* Expression: 0.256
                                        ...
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: 0.15
                                        * Referenced by: '<S3>/Signal Generator'
                                        */
  ...
  real_T SineWaveFunction_Phase;       /* Expression: 0
                                        * Referenced by: '<S1>/Sine Wave Function'
                                        */
  real_T Lookaheaddistance_Value;      /* Expression: 0.1
...
struct tag_RTM_Path_following_TP_1_T {
  const char_T *path;
...
extern P_Path_following_TP_1_T Path_following_TP_1_P;

/* Block signals (default storage) */
extern B_Path_following_TP_1_T Path_following_TP_1_B;

/* Continuous states (default storage) */
extern X_Path_following_TP_1_T Path_following_TP_1_X;

/* Block states (default storage) */
extern DW_Path_following_TP_1_T Path_following_TP_1_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_Path_following_TP_1_T Path_following_TP_1_PrevZCX;
...
extern void Path_following_TP_1_initialize(void);
extern void Path_following_TP_1_output0(void);
extern void Path_following_TP_1_update0(void);
extern void Path_following_TP_1_output2(void);
extern void Path_following_TP_1_update2(void);
extern void Path_following_TP_1_output(int_T tid);
extern void Path_following_TP_1_update(int_T tid);
extern void Path_following_TP_1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Path_following_TP_1_rtModel *Path_following_TP_1(void);
...
extern RT_MODEL_Path_following_TP_1_T *const Path_following_TP_1_M;
 ...
 *
 * '<Root>' : 'Path_following_TP_1'
 * '<S1>'   : 'Path_following_TP_1/AlphaToDelta'
 * '<S2>'   : 'Path_following_TP_1/Second-Order Low-Pass Filter'
 * '<S3>'   : 'Path_following_TP_1/Subsystem'
 * '<S4>'   : 'Path_following_TP_1/basicSpeedEstimation'
 * '<S5>'   : 'Path_following_TP_1/plot 2D planar vehicle'
 * '<S6>'   : 'Path_following_TP_1/simple kinematic 2D steered vehicle model'
 * '<S7>'   : 'Path_following_TP_1/speedController'
 * '<S8>'   : 'Path_following_TP_1/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_Path_following_TP_1_h_ */
