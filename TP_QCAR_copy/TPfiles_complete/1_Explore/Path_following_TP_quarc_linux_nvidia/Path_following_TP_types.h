...
#ifndef struct_tag_chBPQpHmy183rkhRZcbgRD
#define struct_tag_chBPQpHmy183rkhRZcbgRD

struct tag_chBPQpHmy183rkhRZcbgRD
{
  ...
  real_T LastPose[3];
  real_T WaypointsInternal[604];
};

#endif                                 /* struct_tag_chBPQpHmy183rkhRZcbgRD */

#ifndef typedef_nav_slalgs_internal_PurePursu_T
#define typedef_nav_slalgs_internal_PurePursu_T

typedef struct tag_chBPQpHmy183rkhRZcbgRD nav_slalgs_internal_PurePursu_T;
