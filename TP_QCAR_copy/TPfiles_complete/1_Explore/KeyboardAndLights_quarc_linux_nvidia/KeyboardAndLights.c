...
RT_MODEL_KeyboardAndLights_T *KeyboardAndLights(void)
{
  ...
  /* External mode info */
  KeyboardAndLights_M->Sizes.checksums[0] = (885390410U);
  KeyboardAndLights_M->Sizes.checksums[1] = (3537538039U);
  KeyboardAndLights_M->Sizes.checksums[2] = (436671612U);
  KeyboardAndLights_M->Sizes.checksums[3] = (2425951104U);
