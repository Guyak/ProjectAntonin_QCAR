###########################################################################
## Makefile generated for component 'OG_LIDAR_Base'. 
## 
## Makefile     : OG_LIDAR_Base.mk
## Generated on : Wed Oct 19 08:33:29 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/OG_LIDAR_Base.rt-linux_nvidia
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/OG_LIDAR_Base.rt-linux_nvidia
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=OG_LIDAR_Base -DNUMST=3 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/OG_LIDAR_Base.c $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/OG_LIDAR_Base_data.c $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/OG_LIDAR_Base_main.c $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/rtGetInf.c $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/rtGetNaN.c $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = OG_LIDAR_Base.o OG_LIDAR_Base_data.o OG_LIDAR_Base_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
OG_LIDAR_Base.o : $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/OG_LIDAR_Base.c
	$(CC) $(CFLAGS) -o"$@" "$<"


OG_LIDAR_Base_data.o : $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/OG_LIDAR_Base_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


OG_LIDAR_Base_main.o : $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/OG_LIDAR_Base_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/OG_LIDAR_Base_quarc_linux_nvidia/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
