...
#ifndef RTW_HEADER_OG_LIDAR_Base_h_
#define RTW_HEADER_OG_LIDAR_Base_h_
#include <math.h>
#include <string.h>
#ifndef OG_LIDAR_Base_COMMON_INCLUDES_
#define OG_LIDAR_Base_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* OG_LIDAR_Base_COMMON_INCLUDES_ */

#include "OG_LIDAR_Base_types.h"
...
#define OG_LIDAR_Base_rtModel          RT_MODEL_OG_LIDAR_Base_T
...
#define rtB                            OG_LIDAR_Base_B
#define BlockIO                        B_OG_LIDAR_Base_T
#define rtX                            OG_LIDAR_Base_X
#define ContinuousStates               X_OG_LIDAR_Base_T
#define rtXdot                         OG_LIDAR_Base_XDot
#define StateDerivatives               XDot_OG_LIDAR_Base_T
#define tXdis                          OG_LIDAR_Base_XDis
#define StateDisabled                  XDis_OG_LIDAR_Base_T
#define rtP                            OG_LIDAR_Base_P
#define Parameters                     P_OG_LIDAR_Base_T
#define rtDWork                        OG_LIDAR_Base_DW
#define D_Work                         DW_OG_LIDAR_Base_T
#define rtPrevZCSigState               OG_LIDAR_Base_PrevZCX
#define PrevZCSigStates                PrevZCX_OG_LIDAR_Base_T

/* Parameters (default storage) */
struct P_OG_LIDAR_Base_T_ {
...
struct tag_RTM_OG_LIDAR_Base_T {
  const char_T *path;
...
extern P_OG_LIDAR_Base_T OG_LIDAR_Base_P;

/* Block signals (default storage) */
extern B_OG_LIDAR_Base_T OG_LIDAR_Base_B;

/* Continuous states (default storage) */
extern X_OG_LIDAR_Base_T OG_LIDAR_Base_X;

/* Block states (default storage) */
extern DW_OG_LIDAR_Base_T OG_LIDAR_Base_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_OG_LIDAR_Base_T OG_LIDAR_Base_PrevZCX;
...
extern void OG_LIDAR_Base_initialize(void);
extern void OG_LIDAR_Base_output0(void);
extern void OG_LIDAR_Base_update0(void);
extern void OG_LIDAR_Base_output2(void);
extern void OG_LIDAR_Base_update2(void);
extern void OG_LIDAR_Base_output(int_T tid);
extern void OG_LIDAR_Base_update(int_T tid);
extern void OG_LIDAR_Base_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern OG_LIDAR_Base_rtModel *OG_LIDAR_Base(void);
...
extern RT_MODEL_OG_LIDAR_Base_T *const OG_LIDAR_Base_M;
 ...
 *
 * '<Root>' : 'OG_LIDAR_Base'
 * '<S1>'   : 'OG_LIDAR_Base/MATLAB Function1'
 * '<S2>'   : 'OG_LIDAR_Base/Quanser2'
 * '<S3>'   : 'OG_LIDAR_Base/basicSpeedEstimation'
 * '<S4>'   : 'OG_LIDAR_Base/captureLIDAR'
 * '<S5>'   : 'OG_LIDAR_Base/filtering'
 * '<S6>'   : 'OG_LIDAR_Base/plot 2D planar vehicle'
 * '<S7>'   : 'OG_LIDAR_Base/simple kinematic 2D steered vehicle model'
 * '<S8>'   : 'OG_LIDAR_Base/speedController'
 * '<S9>'   : 'OG_LIDAR_Base/captureLIDAR/MATLAB Function'
 * '<S10>'  : 'OG_LIDAR_Base/filtering/Second-Order Low-Pass Filter'
 * '<S11>'  : 'OG_LIDAR_Base/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_OG_LIDAR_Base_h_ */
