  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (LIDAR_AvoidAndStop_P)
    ;%
      section.nData     = 8;
      section.data(8)  = dumData; %prealloc
      
	  ;% LIDAR_AvoidAndStop_P.X_ic
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_P.Y_ic
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_AvoidAndStop_P.vehicle_length
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% LIDAR_AvoidAndStop_P.yaw_ic
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_maximum_rho
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_maximum_thet
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 5;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_minimum_rho
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 6;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_minimum_thet
	  ...
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_direction
	  section.data(1).logicalSrcIdx = 8;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_update_rate
	  section.data(2).logicalSrcIdx = 9;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_zero_locatio
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILRead_encoder_channels
	  section.data(1).logicalSrcIdx = 11;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_P.HILWrite1_other_channels
	  section.data(2).logicalSrcIdx = 12;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_AvoidAndStop_P.HILWrite1_pwm_channels
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_OOTerminate
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_OOExit
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_OOStart
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_OOEnter
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_OOFinal
	  section.data(7).logicalSrcIdx = 20;
	  section.data(7).dtTransOffset = 6;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AIHigh
	  section.data(8).logicalSrcIdx = 21;
	  section.data(8).dtTransOffset = 7;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AILow
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_OOInitial
	  section.data(14).logicalSrcIdx = 27;
	  section.data(14).dtTransOffset = 13;
	
	  ;% LIDAR_AvoidAndStop_P.RangingSensor_Budget
	  section.data(15).logicalSrcIdx = 28;
	  section.data(15).dtTransOffset = 14;
	
	  ;% LIDAR_AvoidAndStop_P.RangingSensor_Period
	  ...
	  ;% LIDAR_AvoidAndStop_P.Kffms_Gain
	  ...
	  ;% LIDAR_AvoidAndStop_P.Motor_commandsat_UpperSat
	  section.data(60).logicalSrcIdx = 73;
	  section.data(60).dtTransOffset = 808;
	
	  ;% LIDAR_AvoidAndStop_P.Motor_commandsat_LowerSat
	  ...
	  ;% LIDAR_AvoidAndStop_P.Constant3_Value
	  section.data(66).logicalSrcIdx = 79;
	  section.data(66).dtTransOffset = 814;
	
	  ;% LIDAR_AvoidAndStop_P.Constant_Value_j
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_EIInitial
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POAlignment
	  section.data(4).logicalSrcIdx = 86;
	  section.data(4).dtTransOffset = 4;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POPolarity
	  section.data(5).logicalSrcIdx = 87;
	  section.data(5).dtTransOffset = 5;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L1Style
	  section.data(6).logicalSrcIdx = 88;
	  section.data(6).dtTransOffset = 6;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L1Marker
	  section.data(7).logicalSrcIdx = 89;
	  section.data(7).dtTransOffset = 7;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L2Style
	  section.data(8).logicalSrcIdx = 90;
	  section.data(8).dtTransOffset = 8;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L2Marker
	  section.data(9).logicalSrcIdx = 91;
	  section.data(9).dtTransOffset = 9;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L3Style
	  section.data(10).logicalSrcIdx = 92;
	  section.data(10).dtTransOffset = 10;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L3Marker
	  section.data(11).logicalSrcIdx = 93;
	  section.data(11).dtTransOffset = 11;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L4Style
	  section.data(12).logicalSrcIdx = 94;
	  section.data(12).dtTransOffset = 12;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L4Marker
	  section.data(13).logicalSrcIdx = 95;
	  section.data(13).dtTransOffset = 13;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L5Style
	  section.data(14).logicalSrcIdx = 96;
	  section.data(14).dtTransOffset = 14;
	
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_L5Marker
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AIChannels
	  section.data(1).logicalSrcIdx = 98;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_DIChannels
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_EIChannels
	  section.data(4).logicalSrcIdx = 101;
	  section.data(4).dtTransOffset = 27;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_EIQuadrature
	  ...
	  ;% LIDAR_AvoidAndStop_P.RangingSensor_Range
	  ...
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_Active
	  section.data(1).logicalSrcIdx = 106;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AOTerminate
	  section.data(2).logicalSrcIdx = 107;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AOExit
	  section.data(3).logicalSrcIdx = 108;
	  section.data(3).dtTransOffset = 2;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_DOTerminate
	  section.data(4).logicalSrcIdx = 109;
	  section.data(4).dtTransOffset = 3;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_DOExit
	  section.data(5).logicalSrcIdx = 110;
	  section.data(5).dtTransOffset = 4;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POTerminate
	  section.data(6).logicalSrcIdx = 111;
	  section.data(6).dtTransOffset = 5;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POExit
	  section.data(7).logicalSrcIdx = 112;
	  section.data(7).dtTransOffset = 6;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_CKPStart
	  section.data(8).logicalSrcIdx = 113;
	  section.data(8).dtTransOffset = 7;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_CKPEnter
	  section.data(9).logicalSrcIdx = 114;
	  section.data(9).dtTransOffset = 8;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_CKStart
	  section.data(10).logicalSrcIdx = 115;
	  section.data(10).dtTransOffset = 9;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_CKEnter
	  section.data(11).logicalSrcIdx = 116;
	  section.data(11).dtTransOffset = 10;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AIPStart
	  section.data(12).logicalSrcIdx = 117;
	  section.data(12).dtTransOffset = 11;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AIPEnter
	  section.data(13).logicalSrcIdx = 118;
	  section.data(13).dtTransOffset = 12;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AOPStart
	  section.data(14).logicalSrcIdx = 119;
	  section.data(14).dtTransOffset = 13;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AOPEnter
	  section.data(15).logicalSrcIdx = 120;
	  section.data(15).dtTransOffset = 14;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AOStart
	  section.data(16).logicalSrcIdx = 121;
	  section.data(16).dtTransOffset = 15;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AOEnter
	  section.data(17).logicalSrcIdx = 122;
	  section.data(17).dtTransOffset = 16;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_AOReset
	  section.data(18).logicalSrcIdx = 123;
	  section.data(18).dtTransOffset = 17;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_DOPStart
	  section.data(19).logicalSrcIdx = 124;
	  section.data(19).dtTransOffset = 18;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_DOPEnter
	  section.data(20).logicalSrcIdx = 125;
	  section.data(20).dtTransOffset = 19;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_DOStart
	  section.data(21).logicalSrcIdx = 126;
	  section.data(21).dtTransOffset = 20;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_DOEnter
	  section.data(22).logicalSrcIdx = 127;
	  section.data(22).dtTransOffset = 21;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_DOReset
	  section.data(23).logicalSrcIdx = 128;
	  section.data(23).dtTransOffset = 22;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_EIPStart
	  section.data(24).logicalSrcIdx = 129;
	  section.data(24).dtTransOffset = 23;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_EIPEnter
	  section.data(25).logicalSrcIdx = 130;
	  section.data(25).dtTransOffset = 24;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_EIStart
	  section.data(26).logicalSrcIdx = 131;
	  section.data(26).dtTransOffset = 25;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_EIEnter
	  section.data(27).logicalSrcIdx = 132;
	  section.data(27).dtTransOffset = 26;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POPStart
	  section.data(28).logicalSrcIdx = 133;
	  section.data(28).dtTransOffset = 27;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POPEnter
	  section.data(29).logicalSrcIdx = 134;
	  section.data(29).dtTransOffset = 28;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POStart
	  section.data(30).logicalSrcIdx = 135;
	  section.data(30).dtTransOffset = 29;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POEnter
	  section.data(31).logicalSrcIdx = 136;
	  section.data(31).dtTransOffset = 30;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_POReset
	  section.data(32).logicalSrcIdx = 137;
	  section.data(32).dtTransOffset = 31;
	
	  ;% LIDAR_AvoidAndStop_P.HILInitialize1_OOReset
	  ...
	  ;% LIDAR_AvoidAndStop_P.RangingSensor_Active
	  section.data(36).logicalSrcIdx = 141;
	  section.data(36).dtTransOffset = 35;
	
	  ;% LIDAR_AvoidAndStop_P.HILWrite1_Active
	  section.data(37).logicalSrcIdx = 142;
	  section.data(37).dtTransOffset = 36;
	
	  ;% LIDAR_AvoidAndStop_P.HILRead_Active
	  ...
	  ;% LIDAR_AvoidAndStop_P.BodyFramePolarPlot_Mode
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (LIDAR_AvoidAndStop_B)
    ;%
      section.nData     = 23;
      section.data(23)  = dumData; %prealloc
      
	  ;% LIDAR_AvoidAndStop_B.RangingSensor_o1
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_B.RangingSensor_o2
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 720;
	
	  ;% LIDAR_AvoidAndStop_B.RangingSensor_o3
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 1440;
	
	  ;% LIDAR_AvoidAndStop_B.RangingSensor_o4
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 2160;
	
	  ;% LIDAR_AvoidAndStop_B.Constant1
	  section.data(5).logicalSrcIdx = 4;
	  ...
	  ;% LIDAR_AvoidAndStop_B.Product1
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 3602;
	
	  ;% LIDAR_AvoidAndStop_B.measured
	  ...
	  ;% LIDAR_AvoidAndStop_B.Integrator
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 3605;
	
	  ;% LIDAR_AvoidAndStop_B.Integrator1
	  ...
	  ;% LIDAR_AvoidAndStop_B.Unwrap224
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 3609;
	
	  ;% LIDAR_AvoidAndStop_B.Product
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (LIDAR_AvoidAndStop_DW)
    ;%
      section.nData     = 1;
      section.data(1)  = dumData; %prealloc
      
	  ;% LIDAR_AvoidAndStop_DW.RangingSensor_Measurements
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% LIDAR_AvoidAndStop_DW.AnimationSFunction_DSTATE
	  section.data(1).logicalSrcIdx = 1;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_DW.HILInitialize1_AIMinimums
	  section.data(2).logicalSrcIdx = 2;
	  section.data(2).dtTransOffset = 6;
	
	  ;% LIDAR_AvoidAndStop_DW.HILInitialize1_AIMaximums
	  section.data(3).logicalSrcIdx = 3;
	  section.data(3).dtTransOffset = 13;
	
	  ;% LIDAR_AvoidAndStop_DW.HILInitialize1_FilterFrequency
	  ...
	  ;% LIDAR_AvoidAndStop_DW.HILInitialize1_POValues
	  section.data(6).logicalSrcIdx = 6;
	  section.data(6).dtTransOffset = 26;
	
	  ;% LIDAR_AvoidAndStop_DW.HILInitialize1_OOValues
	  section.data(7).logicalSrcIdx = 7;
	  section.data(7).dtTransOffset = 27;
	
	  ;% LIDAR_AvoidAndStop_DW.BodyFramePolarPlot_XBuffer
	  section.data(8).logicalSrcIdx = 8;
	  section.data(8).dtTransOffset = 40;
	
	  ;% LIDAR_AvoidAndStop_DW.BodyFramePolarPlot_YBuffer
	  ...
	  ;% LIDAR_AvoidAndStop_DW.HILWrite1_PWORK
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_DW.Scope_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_AvoidAndStop_DW.HILRead_PWORK
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% LIDAR_AvoidAndStop_DW.Scope_PWORK_p.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	  ...
	  ;% LIDAR_AvoidAndStop_DW.HILInitialize1_DOStates
	  section.data(1).logicalSrcIdx = 18;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_DW.HILInitialize1_QuadratureModes
	  section.data(2).logicalSrcIdx = 19;
	  section.data(2).dtTransOffset = 1;
	
	  ;% LIDAR_AvoidAndStop_DW.HILInitialize1_InitialEICounts
	  ...
	  ;% LIDAR_AvoidAndStop_DW.BodyFramePolarPlot_IWORK
	  section.data(1).logicalSrcIdx = 23;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_DW.Integrator1_IWORK
	  section.data(2).logicalSrcIdx = 24;
	  ...
	  ;% LIDAR_AvoidAndStop_DW.BodyFramePolarPlot_IsFull
	  section.data(1).logicalSrcIdx = 25;
	  section.data(1).dtTransOffset = 0;
	
	  ;% LIDAR_AvoidAndStop_DW.Unwrap224_FirstSample
  ...
  targMap.checksum0 = 888133993;
  targMap.checksum1 = 3178198735;
  targMap.checksum2 = 3868220984;
  targMap.checksum3 = 2072971573;
