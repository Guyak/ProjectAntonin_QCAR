...
RT_MODEL_Autonomous_Driving_T *Autonomous_Driving(void)
{
  ...
  /* External mode info */
  Autonomous_Driving_M->Sizes.checksums[0] = (257798187U);
  Autonomous_Driving_M->Sizes.checksums[1] = (1097347280U);
  Autonomous_Driving_M->Sizes.checksums[2] = (185777589U);
  Autonomous_Driving_M->Sizes.checksums[3] = (1962578331U);
