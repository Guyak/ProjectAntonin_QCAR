 ...
 * C source code generated on : Mon Jan 17 09:55:46 2022
 *
...
#ifndef RTW_HEADER_Manual_Drive_h_
#define RTW_HEADER_Manual_Drive_h_
#include <math.h>
#include <string.h>
#ifndef Manual_Drive_COMMON_INCLUDES_
#define Manual_Drive_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Manual_Drive_COMMON_INCLUDES_ */

#include "Manual_Drive_types.h"
...
#define Manual_Drive_rtModel           RT_MODEL_Manual_Drive_T
...
typedef struct {
  ...
  real_T one_shot_block;               /* '<S20>/one_shot_block' */
  real_T Product_d;                    /* '<S9>/Product' */
  real_T Gain;                         /* '<S9>/Gain' */
  real_T wheelspeedms;                 /* '<S4>/wheel radius' */
  real_T actualsampletime;             /* '<S8>/Sample Time' */
  real_T reference;                    /* '<S8>/Constant' */
  real_T computationtime;              /* '<S8>/Computation Time' */
  real_T OutportBufferForEnabled;      /* '<S15>/Constant' */
  boolean_T GameController_o1;         /* '<S6>/Game Controller' */
  boolean_T GameController_o2[32];     /* '<S6>/Game Controller' */
  boolean_T Compare;                   /* '<S18>/Compare' */
} B_Manual_Drive_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  t_timeout SampleTime_PreviousTime;   /* '<S8>/Sample Time' */
  t_timeout ComputationTime_BeginTime; /* '<S8>/Computation Time' */
  t_timeout ComputationTime_ComputationTime;/* '<S8>/Computation Time' */
  real_T one_shot_block_DSTATE[3];     /* '<S20>/one_shot_block' */
  ...
  int32_T clockTickCounter;            /* '<S7>/Pulsing Light' */
  ...
  t_boolean HILWrite_DigitalBuffer;    /* '<S3>/HIL Write' */
} DW_Manual_Drive_T;
...
#define rtB                            Manual_Drive_B
#define BlockIO                        B_Manual_Drive_T
#define rtX                            Manual_Drive_X
#define ContinuousStates               X_Manual_Drive_T
#define rtXdot                         Manual_Drive_XDot
#define StateDerivatives               XDot_Manual_Drive_T
#define tXdis                          Manual_Drive_XDis
#define StateDisabled                  XDis_Manual_Drive_T
#define rtP                            Manual_Drive_P
#define Parameters                     P_Manual_Drive_T
#define rtDWork                        Manual_Drive_DW
#define D_Work                         DW_Manual_Drive_T
#define rtPrevZCSigState               Manual_Drive_PrevZCX
#define PrevZCSigStates                PrevZCX_Manual_Drive_T

/* Parameters (default storage) */
struct P_Manual_Drive_T_ {
  ...
  boolean_T CompareToConstant2_const_a;
                                    ...
                                    */
  boolean_T CompareToConstant1_const_o;
  ...
  real_T Constant_Value;               /* Expression: -1
                                        ...
                                        */
  real_T Enabled_Y0;                   /* Expression: [0]
  ...
  real_T Constant1_Value_b;            /* Expression: 1
                                        ...
                                        */
  real_T Constant2_Value_n;            /* Expression: 25
  ...
  real_T directionconvention_Gain;     /* Expression: -1
                                        ...
                                        */
  real_T scaleoutputtomaxrange_Gain;   /* Expression: 0.2
                                        * Referenced by: '<S3>/scale output  to max range'
                                        */
  real_T commandsaturation_UpperSat;   /* Expression: 0.20
                                        * Referenced by: '<S3>/command saturation'
                                        */
  real_T commandsaturation_LowerSat;   /* Expression: -0.20
                                        * Referenced by: '<S3>/command saturation'
                                        */
  ...
  real_T Gain4_Gain;                   /* Expression: -1
                                        ...
                                        */
  real_T remappingtosteeringrange_Gain;/* Expression: 0.5
  ...
  real_T Memory_InitialCondition;      /* Expression: 0
                                        ...
                                        */
  real_T Constant2_Value_j;            /* Expression: 5
  ...
  real_T Switch_Threshold_f;           /* Expression: 0.5
                                        ...
                                        */
  real_T minvoltage_Value;             /* Expression: 10.5
                                        * Referenced by: '<S9>/min voltage'
                                        */
  real_T maxvoltage_Value;             /* Expression: 12.6
  ...
  real_T wheelradius_Gain;             /* Expression: 0.0342
                                        ...
                                        */
  real_T Constant_Value_b3;            /* Expression: qc_get_step_size
...
extern P_Manual_Drive_T Manual_Drive_P;

/* Block signals (default storage) */
extern B_Manual_Drive_T Manual_Drive_B;

/* Continuous states (default storage) */
extern X_Manual_Drive_T Manual_Drive_X;

/* Block states (default storage) */
extern DW_Manual_Drive_T Manual_Drive_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_Manual_Drive_T Manual_Drive_PrevZCX;

/* Model entry point functions */
extern void Manual_Drive_initialize(void);
extern void Manual_Drive_output(void);
extern void Manual_Drive_update(void);
extern void Manual_Drive_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Manual_Drive_rtModel *Manual_Drive(void);
...
extern RT_MODEL_Manual_Drive_T *const Manual_Drive_M;
 ...
 *
 * '<Root>' : 'Manual_Drive'
 * '<S1>'   : 'Manual_Drive/Powered by QUARC'
 * '<S2>'   : 'Manual_Drive/Quanser'
 * '<S3>'   : 'Manual_Drive/basicQCarIO'
 * '<S4>'   : 'Manual_Drive/basicSpeedEstimation'
 * '<S5>'   : 'Manual_Drive/channelMappingManualDriveGamepad'
 * '<S6>'   : 'Manual_Drive/gamepadViaTarget'
 * '<S7>'   : 'Manual_Drive/indicatorAndLamps'
 * '<S8>'   : 'Manual_Drive/monitorTiming '
 * '<S9>'   : 'Manual_Drive/powerConsumptionMonitor'
 * '<S10>'  : 'Manual_Drive/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S11>'  : 'Manual_Drive/channelMappingManualDriveGamepad/Compare To Constant1'
 * '<S12>'  : 'Manual_Drive/channelMappingManualDriveGamepad/Compare To Constant2'
 * '<S13>'  : 'Manual_Drive/gamepadViaTarget/Compare To Zero'
 * '<S14>'  : 'Manual_Drive/gamepadViaTarget/Find Arrow Key  from radians'
 * '<S15>'  : 'Manual_Drive/gamepadViaTarget/Triggered Subsystem'
 * '<S16>'  : 'Manual_Drive/indicatorAndLamps/Compare To Constant1'
 * '<S17>'  : 'Manual_Drive/indicatorAndLamps/Compare To Constant2'
 * '<S18>'  : 'Manual_Drive/indicatorAndLamps/Compare To Constant3'
 * '<S19>'  : 'Manual_Drive/indicatorAndLamps/Left Steering Limit'
 * '<S20>'  : 'Manual_Drive/indicatorAndLamps/One Shot'
 * '<S21>'  : 'Manual_Drive/indicatorAndLamps/Right Steering Limit'
 */
#endif                                 /* RTW_HEADER_Manual_Drive_h_ */
